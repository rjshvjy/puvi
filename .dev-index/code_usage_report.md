...
Generated: 2025-09-02 05:37:48.145922
...
### batch
- Used by modules: cost_management, masters_crud, blending, batch_production, sku_production, writeoff_analytics, material_sales, opening_balance, material_writeoff, db_utils, app, traceability
- Files: 14
- Functions using this table:
...
### batches
- Used by modules: blending, batch_production, sku_production, material_sales, opening_balance, material_writeoff, app
- Files: 7
- Functions using this table:
...
### categories
- Used by modules: masters_crud, sku_production, masters_common, material_writeoff, system_config
- Files: 10

### categories_master
- Used by modules: masters_crud, blending, purchase, masters_common, sku_outbound, material_writeoff, db_utils
- Files: 7
- Functions using this table:
...
### cost_elements
- Used by modules: cost_management, masters_crud, batch_production, masters_common, system_config
- Files: 25

### cost_elements_master
- Used by modules: cost_management, package_sizes, batch_production, sku_production, masters_common, db_utils, system_config
- Files: 7
- Functions using this table:
...
### database
- Used by modules: cost_management, blending, system_config, batch_production, sku_production, masters_common, material_writeoff, traceability
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: cost_management, expiry_utils, package_sizes, blending, masters_crud, sku_production, inventory_utils, date_utils, opening_balance, masters_common, sku_management, sku_outbound, app, traceability
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: cost_management, package_sizes, masters_crud, blending, batch_production, sku_production, purchase, customers, writeoff_analytics, material_sales, opening_balance, masters_common, sku_management, locations, material_writeoff, sku_outbound, app, system_config
- Files: 18

### decimal
- Used by modules: cost_management, expiry_utils, package_sizes, blending, masters_crud, batch_production, sku_production, purchase, writeoff_analytics, inventory_utils, material_sales, opening_balance, masters_common, validation, sku_management, locations, sku_outbound
- Files: 17
...
### errors
- Used by modules: masters_crud, sku_management, opening_balance, locations, db_utils, app, customers
- Files: 7

### existing
- Used by modules: cost_management, expiry_utils, package_sizes, batch_production, inventory_utils, opening_balance, traceability
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: cost_management, package_sizes, masters_crud, blending, batch_production, sku_production, purchase, customers, writeoff_analytics, material_sales, opening_balance, sku_management, locations, material_writeoff, sku_outbound, app, system_config
- Files: 17
...
### inventory
- Used by modules: masters_crud, blending, batch_production, sku_production, purchase, inventory_utils, material_sales, opening_balance, material_writeoff, db_utils
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### locations_master
- Used by modules: expiry_utils, sku_production, locations, sku_outbound, app
- Files: 5
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### materials
- Used by modules: masters_crud, blending, system_config, batch_production, sku_production, purchase, writeoff_analytics, opening_balance, masters_common, material_writeoff, db_utils, app, traceability
- Files: 26
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: cost_management, sku_production, writeoff_analytics, material_sales, opening_balance, masters_common, locations, material_writeoff, sku_outbound
- Files: 9
...
### oil_types
- Used by modules: blending, batch_production, material_sales, material_writeoff, system_config
- Files: 7
...
### purchases
- Used by modules: blending, batch_production, sku_production, purchase, opening_balance, masters_common, db_utils, app
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: package_sizes, masters_crud, sku_management, masters_common, locations, customers
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sku_inventory
- Used by modules: expiry_utils, sku_production, sku_outbound, locations, material_writeoff, db_utils
- Files: 6
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: package_sizes, expiry_utils, masters_crud, sku_production, sku_management, sku_outbound, material_writeoff, db_utils, app, system_config
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: expiry_utils, sku_production, sku_management, sku_outbound, material_writeoff, db_utils, app
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### subcategories_master
- Used by modules: masters_crud, blending, purchase, masters_common, sku_outbound, db_utils
- Files: 6
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: cost_management, expiry_utils, package_sizes, blending, masters_crud, batch_production, sku_production, purchase, customers, writeoff_analytics, material_sales, opening_balance, sku_management, locations, material_writeoff, sku_outbound, app, system_config
- Files: 18
...
### suppliers
- Used by modules: system_config, sku_production, purchase, opening_balance, masters_common, db_utils, app, traceability
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### utils
- Used by modules: cost_management, expiry_utils, masters_crud, blending, batch_production, sku_production, purchase, writeoff_analytics, material_sales, opening_balance, sku_management, locations, material_writeoff, sku_outbound, customers
- Files: 15

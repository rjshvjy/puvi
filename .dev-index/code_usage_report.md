...
Generated: 2025-08-30 18:26:24.581521
...
### batch
- Used by modules: masters_crud, material_writeoff, writeoff_analytics, traceability, db_utils, cost_management, opening_balance, blending, sku_production, batch_production, material_sales, app
- Files: 14
- Functions using this table:
...
### batches
- Used by modules: material_writeoff, opening_balance, sku_production, blending, batch_production, material_sales, app
- Files: 7
- Functions using this table:
...
### categories_master
- Used by modules: masters_crud, material_writeoff, masters_common, purchase, db_utils, blending
- Files: 6
- Functions using this table:
...
- Used by modules: masters_common, system_config, package_sizes, db_utils, cost_management, batch_production, sku_production
- Files: 7
- Functions using this table:
...
### database
- Used by modules: material_writeoff, masters_common, system_config, cost_management, batch_production, sku_production, blending, traceability
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: masters_crud, masters_common, inventory_utils, traceability, package_sizes, sku_management, cost_management, sku_outbound, opening_balance, blending, date_utils, sku_production, expiry_utils, app
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: masters_crud, material_writeoff, masters_common, writeoff_analytics, purchase, customers, system_config, package_sizes, sku_management, cost_management, sku_outbound, locations, opening_balance, blending, sku_production, batch_production, material_sales, app
- Files: 18

### decimal
- Used by modules: masters_crud, masters_common, writeoff_analytics, purchase, inventory_utils, sku_management, package_sizes, cost_management, validation, sku_outbound, opening_balance, blending, sku_production, batch_production, expiry_utils, material_sales, locations
- Files: 17
...
### errors
- Used by modules: masters_crud, sku_management, db_utils, locations, opening_balance, customers, app
- Files: 7

### existing
- Used by modules: inventory_utils, package_sizes, cost_management, opening_balance, batch_production, expiry_utils, traceability
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: masters_crud, material_writeoff, writeoff_analytics, purchase, customers, system_config, package_sizes, sku_management, cost_management, sku_outbound, locations, opening_balance, blending, sku_production, batch_production, material_sales, app
- Files: 17
...
### inventory
- Used by modules: masters_crud, material_writeoff, purchase, inventory_utils, db_utils, opening_balance, blending, sku_production, batch_production, material_sales
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### materials
- Used by modules: masters_crud, material_writeoff, masters_common, writeoff_analytics, purchase, traceability, system_config, db_utils, opening_balance, blending, sku_production, batch_production, app
- Files: 26
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: material_writeoff, masters_common, writeoff_analytics, cost_management, sku_outbound, locations, opening_balance, sku_production, material_sales
- Files: 9
...
### purchases
- Used by modules: masters_common, purchase, db_utils, opening_balance, sku_production, blending, batch_production, app
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: masters_crud, masters_common, sku_management, package_sizes, locations, customers
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sales
- Used by modules: sku_outbound, material_sales, app, masters_common
- Files: 4
...
### sku_inventory
- Used by modules: material_writeoff, db_utils, sku_outbound, locations, sku_production
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: masters_crud, material_writeoff, sku_management, system_config, package_sizes, db_utils, sku_outbound, sku_production, expiry_utils, app
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: material_writeoff, sku_management, db_utils, sku_outbound, sku_production, expiry_utils, app
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### statistics
- Used by modules: masters_crud, writeoff_analytics, app, opening_balance
- Files: 4

### status
- Used by modules: masters_crud, sku_outbound, opening_balance, sku_production, app
- Files: 5
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: masters_crud, masters_common, purchase, db_utils, blending
- Files: 5
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: masters_crud, material_writeoff, writeoff_analytics, purchase, customers, system_config, package_sizes, sku_management, cost_management, sku_outbound, locations, opening_balance, blending, sku_production, batch_production, expiry_utils, material_sales, app
- Files: 18
...
### suppliers
- Used by modules: masters_common, purchase, traceability, system_config, db_utils, opening_balance, sku_production, app
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### utils
- Used by modules: masters_crud, material_writeoff, writeoff_analytics, purchase, customers, sku_management, cost_management, sku_outbound, locations, opening_balance, blending, sku_production, batch_production, expiry_utils, material_sales
- Files: 15

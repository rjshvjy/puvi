...
Generated: 2025-09-01 05:29:21.402463
...
### batch
- Used by modules: sku_production, opening_balance, app, writeoff_analytics, db_utils, material_writeoff, blending, cost_management, batch_production, material_sales, masters_crud, traceability
- Files: 14
- Functions using this table:
...
- Used by modules: batch_production, masters_common, cost_management, db_utils
- Files: 4
- Functions using this table:
...
### batches
- Used by modules: sku_production, opening_balance, app, material_writeoff, blending, batch_production, material_sales
- Files: 7
- Functions using this table:
...
### categories_master
- Used by modules: sku_outbound, material_writeoff, blending, purchase, masters_crud, masters_common, db_utils
- Files: 7
- Functions using this table:
...
### cost_elements
- Used by modules: cost_management, batch_production, system_config, masters_crud, masters_common
- Files: 25

### cost_elements_master
- Used by modules: sku_production, cost_management, batch_production, package_sizes, system_config, masters_common, db_utils
- Files: 7
- Functions using this table:
...
### database
- Used by modules: sku_production, material_writeoff, blending, cost_management, batch_production, system_config, masters_common, traceability
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: sku_production, opening_balance, app, sku_management, sku_outbound, masters_crud, blending, cost_management, package_sizes, date_utils, expiry_utils, inventory_utils, masters_common, traceability
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: sku_production, opening_balance, app, writeoff_analytics, sku_management, locations, sku_outbound, material_writeoff, blending, cost_management, purchase, batch_production, package_sizes, system_config, material_sales, masters_crud, masters_common, customers
- Files: 18

### decimal
- Used by modules: sku_production, opening_balance, writeoff_analytics, sku_management, validation, locations, sku_outbound, masters_crud, blending, cost_management, purchase, batch_production, expiry_utils, package_sizes, material_sales, inventory_utils, masters_common
- Files: 17
...
### dependencies
- Used by modules: sku_management, masters_crud, masters_common, locations
- Files: 4
...
### errors
- Used by modules: opening_balance, sku_management, app, locations, masters_crud, customers, db_utils
- Files: 7

### existing
- Used by modules: opening_balance, cost_management, batch_production, expiry_utils, package_sizes, inventory_utils, traceability
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: sku_production, opening_balance, app, writeoff_analytics, sku_management, locations, sku_outbound, material_writeoff, blending, cost_management, purchase, batch_production, package_sizes, system_config, material_sales, masters_crud, customers
- Files: 17
...
### in
- Used by modules: sku_management, package_sizes, cost_management
- Files: 3
- Functions using this table:
  - bulk_update_cost_elements in puvi-backend/puvi-backend-main/modules/cost_management.py
  - bulk_update_package_sizes in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### inventory
- Used by modules: sku_production, opening_balance, material_writeoff, masters_crud, blending, purchase, batch_production, material_sales, inventory_utils, db_utils
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### items
- Used by modules: sku_production, purchase, material_writeoff, sku_outbound
- Files: 4
...
### material_writeoffs
- Used by modules: opening_balance, writeoff_analytics, material_writeoff, masters_common, db_utils
- Files: 5
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: sku_production, opening_balance, app, writeoff_analytics, db_utils, material_writeoff, blending, purchase, batch_production, system_config, masters_crud, masters_common, traceability
- Files: 26
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: sku_production, opening_balance, writeoff_analytics, locations, sku_outbound, material_writeoff, cost_management, material_sales, masters_common
- Files: 9
...
### oil_cake_inventory
- Used by modules: material_sales, batch_production, material_writeoff, db_utils
- Files: 5
- Functions using this table:
  - get_material_sales_inventory in puvi-backend/puvi-backend-main/modules/material_sales.py
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
...
### oil_types
- Used by modules: material_writeoff, blending, batch_production, system_config, material_sales
- Files: 7
...
### purchase_items
- Used by modules: masters_common, purchase, batch_production, db_utils
- Files: 4
- Functions using this table:
...
### purchases
- Used by modules: sku_production, opening_balance, app, blending, purchase, batch_production, masters_common, db_utils
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: sku_management, locations, package_sizes, masters_crud, masters_common, customers
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sales
- Used by modules: masters_common, material_sales, app, sku_outbound
- Files: 4
...
### sku
- Used by modules: material_writeoff, system_config, sku_outbound
- Files: 57
- Functions using this table:
  - get_config in puvi-backend/puvi-backend-main/modules/system_config.py
  - get_gst_rate_for_sku in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### sku_expiry_tracking
- Used by modules: sku_production, locations, sku_outbound, expiry_utils, db_utils
- Files: 5
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: sku_production, locations, sku_outbound, material_writeoff, db_utils
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: sku_production, app, sku_management, sku_outbound, material_writeoff, package_sizes, expiry_utils, system_config, masters_crud, db_utils
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: sku_production, app, sku_management, sku_outbound, material_writeoff, expiry_utils, db_utils
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### statistics
- Used by modules: masters_crud, opening_balance, app, writeoff_analytics
- Files: 4
...
### status
- Used by modules: sku_production, opening_balance, app, sku_outbound, masters_crud
- Files: 5
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: sku_outbound, blending, purchase, masters_crud, masters_common, db_utils
- Files: 6
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: sku_production, opening_balance, app, writeoff_analytics, sku_management, locations, sku_outbound, material_writeoff, blending, cost_management, purchase, batch_production, expiry_utils, package_sizes, system_config, material_sales, masters_crud, customers
- Files: 18
...
### suppliers
- Used by modules: sku_production, opening_balance, app, db_utils, purchase, system_config, masters_common, traceability
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### the
- Used by modules: masters_crud, cost_management, traceability, db_utils
- Files: 4
- Functions using this table:
...
### utils
- Used by modules: sku_production, opening_balance, writeoff_analytics, sku_management, locations, sku_outbound, material_writeoff, blending, cost_management, purchase, batch_production, expiry_utils, material_sales, masters_crud, customers
- Files: 15

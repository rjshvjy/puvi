...
Generated: 2025-08-30 01:37:29.373441

## Summary
- Tables found in code: 366
- Backend files scanned: 26
...
### address
- Used by modules: locations, masters_common
- Files: 2
...
### an
- Used by modules: sku_management, masters_crud, locations
- Files: 3
- Functions using this table:
...
### batch
- Used by modules: opening_balance, masters_crud, blending, traceability, material_sales, cost_management, db_utils, material_writeoff, writeoff_analytics, batch_production, app, sku_production
- Files: 14
- Functions using this table:
...
### batches
- Used by modules: opening_balance, blending, material_sales, material_writeoff, batch_production, app, sku_production
- Files: 7
- Functions using this table:
...
### bottles
- Used by modules: sku_management, system_config, material_writeoff
- Files: 3
...
### categories
- Used by modules: sku_management, masters_crud, system_config, masters_common, material_writeoff, sku_production
- Files: 11

### categories_master
- Used by modules: masters_crud, masters_common, blending, purchase, material_writeoff, db_utils
- Files: 6
- Functions using this table:
...
### cost_elements
- Used by modules: masters_crud, system_config, masters_common, cost_management, sku_outbound, batch_production
- Files: 26

### cost_elements_master
- Used by modules: sku_management, system_config, masters_common, cost_management, db_utils, package_sizes, batch_production, sku_production
- Files: 8
- Functions using this table:
...
### database
- Used by modules: system_config, masters_common, blending, traceability, cost_management, material_writeoff, batch_production, sku_production
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: sku_management, opening_balance, masters_crud, masters_common, date_utils, blending, traceability, expiry_utils, cost_management, inventory_utils, sku_outbound, package_sizes, app, sku_production
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: sku_management, opening_balance, masters_crud, system_config, masters_common, locations, blending, material_sales, purchase, cost_management, sku_outbound, material_writeoff, writeoff_analytics, batch_production, package_sizes, app, sku_production
- Files: 17

### decimal
- Used by modules: sku_management, opening_balance, masters_crud, masters_common, locations, blending, expiry_utils, material_sales, validation, cost_management, inventory_utils, sku_outbound, purchase, writeoff_analytics, batch_production, package_sizes, sku_production
- Files: 17
...
### errors
- Used by modules: sku_management, opening_balance, masters_crud, locations, db_utils, app
- Files: 6

### existing
- Used by modules: sku_management, opening_balance, traceability, expiry_utils, cost_management, inventory_utils, batch_production, package_sizes
- Files: 8
- Functions using this table:
...
### flask
- Used by modules: sku_management, opening_balance, masters_crud, system_config, locations, blending, material_sales, purchase, cost_management, sku_outbound, material_writeoff, writeoff_analytics, batch_production, package_sizes, app, sku_production
- Files: 16
...
### inventory
- Used by modules: opening_balance, masters_crud, blending, material_sales, purchase, db_utils, inventory_utils, material_writeoff, batch_production, sku_production
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
- Functions using this table:
  ...
  - get_outbound_details in puvi-backend/puvi-backend-main/modules/sku_outbound.py
  - trace_batch in puvi-backend/puvi-backend-main/modules/sku_outbound.py
  - generate_location_code in puvi-backend/puvi-backend-main/modules/locations.py
  - ... and 9 more
...
### material_writeoffs
- Used by modules: opening_balance, masters_common, material_writeoff, db_utils, writeoff_analytics
- Files: 5
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: sku_management, opening_balance, masters_crud, system_config, masters_common, blending, traceability, purchase, db_utils, material_writeoff, writeoff_analytics, batch_production, app, sku_production
- Files: 27
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: sku_management, opening_balance, masters_common, locations, material_sales, cost_management, sku_outbound, material_writeoff, writeoff_analytics, sku_production
- Files: 10
...
### oil_types
- Used by modules: system_config, blending, material_sales, material_writeoff, batch_production
- Files: 7
...
### purchases
- Used by modules: opening_balance, masters_common, blending, purchase, db_utils, batch_production, app, sku_production
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: sku_management, masters_crud, masters_common, locations, package_sizes
- Files: 5
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sku_expiry_tracking
- Used by modules: locations, expiry_utils, sku_outbound, db_utils, sku_production
- Files: 5
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: locations, sku_outbound, material_writeoff, db_utils, sku_production
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: sku_management, masters_crud, system_config, expiry_utils, sku_outbound, db_utils, material_writeoff, package_sizes, app, sku_production
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: sku_management, expiry_utils, sku_outbound, db_utils, material_writeoff, app, sku_production
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### status
- Used by modules: opening_balance, masters_crud, sku_outbound, app, sku_production
- Files: 5
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: masters_crud, masters_common, blending, purchase, db_utils
- Files: 5
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: sku_management, opening_balance, masters_crud, system_config, locations, blending, expiry_utils, material_sales, purchase, cost_management, sku_outbound, material_writeoff, writeoff_analytics, batch_production, package_sizes, app, sku_production
- Files: 17
...
### suppliers
- Used by modules: opening_balance, system_config, masters_common, traceability, purchase, db_utils, app, sku_production
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### utils
- Used by modules: sku_management, opening_balance, masters_crud, locations, blending, expiry_utils, material_sales, purchase, cost_management, sku_outbound, material_writeoff, writeoff_analytics, batch_production, sku_production
- Files: 14

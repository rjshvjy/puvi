...
Generated: 2025-09-02 07:17:54.797746
...
### batch
- Used by modules: opening_balance, db_utils, cost_management, writeoff_analytics, traceability, app, material_writeoff, material_sales, masters_crud, blending, sku_production, batch_production
- Files: 14
- Functions using this table:
...
### batches
- Used by modules: opening_balance, app, material_writeoff, material_sales, blending, sku_production, batch_production
- Files: 7
- Functions using this table:
...
### blend_batches
- Used by modules: masters_crud, sku_production, db_utils, blending
- Files: 4
- Functions using this table:
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
  - create_blend in puvi-backend/puvi-backend-main/modules/blending.py
...
### categories
- Used by modules: system_config, masters_common, masters_crud, material_writeoff, sku_production
- Files: 10

### categories_master
- Used by modules: db_utils, masters_common, material_writeoff, masters_crud, blending, sku_outbound, purchase
- Files: 7
- Functions using this table:
...
- Used by modules: cost_management, db_utils, system_config, masters_common, package_sizes, sku_production, batch_production
- Files: 7
- Functions using this table:
...
### database
- Used by modules: cost_management, system_config, masters_common, traceability, material_writeoff, blending, sku_production, batch_production
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: date_utils, opening_balance, cost_management, sku_management, masters_common, traceability, app, masters_crud, expiry_utils, blending, package_sizes, sku_outbound, sku_production, inventory_utils
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: sku_management, cost_management, opening_balance, system_config, locations, writeoff_analytics, masters_common, app, material_writeoff, material_sales, masters_crud, customers, blending, package_sizes, sku_outbound, sku_production, purchase, batch_production
- Files: 18

### decimal
- Used by modules: sku_management, validation, opening_balance, cost_management, locations, writeoff_analytics, masters_common, masters_crud, material_sales, expiry_utils, batch_production, blending, package_sizes, sku_outbound, sku_production, purchase, inventory_utils
- Files: 17
...
### errors
- Used by modules: sku_management, opening_balance, db_utils, locations, app, masters_crud, customers
- Files: 7

### existing
- Used by modules: cost_management, opening_balance, traceability, expiry_utils, batch_production, package_sizes, inventory_utils
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: sku_management, cost_management, opening_balance, system_config, locations, writeoff_analytics, app, material_writeoff, material_sales, masters_crud, customers, blending, package_sizes, sku_outbound, sku_production, purchase, batch_production
- Files: 17
...
### inventory
- Used by modules: opening_balance, db_utils, material_writeoff, masters_crud, material_sales, batch_production, blending, sku_production, purchase, inventory_utils
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### locations_master
- Used by modules: locations, app, expiry_utils, sku_outbound, sku_production
- Files: 5
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### material_writeoffs
- Used by modules: opening_balance, db_utils, writeoff_analytics, masters_common, material_writeoff
- Files: 5
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: opening_balance, db_utils, system_config, writeoff_analytics, masters_common, traceability, app, material_writeoff, masters_crud, blending, sku_production, purchase, batch_production
- Files: 26
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: locations, cost_management, opening_balance, writeoff_analytics, masters_common, material_writeoff, material_sales, sku_outbound, sku_production
- Files: 9
...
### oil_cake_inventory
- Used by modules: db_utils, material_sales, batch_production, material_writeoff
- Files: 5
- Functions using this table:
  - get_material_sales_inventory in puvi-backend/puvi-backend-main/modules/material_sales.py
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
...
### oil_types
- Used by modules: system_config, material_writeoff, material_sales, blending, batch_production
- Files: 7
...
### purchases
- Used by modules: opening_balance, db_utils, masters_common, app, blending, sku_production, purchase, batch_production
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: sku_management, locations, masters_common, masters_crud, customers, package_sizes
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sku_expiry_tracking
- Used by modules: locations, db_utils, expiry_utils, sku_outbound, sku_production
- Files: 5
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: locations, db_utils, material_writeoff, expiry_utils, sku_outbound, sku_production
- Files: 6
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: sku_management, db_utils, system_config, app, material_writeoff, expiry_utils, masters_crud, package_sizes, sku_outbound, sku_production
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: sku_management, db_utils, app, material_writeoff, expiry_utils, sku_outbound, sku_production
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### status
- Used by modules: opening_balance, masters_crud, app, sku_outbound, sku_production
- Files: 5
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: db_utils, masters_common, masters_crud, blending, sku_outbound, purchase
- Files: 6
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: sku_management, opening_balance, cost_management, system_config, locations, writeoff_analytics, app, material_writeoff, expiry_utils, material_sales, customers, masters_crud, blending, package_sizes, sku_outbound, sku_production, purchase, batch_production
- Files: 18
...
### suppliers
- Used by modules: opening_balance, db_utils, system_config, masters_common, traceability, app, sku_production, purchase
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### utils
- Used by modules: sku_management, cost_management, opening_balance, locations, writeoff_analytics, material_writeoff, masters_crud, expiry_utils, material_sales, customers, blending, sku_outbound, sku_production, purchase, batch_production
- Files: 15

...
Generated: 2025-09-01 06:52:29.656035
...
### allocations
- Used by modules: sku_outbound, material_sales, expiry_utils, sku_production
- Files: 4
...
### batch
- Used by modules: masters_crud, batch_production, sku_production, cost_management, material_writeoff, writeoff_analytics, blending, material_sales, traceability, app, opening_balance, db_utils
- Files: 14
- Functions using this table:
...
### batches
- Used by modules: batch_production, sku_production, material_writeoff, blending, material_sales, app, opening_balance
- Files: 7
- Functions using this table:
...
### categories
- Used by modules: masters_crud, sku_production, system_config, material_writeoff, masters_common
- Files: 10

### categories_master
- Used by modules: masters_crud, db_utils, material_writeoff, sku_outbound, blending, purchase, masters_common
- Files: 7
- Functions using this table:
...
### cost_elements
- Used by modules: masters_crud, batch_production, system_config, cost_management, masters_common
- Files: 25

### cost_elements_master
- Used by modules: batch_production, sku_production, system_config, cost_management, masters_common, package_sizes, db_utils
- Files: 7
- Functions using this table:
...
### customers
- Used by modules: locations, sku_outbound, app, customers
- Files: 14
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_outbound_history in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### database
- Used by modules: batch_production, sku_production, system_config, cost_management, material_writeoff, blending, traceability, masters_common
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: masters_crud, sku_production, cost_management, sku_outbound, inventory_utils, date_utils, blending, traceability, app, package_sizes, opening_balance, sku_management, expiry_utils, masters_common
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: locations, masters_crud, batch_production, sku_production, system_config, cost_management, material_writeoff, sku_outbound, writeoff_analytics, blending, purchase, material_sales, app, package_sizes, customers, opening_balance, sku_management, masters_common
- Files: 18

### decimal
- Used by modules: locations, masters_crud, batch_production, sku_production, cost_management, validation, writeoff_analytics, inventory_utils, blending, material_sales, sku_outbound, purchase, package_sizes, opening_balance, sku_management, expiry_utils, masters_common
- Files: 17
...
### errors
- Used by modules: locations, masters_crud, customers, app, opening_balance, sku_management, db_utils
- Files: 7

### existing
- Used by modules: batch_production, cost_management, inventory_utils, traceability, package_sizes, opening_balance, expiry_utils
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: locations, masters_crud, batch_production, sku_production, system_config, cost_management, material_writeoff, sku_outbound, writeoff_analytics, blending, purchase, material_sales, app, package_sizes, customers, opening_balance, sku_management
- Files: 17
...
### inventory
- Used by modules: masters_crud, batch_production, sku_production, material_writeoff, blending, inventory_utils, material_sales, purchase, opening_balance, db_utils
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### items
- Used by modules: sku_outbound, purchase, sku_production, material_writeoff
- Files: 4
...
### material_writeoffs
- Used by modules: db_utils, material_writeoff, writeoff_analytics, opening_balance, masters_common
- Files: 5
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: masters_crud, batch_production, sku_production, system_config, material_writeoff, masters_common, writeoff_analytics, blending, purchase, traceability, app, opening_balance, db_utils
- Files: 26
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: locations, sku_production, cost_management, material_writeoff, sku_outbound, writeoff_analytics, material_sales, opening_balance, masters_common
- Files: 9
...
### oil_cake_inventory
- Used by modules: material_writeoff, batch_production, material_sales, db_utils
- Files: 5
- Functions using this table:
  - get_material_sales_inventory in puvi-backend/puvi-backend-main/modules/material_sales.py
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
...
### oil_types
- Used by modules: batch_production, system_config, material_writeoff, blending, material_sales
- Files: 7
...
### purchases
- Used by modules: batch_production, sku_production, masters_common, blending, purchase, app, opening_balance, db_utils
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: locations, masters_crud, customers, package_sizes, sku_management, masters_common
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sales
- Used by modules: sku_outbound, app, material_sales, masters_common
- Files: 4
...
### sku_expiry_tracking
- Used by modules: locations, sku_production, sku_outbound, expiry_utils, db_utils
- Files: 5
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: locations, sku_production, material_writeoff, sku_outbound, db_utils
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: masters_crud, sku_production, system_config, material_writeoff, sku_outbound, package_sizes, app, sku_management, expiry_utils, db_utils
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: sku_production, material_writeoff, sku_outbound, app, sku_management, expiry_utils, db_utils
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### status
- Used by modules: masters_crud, sku_production, sku_outbound, app, opening_balance
- Files: 5
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: masters_crud, db_utils, sku_outbound, blending, purchase, masters_common
- Files: 6
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: locations, masters_crud, batch_production, sku_production, system_config, cost_management, material_writeoff, sku_outbound, writeoff_analytics, blending, purchase, material_sales, app, package_sizes, customers, opening_balance, sku_management, expiry_utils
- Files: 18
...
### suppliers
- Used by modules: sku_production, system_config, masters_common, purchase, traceability, app, opening_balance, db_utils
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### utils
- Used by modules: locations, masters_crud, batch_production, sku_production, cost_management, material_writeoff, sku_outbound, writeoff_analytics, blending, purchase, material_sales, customers, opening_balance, sku_management, expiry_utils
- Files: 15

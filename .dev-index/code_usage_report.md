...
Generated: 2025-08-30 07:52:57.336536

## Summary
- Tables found in code: 368
- Backend files scanned: 27
- Frontend files scanned: 41
...
### batch
- Used by modules: app, material_writeoff, writeoff_analytics, masters_crud, material_sales, cost_management, db_utils, sku_production, opening_balance, batch_production, blending, traceability
- Files: 14
- Functions using this table:
...
### batches
- Used by modules: app, material_writeoff, material_sales, sku_production, opening_balance, batch_production, blending
- Files: 7
- Functions using this table:
...
### categories
- Used by modules: material_writeoff, masters_crud, system_config, sku_management, sku_production, masters_common
- Files: 11

### categories_master
- Used by modules: material_writeoff, masters_crud, purchase, db_utils, blending, masters_common
- Files: 6
- Functions using this table:
...
### cost_elements
- Used by modules: masters_crud, cost_management, system_config, batch_production, sku_outbound, masters_common
- Files: 26

### cost_elements_master
- Used by modules: package_sizes, cost_management, system_config, sku_management, db_utils, sku_production, batch_production, masters_common
- Files: 8
- Functions using this table:
...
### database
- Used by modules: material_writeoff, cost_management, system_config, masters_common, sku_production, batch_production, blending, traceability
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: app, sku_outbound, masters_crud, package_sizes, cost_management, inventory_utils, date_utils, masters_common, sku_management, sku_production, opening_balance, blending, traceability, expiry_utils
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: app, material_writeoff, locations, sku_outbound, writeoff_analytics, masters_crud, material_sales, cost_management, package_sizes, system_config, purchase, customers, sku_management, sku_production, opening_balance, batch_production, blending, masters_common
- Files: 18

### decimal
- Used by modules: locations, sku_outbound, writeoff_analytics, masters_crud, material_sales, cost_management, inventory_utils, package_sizes, purchase, sku_management, validation, sku_production, opening_balance, batch_production, blending, masters_common, expiry_utils
- Files: 17
...
### errors
- Used by modules: app, locations, masters_crud, customers, sku_management, db_utils, opening_balance
- Files: 7

### existing
- Used by modules: package_sizes, cost_management, inventory_utils, sku_management, opening_balance, batch_production, traceability, expiry_utils
- Files: 8
- Functions using this table:
...
### flask
- Used by modules: app, material_writeoff, locations, sku_outbound, writeoff_analytics, masters_crud, material_sales, cost_management, package_sizes, system_config, purchase, customers, sku_management, sku_production, opening_balance, batch_production, blending
- Files: 17
...
### inventory
- Used by modules: material_writeoff, masters_crud, material_sales, inventory_utils, purchase, db_utils, sku_production, opening_balance, batch_production, blending
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### material_writeoffs
- Used by modules: material_writeoff, writeoff_analytics, db_utils, opening_balance, masters_common
- Files: 5
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: app, material_writeoff, writeoff_analytics, masters_crud, system_config, purchase, masters_common, db_utils, sku_production, sku_management, opening_balance, batch_production, blending, traceability
- Files: 27
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: locations, material_writeoff, writeoff_analytics, material_sales, cost_management, sku_management, sku_production, opening_balance, sku_outbound, masters_common
- Files: 10
...
### oil_types
- Used by modules: material_writeoff, material_sales, system_config, batch_production, blending
- Files: 7
...
### purchase_items
- Used by modules: db_utils, batch_production, masters_common, purchase
- Files: 4
- Functions using this table:
...
### purchases
- Used by modules: app, purchase, db_utils, sku_production, opening_balance, batch_production, blending, masters_common
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### sku_inventory
- Used by modules: locations, material_writeoff, db_utils, sku_production, sku_outbound
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: app, material_writeoff, masters_crud, package_sizes, system_config, sku_management, db_utils, sku_production, sku_outbound, expiry_utils
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: app, material_writeoff, sku_management, db_utils, sku_production, sku_outbound, expiry_utils
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### status
- Used by modules: app, masters_crud, sku_production, opening_balance, sku_outbound
- Files: 5
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: masters_crud, purchase, db_utils, blending, masters_common
- Files: 5
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: app, material_writeoff, locations, sku_outbound, writeoff_analytics, masters_crud, material_sales, cost_management, package_sizes, system_config, purchase, customers, sku_management, sku_production, opening_balance, batch_production, blending, expiry_utils
- Files: 18
...
### suppliers
- Used by modules: app, system_config, purchase, masters_common, db_utils, sku_production, opening_balance, traceability
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### utils
- Used by modules: locations, material_writeoff, sku_outbound, writeoff_analytics, masters_crud, material_sales, cost_management, purchase, customers, sku_management, sku_production, opening_balance, batch_production, blending, expiry_utils
- Files: 15

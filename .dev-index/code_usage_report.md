...
Generated: 2025-08-31 14:04:44.324252
...
### allocations
- Used by modules: sku_outbound, expiry_utils, sku_production, material_sales
- Files: 4
...
### batch
- Used by modules: traceability, material_writeoff, app, sku_production, masters_crud, batch_production, opening_balance, db_utils, cost_management, blending, writeoff_analytics, material_sales
- Files: 14
- Functions using this table:
...
- Used by modules: batch_production, db_utils, masters_common, cost_management
- Files: 4
- Functions using this table:
...
### batches
- Used by modules: material_writeoff, app, sku_production, batch_production, opening_balance, blending, material_sales
- Files: 7
- Functions using this table:
...
### categories_master
- Used by modules: material_writeoff, purchase, masters_common, masters_crud, db_utils, blending
- Files: 6
- Functions using this table:
...
- Used by modules: sku_production, masters_common, system_config, batch_production, package_sizes, db_utils, cost_management
- Files: 7
- Functions using this table:
...
### database
- Used by modules: traceability, material_writeoff, sku_production, masters_common, system_config, batch_production, cost_management, blending
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: traceability, inventory_utils, date_utils, app, sku_management, sku_production, masters_common, masters_crud, expiry_utils, opening_balance, package_sizes, cost_management, sku_outbound, blending
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: material_writeoff, locations, app, purchase, sku_production, masters_common, system_config, customers, sku_management, batch_production, masters_crud, opening_balance, package_sizes, cost_management, sku_outbound, blending, writeoff_analytics, material_sales
- Files: 18

### decimal
- Used by modules: locations, inventory_utils, validation, sku_management, purchase, sku_production, masters_common, masters_crud, expiry_utils, batch_production, opening_balance, package_sizes, cost_management, sku_outbound, blending, writeoff_analytics, material_sales
- Files: 17
...
### errors
- Used by modules: locations, sku_management, app, customers, masters_crud, opening_balance, db_utils
- Files: 7

### existing
- Used by modules: traceability, inventory_utils, expiry_utils, batch_production, opening_balance, package_sizes, cost_management
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: material_writeoff, locations, app, purchase, sku_production, sku_management, system_config, customers, masters_crud, batch_production, opening_balance, package_sizes, cost_management, sku_outbound, blending, writeoff_analytics, material_sales
- Files: 17
...
### inventory
- Used by modules: material_writeoff, inventory_utils, purchase, sku_production, masters_crud, batch_production, opening_balance, db_utils, blending, material_sales
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### material_writeoffs
- Used by modules: material_writeoff, masters_common, opening_balance, db_utils, writeoff_analytics
- Files: 5
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: traceability, material_writeoff, app, purchase, sku_production, masters_common, system_config, masters_crud, batch_production, opening_balance, db_utils, sku_outbound, blending, writeoff_analytics
- Files: 27
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: material_writeoff, locations, sku_production, masters_common, opening_balance, cost_management, sku_outbound, writeoff_analytics, material_sales
- Files: 9
...
### oil_types
- Used by modules: material_writeoff, system_config, batch_production, blending, material_sales
- Files: 7
...
### purchase_items
- Used by modules: batch_production, purchase, db_utils, masters_common
- Files: 4
- Functions using this table:
...
### purchases
- Used by modules: app, purchase, sku_production, masters_common, batch_production, opening_balance, db_utils, blending
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: locations, sku_management, masters_common, customers, masters_crud, package_sizes
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sales
- Used by modules: sku_outbound, app, masters_common, material_sales
- Files: 4
...
### sku_expiry_tracking
- Used by modules: locations, sku_production, expiry_utils, db_utils, sku_outbound
- Files: 5
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: material_writeoff, locations, sku_production, db_utils, sku_outbound
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: material_writeoff, app, sku_management, sku_production, system_config, masters_crud, expiry_utils, package_sizes, db_utils, sku_outbound
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: material_writeoff, app, sku_management, sku_production, expiry_utils, db_utils, sku_outbound
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### subcategories_master
- Used by modules: purchase, masters_common, masters_crud, db_utils, blending
- Files: 5
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: material_writeoff, locations, app, purchase, sku_production, sku_management, system_config, customers, masters_crud, expiry_utils, batch_production, opening_balance, package_sizes, cost_management, sku_outbound, blending, writeoff_analytics, material_sales
- Files: 18
...
### suppliers
- Used by modules: traceability, app, purchase, sku_production, masters_common, system_config, opening_balance, db_utils
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### utils
- Used by modules: material_writeoff, locations, sku_management, purchase, sku_production, customers, masters_crud, expiry_utils, batch_production, opening_balance, cost_management, sku_outbound, blending, writeoff_analytics, material_sales
- Files: 15

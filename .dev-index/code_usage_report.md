...
Generated: 2025-09-07 13:27:46.447655
...
### batch
- Used by modules: opening_balance, sku_production, traceability, blending, db_utils, app, cost_management, writeoff_analytics, batch_production, material_sales, material_writeoff, masters_crud
- Files: 14
- Functions using this table:
...
- Used by modules: db_utils, cost_management, masters_common, batch_production, masters_crud
- Files: 5
- Functions using this table:
...
### batches
- Used by modules: sku_production, opening_balance, blending, app, batch_production, material_sales, material_writeoff
- Files: 7
- Functions using this table:
...
### blend_batches
- Used by modules: db_utils, sku_production, masters_crud, blending
- Files: 4
- Functions using this table:
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
  - create_blend in puvi-backend/puvi-backend-main/modules/blending.py
...
### categories
- Used by modules: sku_production, system_config, masters_common, material_writeoff, masters_crud
- Files: 10

### categories_master
- Used by modules: sku_outbound, blending, db_utils, masters_common, purchase, material_writeoff, masters_crud
- Files: 7
- Functions using this table:
...
- Used by modules: sku_production, db_utils, cost_management, package_sizes, system_config, masters_common, batch_production, masters_crud
- Files: 8
- Functions using this table:
...
### database
- Used by modules: sku_production, traceability, blending, cost_management, system_config, masters_common, batch_production, material_writeoff, masters_crud
- Files: 9
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: opening_balance, sku_production, traceability, sku_outbound, blending, inventory_utils, app, cost_management, sku_management, package_sizes, date_utils, masters_common, expiry_utils, masters_crud
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: opening_balance, sku_production, sku_outbound, blending, app, sku_management, cost_management, customers, package_sizes, writeoff_analytics, system_config, locations, masters_common, batch_production, purchase, material_sales, material_writeoff, masters_crud
- Files: 18

### decimal
- Used by modules: opening_balance, sku_production, sku_outbound, blending, inventory_utils, sku_management, cost_management, package_sizes, writeoff_analytics, locations, validation, masters_common, expiry_utils, batch_production, purchase, material_sales, masters_crud
- Files: 17
...
### errors
- Used by modules: opening_balance, db_utils, sku_management, app, customers, locations, masters_crud
- Files: 7

### existing
- Used by modules: opening_balance, traceability, inventory_utils, cost_management, package_sizes, expiry_utils, batch_production
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: opening_balance, sku_production, sku_outbound, blending, app, sku_management, cost_management, customers, package_sizes, writeoff_analytics, system_config, locations, batch_production, purchase, material_sales, material_writeoff, masters_crud
- Files: 17
...
### in
- Used by modules: sku_management, cost_management, package_sizes, masters_crud
- Files: 4
- Functions using this table:
  - bulk_update_cost_elements in puvi-backend/puvi-backend-main/modules/cost_management.py
  - bulk_update_package_sizes in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### inventory
- Used by modules: opening_balance, sku_production, blending, inventory_utils, db_utils, batch_production, purchase, material_sales, material_writeoff, masters_crud
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### locations_master
- Used by modules: sku_production, sku_outbound, app, expiry_utils, locations
- Files: 5
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### masters_audit_log
- Used by modules: db_utils, sku_management, opening_balance, masters_common
- Files: 4
- Functions using this table:
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - close_financial_year in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: opening_balance, sku_production, traceability, blending, db_utils, app, writeoff_analytics, system_config, masters_common, batch_production, purchase, material_writeoff, masters_crud
- Files: 25
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: opening_balance, sku_production, sku_outbound, cost_management, writeoff_analytics, masters_common, locations, material_sales, material_writeoff
- Files: 9
...
### oil_types
- Used by modules: blending, system_config, batch_production, material_sales, material_writeoff
- Files: 7
...
- Used by modules: sku_production, db_utils, package_sizes, masters_common, masters_crud
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - create_production_plan in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### purchases
- Used by modules: opening_balance, sku_production, blending, db_utils, app, masters_common, batch_production, purchase
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### sales
- Used by modules: app, material_sales, sku_outbound, masters_crud
- Files: 4
...
### sku_expiry_tracking
- Used by modules: sku_production, sku_outbound, db_utils, expiry_utils, locations
- Files: 5
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: sku_production, sku_outbound, db_utils, expiry_utils, locations, material_writeoff
- Files: 6
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: sku_production, sku_outbound, db_utils, app, sku_management, package_sizes, system_config, expiry_utils, material_writeoff, masters_crud
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: sku_production, sku_outbound, db_utils, app, sku_management, expiry_utils, material_writeoff
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### subcategories_master
- Used by modules: sku_outbound, blending, db_utils, masters_common, purchase, masters_crud
- Files: 6
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: opening_balance, sku_production, sku_outbound, blending, app, sku_management, cost_management, customers, package_sizes, writeoff_analytics, system_config, locations, expiry_utils, batch_production, purchase, material_sales, material_writeoff, masters_crud
- Files: 18
...
### suppliers
- Used by modules: sku_production, opening_balance, traceability, db_utils, app, system_config, masters_common, purchase
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### updates
- Used by modules: cost_management, package_sizes, masters_crud
- Files: 3
...
### utils
- Used by modules: opening_balance, sku_production, sku_outbound, blending, sku_management, cost_management, customers, locations, writeoff_analytics, expiry_utils, batch_production, purchase, material_sales, material_writeoff, masters_crud
- Files: 15

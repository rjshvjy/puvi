...
Generated: 2025-09-07 12:43:38.679346
...
### batch
- Used by modules: sku_production, masters_crud, opening_balance, material_sales, batch_production, blending, material_writeoff, cost_management, traceability, writeoff_analytics, app, db_utils
- Files: 14
- Functions using this table:
...
- Used by modules: masters_crud, batch_production, cost_management, masters_common, db_utils
- Files: 5
- Functions using this table:
...
### batches
- Used by modules: sku_production, opening_balance, material_sales, batch_production, blending, material_writeoff, app
- Files: 7
- Functions using this table:
...
### categories_master
- Used by modules: masters_crud, purchase, blending, sku_outbound, masters_common, material_writeoff, db_utils
- Files: 7
- Functions using this table:
...
### cost_elements
- Used by modules: masters_crud, batch_production, cost_management, masters_common, system_config
- Files: 25

### cost_elements_master
- Used by modules: sku_production, masters_crud, batch_production, cost_management, masters_common, package_sizes, system_config, db_utils
- Files: 8
- Functions using this table:
...
### customers
- Used by modules: sku_outbound, locations, app, customers
- Files: 15
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_customer_all_locations in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### database
- Used by modules: sku_production, masters_crud, batch_production, blending, cost_management, traceability, masters_common, system_config, material_writeoff
- Files: 9
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: sku_production, date_utils, masters_crud, opening_balance, inventory_utils, blending, sku_outbound, cost_management, traceability, masters_common, expiry_utils, package_sizes, app, sku_management
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: sku_production, masters_crud, opening_balance, material_sales, batch_production, blending, purchase, sku_outbound, cost_management, customers, material_writeoff, locations, writeoff_analytics, masters_common, package_sizes, system_config, app, sku_management
- Files: 18

### decimal
- Used by modules: sku_production, masters_crud, opening_balance, material_sales, inventory_utils, blending, batch_production, sku_outbound, cost_management, purchase, locations, writeoff_analytics, masters_common, expiry_utils, validation, package_sizes, sku_management
- Files: 17
...
### errors
- Used by modules: masters_crud, opening_balance, customers, locations, app, sku_management, db_utils
- Files: 7

### existing
- Used by modules: opening_balance, batch_production, inventory_utils, cost_management, traceability, expiry_utils, package_sizes
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: sku_production, masters_crud, opening_balance, material_sales, batch_production, blending, purchase, sku_outbound, cost_management, customers, material_writeoff, locations, writeoff_analytics, package_sizes, system_config, app, sku_management
- Files: 17
...
### in
- Used by modules: masters_crud, cost_management, sku_management, package_sizes
- Files: 4
- Functions using this table:
  - bulk_update_cost_elements in puvi-backend/puvi-backend-main/modules/cost_management.py
  - bulk_update_package_sizes in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### inventory
- Used by modules: sku_production, masters_crud, opening_balance, material_sales, inventory_utils, blending, batch_production, purchase, material_writeoff, db_utils
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### locations_master
- Used by modules: sku_production, sku_outbound, locations, expiry_utils, app
- Files: 5
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### material_writeoffs
- Used by modules: opening_balance, writeoff_analytics, masters_common, material_writeoff, db_utils
- Files: 5
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: sku_production, masters_crud, opening_balance, batch_production, purchase, blending, material_writeoff, traceability, writeoff_analytics, masters_common, system_config, app, db_utils
- Files: 25
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: sku_production, opening_balance, material_sales, sku_outbound, cost_management, locations, writeoff_analytics, masters_common, material_writeoff
- Files: 9
...
### oil_types
- Used by modules: batch_production, material_sales, blending, system_config, material_writeoff
- Files: 7
...
- Used by modules: masters_crud, sku_production, masters_common, package_sizes, db_utils
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - create_production_plan in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### purchases
- Used by modules: sku_production, opening_balance, batch_production, purchase, blending, masters_common, app, db_utils
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: masters_crud, customers, locations, masters_common, package_sizes, sku_management
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sales
- Used by modules: masters_crud, sku_outbound, app, material_sales
- Files: 4
...
### sku_inventory
- Used by modules: sku_production, sku_outbound, locations, expiry_utils, material_writeoff, db_utils
- Files: 6
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: sku_production, masters_crud, material_writeoff, sku_outbound, expiry_utils, package_sizes, system_config, app, sku_management, db_utils
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: sku_production, material_writeoff, sku_outbound, expiry_utils, app, sku_management, db_utils
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### status
- Used by modules: masters_crud, sku_production, opening_balance, sku_outbound, app
- Files: 5
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: masters_crud, purchase, blending, sku_outbound, masters_common, db_utils
- Files: 6
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: sku_production, masters_crud, opening_balance, material_sales, batch_production, blending, purchase, sku_outbound, cost_management, customers, material_writeoff, locations, writeoff_analytics, expiry_utils, package_sizes, system_config, app, sku_management
- Files: 18
...
### suppliers
- Used by modules: sku_production, opening_balance, purchase, traceability, masters_common, system_config, app, db_utils
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### utils
- Used by modules: sku_production, masters_crud, opening_balance, material_sales, batch_production, blending, purchase, sku_outbound, cost_management, customers, locations, writeoff_analytics, expiry_utils, material_writeoff, sku_management
- Files: 15

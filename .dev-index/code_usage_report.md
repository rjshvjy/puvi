...
Generated: 2025-09-08 14:41:02.715627
...
### allocations
- Used by modules: tm_configs, sku_outbound, expiry_utils, sku_production, tm_output_operations, material_sales
- Files: 6
...
### an
- Used by modules: customers, locations, masters_crud, sku_management
- Files: 4
- Functions using this table:
...
### batch
- Used by modules: blending, app, writeoff_analytics, tm_configs, opening_balance, traceability, material_writeoff, tm_production_operations, cost_management, sku_production, batch_production, masters_crud, tm_input_operations, tm_output_operations, db_utils, material_sales
- Files: 18
- Functions using this table:
...
- Used by modules: tm_configs, tm_production_operations, masters_common, cost_management, batch_production, masters_crud, db_utils
- Files: 7
- Functions using this table:
...
### batches
- Used by modules: blending, app, opening_balance, tm_production_operations, material_writeoff, sku_production, batch_production, material_sales
- Files: 8
- Functions using this table:
...
- Used by modules: blending, tm_configs, tm_production_operations, sku_production, db_utils
- Files: 5
- Functions using this table:
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### blend_batches
- Used by modules: blending, tm_configs, tm_production_operations, sku_production, tm_main, masters_crud, tm_output_operations, db_utils
- Files: 8
- Functions using this table:
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
  - create_blend in puvi-backend/puvi-backend-main/modules/blending.py
...
### categories_master
- Used by modules: blending, sku_outbound, purchase, material_writeoff, masters_common, masters_crud, db_utils
- Files: 7
- Functions using this table:
...
- Used by modules: system_config, tm_production_operations, masters_common, cost_management, batch_production, sku_production, masters_crud, db_utils, package_sizes
- Files: 9
- Functions using this table:
...
### cost_override_log
- Used by modules: db_utils, cost_management, tm_configs, masters_common
- Files: 4
- Functions using this table:
  - save_batch_costs in puvi-backend/puvi-backend-main/modules/cost_management.py
...
### customers
- Used by modules: customers, sku_outbound, tm_output_operations, locations, app
- Files: 16
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_customer_all_locations in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### database
- Used by modules: blending, system_config, material_writeoff, masters_common, cost_management, sku_production, masters_crud, traceability
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: tm_configs, tm_production_operations, expiry_utils, sku_production, masters_common, tm_main, tm_input_operations, package_sizes, cost_management, date_utils, masters_crud, sku_management, tm_output_operations, app, traceability, inventory_utils, sku_outbound, blending, opening_balance
- Files: 19
- Functions using this table:
...
### db_utils
- Used by modules: purchase, tm_production_operations, masters_common, sku_production, tm_main, tm_input_operations, package_sizes, locations, writeoff_analytics, cost_management, batch_production, masters_crud, sku_management, tm_output_operations, app, sku_outbound, material_writeoff, blending, customers, system_config, opening_balance, material_sales
- Files: 22

### decimal
- Used by modules: purchase, tm_production_operations, expiry_utils, sku_production, masters_common, tm_input_operations, package_sizes, locations, validation, writeoff_analytics, cost_management, batch_production, masters_crud, sku_management, tm_output_operations, inventory_utils, sku_outbound, blending, opening_balance, material_sales
- Files: 20
...
### dependencies
- Used by modules: tm_production_operations, masters_common, masters_crud, sku_management, tm_output_operations, locations
- Files: 6
...
### errors
- Used by modules: customers, opening_balance, masters_crud, sku_management, db_utils, locations, app
- Files: 7

### existing
- Used by modules: inventory_utils, opening_balance, tm_production_operations, expiry_utils, cost_management, batch_production, package_sizes, traceability
- Files: 8
- Functions using this table:
...
### flask
- Used by modules: purchase, tm_production_operations, sku_production, tm_main, tm_input_operations, package_sizes, locations, writeoff_analytics, cost_management, batch_production, masters_crud, sku_management, tm_output_operations, app, sku_outbound, material_writeoff, blending, customers, system_config, opening_balance, material_sales
- Files: 21
...
### has_dependencies
- Used by modules: tm_production_operations, masters_common, masters_crud, tm_input_operations, tm_output_operations, locations
- Files: 6
...
### inventory
- Used by modules: blending, inventory_utils, opening_balance, purchase, material_writeoff, tm_production_operations, sku_production, batch_production, masters_crud, tm_input_operations, db_utils, material_sales
- Files: 14
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### items
- Used by modules: tm_configs, sku_outbound, purchase, material_writeoff, sku_production, tm_input_operations, tm_output_operations
- Files: 7
...
### locations_master
- Used by modules: sku_outbound, expiry_utils, sku_production, tm_output_operations, locations, app
- Files: 6
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### material_writeoffs
- Used by modules: writeoff_analytics, tm_configs, opening_balance, material_writeoff, masters_common, tm_main, tm_input_operations, db_utils
- Files: 8
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: blending, app, writeoff_analytics, system_config, opening_balance, purchase, material_writeoff, tm_production_operations, masters_common, sku_production, batch_production, masters_crud, tm_input_operations, tm_output_operations, db_utils, traceability
- Files: 27
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: writeoff_analytics, tm_configs, sku_outbound, opening_balance, tm_production_operations, material_writeoff, masters_common, sku_production, cost_management, batch_production, tm_input_operations, tm_output_operations, locations, material_sales
- Files: 14
...
### oil_cake_sales
- Used by modules: tm_configs, tm_main, batch_production, tm_output_operations, db_utils, material_sales
- Files: 7
- Functions using this table:
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
  - get_material_sales_history in puvi-backend/puvi-backend-main/modules/material_sales.py
...
### productions
- Used by modules: sku_production, sku_management, app, tm_output_operations
- Files: 4
...
### purchase_items
- Used by modules: tm_configs, purchase, masters_common, batch_production, tm_input_operations, db_utils
- Files: 6
- Functions using this table:
...
### purchases
- Used by modules: blending, tm_configs, opening_balance, purchase, masters_common, sku_production, batch_production, tm_main, tm_input_operations, tm_output_operations, db_utils, app
- Files: 16
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: customers, tm_production_operations, masters_common, tm_main, masters_crud, sku_management, tm_input_operations, tm_output_operations, package_sizes, locations
- Files: 10
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### rates
- Used by modules: batch_production, masters_crud, system_config
- Files: 3
- Functions using this table:
  - bulk_update_cost_elements in puvi-backend/puvi-backend-main/modules/masters_crud.py
...
### sales
- Used by modules: app, sku_outbound, masters_crud, tm_output_operations, material_sales
- Files: 5
...
### sku
- Used by modules: system_config, sku_outbound, material_writeoff, batch_production, tm_output_operations
- Files: 59
- Functions using this table:
  - get_oil_types in puvi-backend/puvi-backend-main/modules/batch_production.py
  - get_config in puvi-backend/puvi-backend-main/modules/system_config.py
...
### sku_expiry_tracking
- Used by modules: sku_outbound, expiry_utils, sku_production, tm_output_operations, db_utils, locations
- Files: 6
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: sku_outbound, material_writeoff, expiry_utils, sku_production, tm_input_operations, tm_output_operations, db_utils, locations
- Files: 8
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: system_config, sku_outbound, material_writeoff, expiry_utils, sku_production, batch_production, masters_crud, sku_management, tm_input_operations, tm_output_operations, db_utils, package_sizes, app
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_oil_allocation
- Used by modules: tm_configs, tm_production_operations, sku_production, tm_output_operations, db_utils
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - get_production_summary_report in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_production
- Used by modules: sku_outbound, material_writeoff, expiry_utils, sku_production, sku_management, tm_output_operations, db_utils, app
- Files: 8
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### statistics
- Used by modules: writeoff_analytics, opening_balance, tm_main, masters_crud, app
- Files: 5
...
### status
- Used by modules: tm_configs, sku_outbound, opening_balance, tm_production_operations, sku_production, tm_main, masters_crud, tm_input_operations, tm_output_operations, app
- Files: 10
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: blending, sku_outbound, purchase, masters_common, batch_production, masters_crud, db_utils
- Files: 7
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### suppliers
- Used by modules: app, system_config, opening_balance, purchase, masters_common, sku_production, tm_input_operations, db_utils, traceability
- Files: 14
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### the
- Used by modules: tm_production_operations, cost_management, batch_production, masters_crud, tm_input_operations, db_utils, traceability
- Files: 7
- Functions using this table:
...
### utils
- Used by modules: blending, customers, writeoff_analytics, sku_outbound, opening_balance, purchase, material_writeoff, tm_production_operations, expiry_utils, cost_management, sku_production, batch_production, masters_crud, sku_management, tm_input_operations, tm_output_operations, locations, material_sales
- Files: 18
...
### writeoffs
- Used by modules: opening_balance, tm_input_operations, material_writeoff, writeoff_analytics
- Files: 4

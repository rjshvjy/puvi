...
Generated: 2025-09-08 18:19:33.850014
...
### allocations
- Used by modules: expiry_utils, material_sales, tm_configs, sku_production, tm_output_operations, sku_outbound
- Files: 6
...
### batch
- Used by modules: material_sales, opening_balance, cost_management, material_writeoff, sku_production, traceability, masters_crud, tm_configs, blending, batch_production, writeoff_analytics, tm_input_operations, tm_output_operations, db_utils, app, tm_production_operations
- Files: 18
- Functions using this table:
...
- Used by modules: tm_configs, masters_crud, batch_production, masters_common, db_utils, cost_management, tm_production_operations
- Files: 7
- Functions using this table:
...
### batches
- Used by modules: tm_main, material_sales, opening_balance, material_writeoff, sku_production, blending, batch_production, app, tm_production_operations
- Files: 9
- Functions using this table:
...
- Used by modules: tm_configs, sku_production, blending, db_utils, tm_production_operations
- Files: 5
- Functions using this table:
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### blend_batches
- Used by modules: tm_main, tm_configs, sku_production, masters_crud, blending, tm_output_operations, db_utils, tm_production_operations
- Files: 8
- Functions using this table:
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
  - create_blend in puvi-backend/puvi-backend-main/modules/blending.py
...
### cascade_fields
- Used by modules: tm_main, tm_configs, tm_input_operations, tm_production_operations
- Files: 4

### categories
- Used by modules: material_writeoff, sku_production, masters_crud, system_config, masters_common
- Files: 9

### categories_master
- Used by modules: material_writeoff, purchase, masters_crud, blending, masters_common, db_utils, sku_outbound
- Files: 7
- Functions using this table:
...
### cost_elements
- Used by modules: masters_crud, batch_production, system_config, masters_common, cost_management
- Files: 24

### cost_elements_master
- Used by modules: package_sizes, sku_production, masters_crud, batch_production, system_config, db_utils, masters_common, cost_management, tm_production_operations
- Files: 9
- Functions using this table:
...
### customers
- Used by modules: customers, tm_output_operations, app, sku_outbound, locations
- Files: 16
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_customer_all_locations in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### database
- Used by modules: material_writeoff, sku_production, traceability, masters_crud, blending, system_config, masters_common, cost_management
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: masters_crud, masters_common, sku_management, tm_production_operations, traceability, tm_input_operations, cost_management, app, tm_main, expiry_utils, package_sizes, tm_configs, sku_production, sku_outbound, opening_balance, blending, tm_output_operations, date_utils, inventory_utils
- Files: 19
- Functions using this table:
...
### db_utils
- Used by modules: material_sales, customers, masters_crud, batch_production, masters_common, sku_management, tm_production_operations, tm_input_operations, cost_management, app, tm_main, package_sizes, material_writeoff, purchase, sku_production, writeoff_analytics, system_config, sku_outbound, locations, opening_balance, blending, tm_output_operations
- Files: 22

### decimal
- Used by modules: material_sales, masters_crud, batch_production, masters_common, sku_management, tm_production_operations, validation, tm_input_operations, cost_management, expiry_utils, package_sizes, purchase, sku_production, writeoff_analytics, sku_outbound, locations, opening_balance, blending, tm_output_operations, inventory_utils
- Files: 20
...
### dependencies
- Used by modules: masters_crud, masters_common, tm_output_operations, locations, sku_management, tm_production_operations
- Files: 6
...
### edit_status
- Used by modules: tm_input_operations, tm_configs, tm_output_operations, tm_production_operations
- Files: 4

### editable_fields
- Used by modules: tm_input_operations, tm_output_operations, tm_production_operations
- Files: 3
...
### errors
- Used by modules: opening_balance, customers, masters_crud, db_utils, app, locations, sku_management
- Files: 7

### existing
- Used by modules: expiry_utils, opening_balance, package_sizes, traceability, batch_production, cost_management, inventory_utils, tm_production_operations
- Files: 8
- Functions using this table:
...
### has_dependencies
- Used by modules: masters_crud, tm_input_operations, masters_common, tm_output_operations, locations, tm_production_operations
- Files: 6
...
### inventory
- Used by modules: material_sales, opening_balance, material_writeoff, purchase, sku_production, masters_crud, blending, batch_production, tm_input_operations, db_utils, inventory_utils, tm_production_operations
- Files: 14
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### items
- Used by modules: tm_configs, material_writeoff, purchase, sku_production, tm_input_operations, tm_output_operations, sku_outbound
- Files: 7
...
### locations_master
- Used by modules: expiry_utils, sku_production, tm_output_operations, app, sku_outbound, locations
- Files: 6
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### masters_audit_log
- Used by modules: sku_management, opening_balance, masters_common, db_utils
- Files: 4
- Functions using this table:
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - close_financial_year in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### material_writeoffs
- Used by modules: tm_main, tm_configs, opening_balance, material_writeoff, writeoff_analytics, tm_input_operations, masters_common, db_utils
- Files: 8
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: opening_balance, material_writeoff, purchase, sku_production, traceability, masters_crud, blending, batch_production, writeoff_analytics, system_config, tm_input_operations, masters_common, tm_output_operations, db_utils, app, tm_production_operations
- Files: 27
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: material_sales, opening_balance, material_writeoff, tm_configs, sku_production, writeoff_analytics, batch_production, tm_input_operations, masters_common, tm_output_operations, cost_management, sku_outbound, locations, tm_production_operations
- Files: 14
...
### oil
- Used by modules: material_writeoff, sku_production, tm_output_operations, tm_production_operations
- Files: 11
- Functions using this table:
...
### oil_cake_inventory
- Used by modules: material_sales, material_writeoff, batch_production, tm_input_operations, tm_output_operations, db_utils, tm_production_operations
- Files: 8
- Functions using this table:
  - get_material_sales_inventory in puvi-backend/puvi-backend-main/modules/material_sales.py
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
...
- Used by modules: material_sales, tm_configs, tm_output_operations, db_utils, tm_production_operations
- Files: 5
- Functions using this table:
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
...
### oil_cake_sales
- Used by modules: tm_main, material_sales, tm_configs, batch_production, tm_output_operations, db_utils
- Files: 7
- Functions using this table:
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
  - get_material_sales_history in puvi-backend/puvi-backend-main/modules/material_sales.py
...
### oil_types
- Used by modules: material_sales, material_writeoff, blending, batch_production, system_config
- Files: 7
...
### options
- Used by modules: app, package_sizes, masters_common, masters_crud
- Files: 4
...
### outbounds
- Used by modules: app, sku_outbound, tm_main, tm_output_operations
- Files: 4
...
- Used by modules: package_sizes, sku_production, masters_crud, masters_common, db_utils
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - create_production_plan in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### permissions
- Used by modules: tm_input_operations, tm_main, tm_output_operations, tm_production_operations
- Files: 4
...
### productions
- Used by modules: tm_main, sku_production, tm_output_operations, app, sku_management
- Files: 5
...
### purchase_items
- Used by modules: tm_configs, purchase, batch_production, tm_input_operations, masters_common, db_utils
- Files: 6
- Functions using this table:
...
### purchases
- Used by modules: tm_main, tm_configs, opening_balance, purchase, sku_production, blending, batch_production, tm_input_operations, masters_common, tm_output_operations, db_utils, app
- Files: 16
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: tm_main, package_sizes, customers, masters_crud, tm_input_operations, masters_common, tm_output_operations, locations, sku_management, tm_production_operations
- Files: 10
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sales
- Used by modules: tm_main, material_sales, masters_crud, tm_output_operations, app, sku_outbound
- Files: 6
...
### sku_expiry_tracking
- Used by modules: expiry_utils, sku_production, tm_output_operations, db_utils, sku_outbound, locations
- Files: 6
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: expiry_utils, material_writeoff, sku_production, tm_input_operations, tm_output_operations, db_utils, sku_outbound, locations
- Files: 8
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: expiry_utils, package_sizes, material_writeoff, sku_production, masters_crud, batch_production, system_config, tm_input_operations, tm_output_operations, db_utils, app, sku_outbound, sku_management
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_oil_allocation
- Used by modules: tm_configs, sku_production, tm_output_operations, db_utils, tm_production_operations
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - get_production_summary_report in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_production
- Used by modules: expiry_utils, material_writeoff, sku_production, tm_output_operations, db_utils, app, sku_outbound, sku_management
- Files: 8
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### statistics
- Used by modules: tm_main, opening_balance, masters_crud, writeoff_analytics, app
- Files: 5
...
### status
- Used by modules: tm_main, tm_configs, opening_balance, sku_production, masters_crud, tm_input_operations, tm_output_operations, app, sku_outbound, tm_production_operations
- Files: 10
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: purchase, masters_crud, blending, batch_production, masters_common, db_utils, sku_outbound
- Files: 7
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: material_sales, customers, masters_crud, batch_production, sku_management, tm_production_operations, tm_input_operations, cost_management, app, tm_main, expiry_utils, package_sizes, material_writeoff, purchase, sku_production, writeoff_analytics, system_config, sku_outbound, locations, opening_balance, blending, tm_output_operations
- Files: 22
...
### suppliers
- Used by modules: opening_balance, purchase, sku_production, traceability, system_config, tm_input_operations, masters_common, db_utils, app
- Files: 14
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### the
- Used by modules: masters_crud, traceability, batch_production, tm_input_operations, db_utils, cost_management, tm_production_operations
- Files: 7
- Functions using this table:
...
### utils
- Used by modules: expiry_utils, opening_balance, material_sales, purchase, sku_production, customers, material_writeoff, masters_crud, blending, batch_production, writeoff_analytics, tm_input_operations, tm_output_operations, cost_management, sku_outbound, locations, sku_management, tm_production_operations
- Files: 18
...
### writeoffs
- Used by modules: tm_main, opening_balance, material_writeoff, writeoff_analytics, tm_input_operations
- Files: 5

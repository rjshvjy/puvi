...
Generated: 2025-08-30 08:16:42.809928
...
### batch
- Used by modules: app, batch_production, material_writeoff, masters_crud, traceability, cost_management, sku_production, blending, opening_balance, writeoff_analytics, db_utils, material_sales
- Files: 14
- Functions using this table:
...
### batches
- Used by modules: app, batch_production, material_writeoff, sku_production, blending, opening_balance, material_sales
- Files: 7
- Functions using this table:
...
### categories
- Used by modules: material_writeoff, masters_crud, sku_production, sku_management, system_config, masters_common
- Files: 11

### categories_master
- Used by modules: material_writeoff, purchase, masters_crud, blending, db_utils, masters_common
- Files: 6
- Functions using this table:
...
### cost_elements
- Used by modules: batch_production, masters_crud, cost_management, sku_outbound, system_config, masters_common
- Files: 26

### cost_elements_master
- Used by modules: batch_production, cost_management, sku_production, sku_management, db_utils, system_config, masters_common, package_sizes
- Files: 8
- Functions using this table:
...
### customers
- Used by modules: app, sku_outbound, locations, customers
- Files: 14
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_outbound_history in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### database
- Used by modules: batch_production, material_writeoff, traceability, cost_management, sku_production, blending, system_config, masters_common
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: app, date_utils, inventory_utils, masters_crud, traceability, cost_management, expiry_utils, sku_production, blending, sku_management, opening_balance, sku_outbound, masters_common, package_sizes
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: app, batch_production, material_writeoff, locations, purchase, masters_crud, cost_management, sku_production, blending, customers, sku_management, opening_balance, writeoff_analytics, sku_outbound, system_config, material_sales, masters_common, package_sizes
- Files: 18

### decimal
- Used by modules: batch_production, locations, inventory_utils, purchase, masters_crud, cost_management, expiry_utils, validation, sku_production, blending, sku_management, opening_balance, writeoff_analytics, sku_outbound, material_sales, masters_common, package_sizes
- Files: 17
...
### errors
- Used by modules: app, masters_crud, customers, sku_management, opening_balance, db_utils, locations
- Files: 7

### existing
- Used by modules: batch_production, inventory_utils, traceability, cost_management, expiry_utils, sku_management, opening_balance, package_sizes
- Files: 8
- Functions using this table:
...
### flask
- Used by modules: app, batch_production, material_writeoff, locations, purchase, masters_crud, cost_management, sku_production, blending, customers, sku_management, opening_balance, writeoff_analytics, sku_outbound, system_config, material_sales, package_sizes
- Files: 17
...
### inventory
- Used by modules: batch_production, material_writeoff, inventory_utils, purchase, masters_crud, sku_production, blending, opening_balance, db_utils, material_sales
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### materials
- Used by modules: app, batch_production, material_writeoff, purchase, masters_crud, traceability, sku_production, blending, sku_management, opening_balance, writeoff_analytics, db_utils, system_config, masters_common
- Files: 27
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: material_writeoff, locations, cost_management, sku_production, sku_management, opening_balance, writeoff_analytics, sku_outbound, material_sales, masters_common
- Files: 10
...
### purchases
- Used by modules: app, batch_production, purchase, sku_production, blending, opening_balance, db_utils, masters_common
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: locations, masters_crud, customers, sku_management, masters_common, package_sizes
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sku_expiry_tracking
- Used by modules: expiry_utils, sku_production, sku_outbound, db_utils, locations
- Files: 5
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: material_writeoff, sku_production, sku_outbound, db_utils, locations
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: app, material_writeoff, masters_crud, expiry_utils, sku_production, sku_management, sku_outbound, db_utils, system_config, package_sizes
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: app, material_writeoff, expiry_utils, sku_production, sku_management, sku_outbound, db_utils
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### subcategories_master
- Used by modules: purchase, masters_crud, blending, db_utils, masters_common
- Files: 5
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: app, batch_production, material_writeoff, locations, purchase, masters_crud, cost_management, expiry_utils, sku_production, blending, customers, sku_management, opening_balance, writeoff_analytics, sku_outbound, system_config, material_sales, package_sizes
- Files: 18
...
### suppliers
- Used by modules: app, purchase, traceability, sku_production, opening_balance, db_utils, system_config, masters_common
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### utils
- Used by modules: batch_production, material_writeoff, locations, purchase, masters_crud, cost_management, expiry_utils, sku_production, blending, customers, sku_management, opening_balance, writeoff_analytics, sku_outbound, material_sales
- Files: 15

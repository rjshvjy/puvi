...
Generated: 2025-09-09 06:01:49.722356
...
### tm_main
Tables used: batches, blend_batches, blends, cascade_fields, config, datetime, db_utils, flask, function, has_items, immutable_fields, jwt, list_fields, material_writeoffs, modules, new_values, oil_cake_sales, old_values, operation, outbounds, permissions, productions, purchases, query, records, request, safe_fields, sales, statistics, status, success, transaction, transaction_audit_log, writeoffs
...
### address
- Used by modules: masters_common, locations, customers
- Files: 3
...
### allocations
- Used by modules: material_sales, tm_output_operations, sku_production, expiry_utils, sku_outbound, tm_configs
- Files: 6
...
### an
- Used by modules: masters_crud, locations, customers, sku_management
- Files: 4
- Functions using this table:
...
### batch
- Used by modules: masters_crud, material_sales, material_writeoff, opening_balance, db_utils, tm_output_operations, tm_input_operations, batch_production, writeoff_analytics, traceability, sku_production, app, tm_production_operations, blending, cost_management, tm_configs
- Files: 18
- Functions using this table:
...
- Used by modules: masters_crud, db_utils, batch_production, masters_common, tm_production_operations, cost_management, tm_configs
- Files: 7
- Functions using this table:
...
### batches
- Used by modules: material_sales, material_writeoff, opening_balance, tm_main, batch_production, sku_production, app, tm_production_operations, blending
- Files: 9
- Functions using this table:
...
- Used by modules: db_utils, sku_production, tm_production_operations, blending, tm_configs
- Files: 5
- Functions using this table:
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### blend_batches
- Used by modules: masters_crud, db_utils, tm_output_operations, tm_main, sku_production, tm_production_operations, blending, tm_configs
- Files: 8
- Functions using this table:
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
  - create_blend in puvi-backend/puvi-backend-main/modules/blending.py
...
### blends
- Used by modules: tm_main, tm_production_operations, blending
- Files: 3
...
- Used by modules: masters_common, db_utils, system_config
- Files: 3
- Functions using this table:
...
### bottles
- Used by modules: tm_input_operations, material_writeoff, system_config
- Files: 3
...
### cascade_fields
- Used by modules: tm_input_operations, tm_main, tm_production_operations, tm_configs
- Files: 4

### categories
- Used by modules: masters_crud, material_writeoff, masters_common, sku_production, system_config
- Files: 9

### categories_master
- Used by modules: masters_crud, material_writeoff, db_utils, masters_common, blending, sku_outbound, purchase
- Files: 7
- Functions using this table:
...
### changes
- Used by modules: tm_output_operations, tm_production_operations
- Files: 2
...
### components
- Used by modules: tm_configs, tm_production_operations, blending
- Files: 3

### config
- Used by modules: db_utils, tm_main
- Files: 24
- Functions using this table:
...
### cost_elements
- Used by modules: masters_crud, batch_production, masters_common, cost_management, system_config
- Files: 24

### cost_elements_master
- Used by modules: masters_crud, db_utils, package_sizes, batch_production, masters_common, sku_production, tm_production_operations, cost_management, system_config
- Files: 9
- Functions using this table:
...
### cost_override_log
- Used by modules: masters_common, db_utils, cost_management, tm_configs
- Files: 4
- Functions using this table:
  - save_batch_costs in puvi-backend/puvi-backend-main/modules/cost_management.py
...
### customers
- Used by modules: locations, tm_output_operations, app, sku_outbound, customers
- Files: 16
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_customer_all_locations in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### database
- Used by modules: masters_crud, material_writeoff, masters_common, traceability, sku_production, blending, cost_management, system_config
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: masters_crud, inventory_utils, tm_main, traceability, sku_production, tm_production_operations, opening_balance, tm_output_operations, blending, expiry_utils, tm_configs, sku_outbound, package_sizes, date_utils, tm_input_operations, masters_common, app, sku_management, cost_management
- Files: 19
- Functions using this table:
...
### days
- Used by modules: cost_management, masters_crud, sku_production
- Files: 3

### db_utils
- Used by modules: masters_crud, tm_main, writeoff_analytics, sku_production, tm_production_operations, system_config, material_sales, opening_balance, tm_output_operations, blending, customers, locations, batch_production, sku_outbound, material_writeoff, package_sizes, tm_input_operations, masters_common, app, sku_management, cost_management, purchase
- Files: 22

### decimal
- Used by modules: masters_crud, inventory_utils, writeoff_analytics, sku_production, tm_production_operations, material_sales, opening_balance, tm_output_operations, blending, expiry_utils, locations, validation, batch_production, sku_outbound, package_sizes, tm_input_operations, masters_common, sku_management, cost_management, purchase
- Files: 20
...
### dependencies
- Used by modules: masters_crud, locations, tm_output_operations, masters_common, tm_production_operations, sku_management
- Files: 6
...
### drying_loss
- Used by modules: tm_configs, tm_production_operations, batch_production
- Files: 3

### edit_status
- Used by modules: tm_output_operations, tm_input_operations, tm_production_operations, tm_configs
- Files: 4

### editable_fields
- Used by modules: tm_output_operations, tm_input_operations, tm_production_operations
- Files: 3
...
### errors
- Used by modules: masters_crud, locations, opening_balance, db_utils, app, sku_management, customers
- Files: 7

### existing
- Used by modules: opening_balance, package_sizes, inventory_utils, batch_production, traceability, tm_production_operations, expiry_utils, cost_management
- Files: 8
- Functions using this table:
...
### expiry
- Used by modules: sku_outbound, tm_output_operations, expiry_utils
- Files: 3
- Functions using this table:
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_outbound in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### extended_costs
- Used by modules: cost_management, tm_production_operations, batch_production
- Files: 3
...
### flask
- Used by modules: masters_crud, tm_main, writeoff_analytics, sku_production, tm_production_operations, system_config, material_sales, opening_balance, tm_output_operations, blending, customers, locations, batch_production, sku_outbound, material_writeoff, package_sizes, tm_input_operations, app, sku_management, cost_management, purchase
- Files: 21
...
### handling_charges
- Used by modules: tm_input_operations, purchase, tm_configs
- Files: 3

### has_dependencies
- Used by modules: masters_crud, locations, tm_output_operations, tm_input_operations, masters_common, tm_production_operations
- Files: 6
...
### if
- Used by modules: masters_crud, tm_output_operations, tm_production_operations
- Files: 3
- Functions using this table:
  - update_record in puvi-backend/puvi-backend-main/modules/masters_crud.py
...
### in
- Used by modules: package_sizes, masters_crud, sku_management
- Files: 3
- Functions using this table:
  - bulk_update_package_sizes in puvi-backend/puvi-backend-main/modules/package_sizes.py
  - bulk_update_weights in puvi-backend/puvi-backend-main/modules/sku_management.py
...
### inventory
- Used by modules: masters_crud, material_sales, material_writeoff, opening_balance, db_utils, tm_input_operations, inventory_utils, batch_production, sku_production, tm_production_operations, blending, purchase
- Files: 14
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### items
- Used by modules: material_writeoff, tm_output_operations, tm_input_operations, sku_production, sku_outbound, purchase, tm_configs
- Files: 7
...
### location
- Used by modules: sku_outbound, locations, expiry_utils
- Files: 3
- Functions using this table:
...
### locations
- Used by modules: sku_outbound, locations, app
- Files: 11

### locations_master
- Used by modules: locations, tm_output_operations, sku_production, app, expiry_utils, sku_outbound
- Files: 6
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### masters_audit_log
- Used by modules: masters_common, db_utils, sku_management, opening_balance
- Files: 4
- Functions using this table:
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - close_financial_year in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### material_writeoffs
- Used by modules: material_writeoff, opening_balance, db_utils, tm_input_operations, tm_main, writeoff_analytics, masters_common, tm_configs
- Files: 8
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: masters_crud, material_writeoff, opening_balance, db_utils, tm_output_operations, tm_input_operations, batch_production, writeoff_analytics, traceability, sku_production, masters_common, app, tm_production_operations, blending, purchase, system_config
- Files: 27
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### modules
- Used by modules: masters_crud, tm_main, app
- Files: 3
...
### notes
- Used by modules: material_sales, locations, material_writeoff, opening_balance, sku_outbound, tm_output_operations, tm_input_operations, batch_production, writeoff_analytics, sku_production, masters_common, tm_production_operations, cost_management, tm_configs
- Files: 14
...
### oil
- Used by modules: sku_production, tm_output_operations, material_writeoff, tm_production_operations
- Files: 11
- Functions using this table:
...
### oil_cake_inventory
- Used by modules: material_sales, material_writeoff, db_utils, tm_output_operations, tm_input_operations, batch_production, tm_production_operations
- Files: 8
- Functions using this table:
  - get_material_sales_inventory in puvi-backend/puvi-backend-main/modules/material_sales.py
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
...
- Used by modules: material_sales, db_utils, tm_output_operations, tm_production_operations, tm_configs
- Files: 5
- Functions using this table:
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
...
### oil_cake_sales
- Used by modules: material_sales, db_utils, tm_output_operations, tm_main, batch_production, tm_configs
- Files: 7
- Functions using this table:
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
  - get_material_sales_history in puvi-backend/puvi-backend-main/modules/material_sales.py
...
### oil_types
- Used by modules: material_sales, material_writeoff, batch_production, blending, system_config
- Files: 7
...
### operation
- Used by modules: tm_main, locations, customers
- Files: 3
- Functions using this table:
  - validate_customer_data in puvi-backend/puvi-backend-main/modules/customers.py
  - validate_location_data in puvi-backend/puvi-backend-main/modules/locations.py
...
### options
- Used by modules: masters_common, package_sizes, app, masters_crud
- Files: 4
...
### outbounds
- Used by modules: tm_main, sku_outbound, tm_output_operations, app
- Files: 4
...
### permissions
- Used by modules: tm_output_operations, tm_input_operations, tm_main, tm_production_operations
- Files: 4
...
### productions
- Used by modules: tm_output_operations, tm_main, sku_production, app, sku_management
- Files: 5
...
### purchase_items
- Used by modules: db_utils, tm_input_operations, batch_production, masters_common, purchase, tm_configs
- Files: 6
- Functions using this table:
...
### purchases
- Used by modules: opening_balance, db_utils, tm_output_operations, tm_input_operations, tm_main, batch_production, masters_common, sku_production, app, blending, purchase, tm_configs
- Files: 16
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: masters_crud, locations, package_sizes, tm_output_operations, tm_input_operations, tm_main, masters_common, tm_production_operations, sku_management, customers
- Files: 10
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### rates
- Used by modules: masters_crud, system_config, batch_production
- Files: 3
- Functions using this table:
  - bulk_update_cost_elements in puvi-backend/puvi-backend-main/modules/masters_crud.py
...
### records
- Used by modules: masters_crud, tm_main, expiry_utils
- Files: 3
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
- Functions using this table:
  ...
  - import_from_csv in puvi-backend/puvi-backend-main/modules/masters_crud.py
  - get_user_from_request in puvi-backend/puvi-backend-main/transaction_management/tm_main.py
  - delete_transaction in puvi-backend/puvi-backend-main/transaction_management/tm_main.py
...
### sales
- Used by modules: masters_crud, material_sales, tm_output_operations, tm_main, app, sku_outbound
- Files: 6
...
### set
- Used by modules: sku_outbound, traceability, opening_balance
- Files: 3
- Functions using this table:
  - get_next_serial in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_next_batch_serial in puvi-backend/puvi-backend-main/utils/traceability.py
...
### sku
- Used by modules: material_writeoff, tm_output_operations, batch_production, sku_outbound, system_config
- Files: 59
- Functions using this table:
  - get_oil_types in puvi-backend/puvi-backend-main/modules/batch_production.py
  - get_config in puvi-backend/puvi-backend-main/modules/system_config.py
...
### sku_bom_details
- Used by modules: db_utils, sku_production, sku_management
- Files: 3
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - create_production_plan in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_expiry_tracking
- Used by modules: locations, db_utils, tm_output_operations, sku_production, expiry_utils, sku_outbound
- Files: 6
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: locations, material_writeoff, db_utils, tm_output_operations, tm_input_operations, sku_production, expiry_utils, sku_outbound
- Files: 8
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: masters_crud, material_writeoff, db_utils, package_sizes, sku_management, tm_output_operations, tm_input_operations, batch_production, sku_production, app, expiry_utils, sku_outbound, system_config
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
- Used by modules: db_utils, tm_output_operations, sku_production
- Files: 3
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - get_production_summary_report in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_oil_allocation
- Used by modules: db_utils, tm_output_operations, sku_production, tm_production_operations, tm_configs
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - get_production_summary_report in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_outbound_items
- Used by modules: sku_outbound, tm_output_operations, tm_configs
- Files: 3
- Functions using this table:
  - create_outbound in puvi-backend/puvi-backend-main/modules/sku_outbound.py
  - get_outbound_history in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### sku_production
- Used by modules: material_writeoff, db_utils, tm_output_operations, sku_management, sku_production, app, expiry_utils, sku_outbound
- Files: 8
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### statistics
- Used by modules: masters_crud, opening_balance, tm_main, writeoff_analytics, app
- Files: 5
...
### status
- Used by modules: masters_crud, opening_balance, tm_output_operations, tm_input_operations, tm_main, sku_production, app, tm_production_operations, sku_outbound, tm_configs
- Files: 10
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py

### subcategories
- Used by modules: masters_common, masters_crud, batch_production
- Files: 8
- Functions using this table:
  - get_oil_types in puvi-backend/puvi-backend-main/modules/batch_production.py

### subcategories_master
- Used by modules: masters_crud, db_utils, batch_production, masters_common, blending, sku_outbound, purchase
- Files: 7
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: masters_crud, tm_main, writeoff_analytics, sku_production, tm_production_operations, system_config, material_sales, opening_balance, tm_output_operations, blending, expiry_utils, customers, locations, batch_production, sku_outbound, material_writeoff, package_sizes, tm_input_operations, app, sku_management, cost_management, purchase
- Files: 22
...
### suppliers
- Used by modules: opening_balance, db_utils, tm_input_operations, masters_common, traceability, sku_production, app, purchase, system_config
- Files: 14
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### the
- Used by modules: masters_crud, db_utils, tm_input_operations, batch_production, traceability, tm_production_operations, cost_management
- Files: 7
- Functions using this table:
...
### utils
- Used by modules: masters_crud, material_sales, locations, material_writeoff, opening_balance, sku_outbound, tm_output_operations, tm_input_operations, sku_management, batch_production, writeoff_analytics, sku_production, tm_production_operations, blending, expiry_utils, cost_management, purchase, customers
- Files: 18
...
### writeoff_reasons
- Used by modules: writeoff_analytics, material_writeoff, masters_common, system_config
- Files: 6
- Functions using this table:
  - get_writeoff_dashboard in puvi-backend/puvi-backend-main/modules/writeoff_analytics.py
  - get_writeoff_report in puvi-backend/puvi-backend-main/modules/writeoff_analytics.py
...
### writeoffs
- Used by modules: material_writeoff, opening_balance, tm_input_operations, tm_main, writeoff_analytics
- Files: 5

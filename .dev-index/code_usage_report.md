...
Generated: 2025-09-08 14:22:17.865329
...
### a
- Used by modules: tm_main, date_utils
- Files: 2
...
### allocations
- Used by modules: tm_output_operations, tm_configs, sku_production, material_sales, expiry_utils, sku_outbound
- Files: 6
...
### an
- Used by modules: sku_management, masters_crud, customers, locations
- Files: 4
- Functions using this table:
...
### batch
- Used by modules: traceability, cost_management, tm_output_operations, opening_balance, tm_configs, batch_production, sku_production, writeoff_analytics, tm_production_operations, material_sales, blending, app, masters_crud, material_writeoff, db_utils, tm_input_operations
- Files: 18
- Functions using this table:
...
- Used by modules: cost_management, tm_configs, batch_production, masters_crud, masters_common, tm_production_operations, db_utils
- Files: 7
- Functions using this table:
...
### batches
- Used by modules: opening_balance, batch_production, sku_production, tm_production_operations, material_sales, blending, app, material_writeoff
- Files: 8
- Functions using this table:
...
- Used by modules: tm_configs, sku_production, blending, tm_production_operations, db_utils
- Files: 5
- Functions using this table:
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### blend_batches
- Used by modules: tm_output_operations, tm_configs, sku_production, tm_main, blending, masters_crud, tm_production_operations, db_utils
- Files: 8
- Functions using this table:
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
  - create_blend in puvi-backend/puvi-backend-main/modules/blending.py
...
### cascade_fields
- Used by modules: tm_main, tm_configs, tm_production_operations, tm_input_operations
- Files: 4

### categories
- Used by modules: sku_production, system_config, masters_crud, masters_common, material_writeoff
- Files: 9

### categories_master
- Used by modules: sku_outbound, blending, purchase, masters_crud, masters_common, material_writeoff, db_utils
- Files: 7
- Functions using this table:
...
### components
- Used by modules: blending, tm_production_operations, tm_configs
- Files: 3
...
- Used by modules: cost_management, masters_crud, db_utils
- Files: 3
- Functions using this table:
...
### cost_elements
- Used by modules: cost_management, system_config, batch_production, masters_crud, masters_common
- Files: 24

### cost_elements_master
- Used by modules: cost_management, sku_production, package_sizes, system_config, batch_production, masters_crud, masters_common, tm_production_operations, db_utils
- Files: 9
- Functions using this table:
...
### cost_override_log
- Used by modules: cost_management, masters_common, db_utils, tm_configs
- Files: 4
- Functions using this table:
  - save_batch_costs in puvi-backend/puvi-backend-main/modules/cost_management.py
...
### customers
- Used by modules: locations, tm_output_operations, customers, sku_outbound, app
- Files: 16
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_customer_all_locations in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### database
- Used by modules: traceability, cost_management, sku_production, blending, system_config, masters_crud, masters_common, material_writeoff
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: traceability, cost_management, opening_balance, masters_common, tm_production_operations, package_sizes, masters_crud, tm_input_operations, sku_management, sku_production, expiry_utils, app, inventory_utils, date_utils, tm_output_operations, tm_configs, tm_main, blending, sku_outbound
- Files: 19
- Functions using this table:
...
### db_utils
- Used by modules: cost_management, opening_balance, writeoff_analytics, system_config, batch_production, purchase, masters_common, material_writeoff, tm_production_operations, locations, package_sizes, masters_crud, tm_input_operations, sku_management, sku_production, customers, app, tm_output_operations, tm_main, material_sales, blending, sku_outbound
- Files: 22

### decimal
- Used by modules: cost_management, opening_balance, writeoff_analytics, purchase, batch_production, masters_common, tm_production_operations, locations, package_sizes, validation, masters_crud, tm_input_operations, sku_management, sku_production, expiry_utils, inventory_utils, tm_output_operations, material_sales, blending, sku_outbound
- Files: 20
...
### dependencies
- Used by modules: sku_management, locations, tm_output_operations, masters_crud, masters_common, tm_production_operations
- Files: 6
...
### drying_loss
- Used by modules: tm_production_operations, tm_configs, batch_production
- Files: 3
...
### errors
- Used by modules: sku_management, locations, opening_balance, customers, app, masters_crud, db_utils
- Files: 7

### existing
- Used by modules: traceability, cost_management, opening_balance, package_sizes, expiry_utils, batch_production, tm_production_operations, inventory_utils
- Files: 8
- Functions using this table:
...
### flask
- Used by modules: cost_management, opening_balance, writeoff_analytics, system_config, batch_production, purchase, material_writeoff, tm_production_operations, locations, package_sizes, masters_crud, tm_input_operations, sku_management, sku_production, customers, app, tm_output_operations, tm_main, material_sales, blending, sku_outbound
- Files: 21
...
### has_dependencies
- Used by modules: locations, tm_output_operations, masters_crud, masters_common, tm_production_operations, tm_input_operations
- Files: 6
...
### in
- Used by modules: sku_management, package_sizes, masters_crud
- Files: 3
- Functions using this table:
  - bulk_update_package_sizes in puvi-backend/puvi-backend-main/modules/package_sizes.py
  - bulk_update_weights in puvi-backend/puvi-backend-main/modules/sku_management.py
...
### inventory
- Used by modules: opening_balance, tm_input_operations, sku_production, tm_production_operations, material_sales, blending, purchase, batch_production, masters_crud, material_writeoff, db_utils, inventory_utils
- Files: 14
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### items
- Used by modules: tm_output_operations, tm_configs, sku_production, sku_outbound, purchase, material_writeoff, tm_input_operations
- Files: 7
...
### location
- Used by modules: locations, expiry_utils, sku_outbound
- Files: 3
- Functions using this table:
...
### locations_master
- Used by modules: locations, tm_output_operations, sku_production, expiry_utils, sku_outbound, app
- Files: 6
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### masters_audit_log
- Used by modules: sku_management, masters_common, db_utils, opening_balance
- Files: 4
- Functions using this table:
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - close_financial_year in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### material_writeoffs
- Used by modules: opening_balance, tm_configs, writeoff_analytics, tm_main, masters_common, material_writeoff, db_utils, tm_input_operations
- Files: 8
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: traceability, tm_output_operations, opening_balance, batch_production, sku_production, writeoff_analytics, tm_production_operations, blending, system_config, app, purchase, masters_crud, masters_common, material_writeoff, db_utils, tm_input_operations
- Files: 27
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### modules
- Used by modules: tm_main, masters_crud, app
- Files: 3
...
### notes
- Used by modules: cost_management, locations, tm_output_operations, opening_balance, tm_configs, sku_production, writeoff_analytics, tm_production_operations, material_sales, sku_outbound, batch_production, masters_common, material_writeoff, tm_input_operations
- Files: 14
...
### oil
- Used by modules: sku_production, tm_production_operations, material_writeoff, tm_output_operations
- Files: 11
- Functions using this table:
...
### oil_cake_inventory
- Used by modules: tm_output_operations, tm_production_operations, material_sales, batch_production, material_writeoff, db_utils, tm_input_operations
- Files: 8
- Functions using this table:
  - get_material_sales_inventory in puvi-backend/puvi-backend-main/modules/material_sales.py
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
...
- Used by modules: tm_output_operations, tm_configs, material_sales, tm_production_operations, db_utils
- Files: 5
- Functions using this table:
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
...
### oil_cake_sales
- Used by modules: tm_output_operations, tm_configs, tm_main, material_sales, batch_production, db_utils
- Files: 7
- Functions using this table:
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
  - get_material_sales_history in puvi-backend/puvi-backend-main/modules/material_sales.py
...
### oil_types
- Used by modules: material_sales, blending, system_config, batch_production, material_writeoff
- Files: 7
...
### options
- Used by modules: package_sizes, masters_common, masters_crud, app
- Files: 4
...
### outbounds
- Used by modules: tm_output_operations, sku_outbound, app
- Files: 3
...
- Used by modules: sku_production, package_sizes, masters_crud, masters_common, db_utils
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - create_production_plan in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### parameters
- Used by modules: cost_management, masters_crud, sku_outbound
- Files: 3
- Functions using this table:
  - get_validation_report in puvi-backend/puvi-backend-main/modules/cost_management.py
...
### permissions
- Used by modules: tm_main, tm_output_operations, tm_production_operations, tm_input_operations
- Files: 4
...
### productions
- Used by modules: sku_management, sku_production, tm_output_operations, app
- Files: 4
...
### purchase_items
- Used by modules: tm_configs, purchase, batch_production, masters_common, db_utils, tm_input_operations
- Files: 6
- Functions using this table:
...
### purchases
- Used by modules: tm_output_operations, opening_balance, tm_configs, batch_production, sku_production, tm_main, blending, purchase, app, masters_common, db_utils, tm_input_operations
- Files: 16
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: sku_management, locations, tm_output_operations, customers, tm_main, package_sizes, masters_crud, masters_common, tm_production_operations, tm_input_operations
- Files: 10
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### records
- Used by modules: masters_crud, expiry_utils
- Files: 2
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### request
- Used by modules: tm_main, masters_crud, opening_balance
- Files: 3
- Functions using this table:
  - import_opening_balances in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - import_from_csv in puvi-backend/puvi-backend-main/modules/masters_crud.py
...
### sales
- Used by modules: masters_crud, material_sales, sku_outbound, app
- Files: 4
...
### sku
- Used by modules: tm_output_operations, sku_outbound, system_config, batch_production, material_writeoff
- Files: 59
- Functions using this table:
  - get_oil_types in puvi-backend/puvi-backend-main/modules/batch_production.py
  - get_config in puvi-backend/puvi-backend-main/modules/system_config.py
...
### sku_expiry_tracking
- Used by modules: locations, tm_output_operations, sku_production, expiry_utils, sku_outbound, db_utils
- Files: 6
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: locations, tm_output_operations, sku_production, expiry_utils, sku_outbound, material_writeoff, db_utils, tm_input_operations
- Files: 8
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: sku_management, tm_output_operations, sku_production, app, package_sizes, expiry_utils, sku_outbound, system_config, batch_production, masters_crud, material_writeoff, db_utils, tm_input_operations
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_oil_allocation
- Used by modules: tm_output_operations, tm_configs, sku_production, tm_production_operations, db_utils
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - get_production_summary_report in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_outbound_items
- Used by modules: tm_output_operations, sku_outbound, tm_configs
- Files: 3
- Functions using this table:
  - create_outbound in puvi-backend/puvi-backend-main/modules/sku_outbound.py
  - get_outbound_history in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### sku_production
- Used by modules: sku_management, tm_output_operations, sku_production, expiry_utils, sku_outbound, app, material_writeoff, db_utils
- Files: 8
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### statistics
- Used by modules: opening_balance, writeoff_analytics, tm_main, app, masters_crud
- Files: 5
...
### status
- Used by modules: tm_output_operations, opening_balance, tm_configs, sku_production, tm_main, sku_outbound, app, masters_crud, tm_production_operations, tm_input_operations
- Files: 10
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: sku_outbound, blending, purchase, batch_production, masters_crud, masters_common, db_utils
- Files: 7
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: cost_management, opening_balance, writeoff_analytics, system_config, batch_production, purchase, material_writeoff, tm_production_operations, locations, package_sizes, masters_crud, tm_input_operations, sku_management, sku_production, customers, expiry_utils, app, tm_output_operations, tm_main, material_sales, blending, sku_outbound
- Files: 22
...
### suppliers
- Used by modules: traceability, opening_balance, sku_production, system_config, app, purchase, masters_common, db_utils, tm_input_operations
- Files: 14
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### the
- Used by modules: traceability, cost_management, batch_production, masters_crud, tm_production_operations, db_utils, tm_input_operations
- Files: 7
- Functions using this table:
...
### utils
- Used by modules: cost_management, sku_management, locations, tm_output_operations, opening_balance, sku_production, writeoff_analytics, tm_production_operations, customers, material_sales, expiry_utils, blending, sku_outbound, purchase, batch_production, masters_crud, material_writeoff, tm_input_operations
- Files: 18
...
### writeoff_reasons
- Used by modules: writeoff_analytics, material_writeoff, system_config, masters_common
- Files: 6
- Functions using this table:
  - get_writeoff_dashboard in puvi-backend/puvi-backend-main/modules/writeoff_analytics.py
  - get_writeoff_report in puvi-backend/puvi-backend-main/modules/writeoff_analytics.py

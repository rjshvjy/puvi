...
Generated: 2025-08-31 06:04:21.899054
...
### allocations
- Used by modules: sku_outbound, sku_production, material_sales, expiry_utils
- Files: 4
...
### batch
- Used by modules: batch_production, blending, material_sales, traceability, writeoff_analytics, app, masters_crud, opening_balance, cost_management, material_writeoff, sku_production, db_utils
- Files: 14
- Functions using this table:
...
- Used by modules: masters_common, batch_production, db_utils, cost_management
- Files: 4
- Functions using this table:
...
### batches
- Used by modules: batch_production, blending, material_sales, app, opening_balance, material_writeoff, sku_production
- Files: 7
- Functions using this table:
...
### categories
- Used by modules: masters_common, masters_crud, material_writeoff, system_config, sku_production
- Files: 10

### categories_master
- Used by modules: blending, db_utils, masters_common, masters_crud, material_writeoff, purchase
- Files: 6
- Functions using this table:
...
### cost_elements
- Used by modules: batch_production, masters_common, masters_crud, system_config, cost_management
- Files: 25

### cost_elements_master
- Used by modules: batch_production, sku_production, masters_common, cost_management, system_config, package_sizes, db_utils
- Files: 7
- Functions using this table:
...
### database
- Used by modules: batch_production, blending, traceability, masters_common, material_writeoff, system_config, sku_production, cost_management
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: date_utils, blending, inventory_utils, traceability, masters_common, app, package_sizes, opening_balance, sku_outbound, masters_crud, expiry_utils, sku_management, sku_production, cost_management
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: customers, batch_production, blending, material_sales, writeoff_analytics, masters_common, app, locations, package_sizes, opening_balance, sku_outbound, purchase, material_writeoff, sku_management, masters_crud, system_config, sku_production, cost_management
- Files: 18

### decimal
- Used by modules: batch_production, blending, inventory_utils, material_sales, writeoff_analytics, masters_common, locations, validation, package_sizes, opening_balance, sku_outbound, purchase, expiry_utils, sku_management, masters_crud, sku_production, cost_management
- Files: 17
...
### errors
- Used by modules: customers, locations, app, masters_crud, opening_balance, sku_management, db_utils
- Files: 7

### existing
- Used by modules: batch_production, inventory_utils, traceability, opening_balance, expiry_utils, package_sizes, cost_management
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: customers, batch_production, blending, material_sales, writeoff_analytics, locations, app, package_sizes, opening_balance, sku_outbound, purchase, material_writeoff, sku_management, masters_crud, system_config, sku_production, cost_management
- Files: 17
...
### inventory
- Used by modules: batch_production, blending, inventory_utils, material_sales, masters_crud, opening_balance, purchase, material_writeoff, sku_production, db_utils
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### material_writeoffs
- Used by modules: writeoff_analytics, masters_common, opening_balance, material_writeoff, db_utils
- Files: 5
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: batch_production, blending, traceability, writeoff_analytics, app, masters_common, masters_crud, opening_balance, purchase, material_writeoff, system_config, sku_production, db_utils
- Files: 26
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: material_sales, masters_common, locations, opening_balance, sku_outbound, cost_management, material_writeoff, sku_production, writeoff_analytics
- Files: 9
...
### oil_types
- Used by modules: batch_production, blending, material_sales, material_writeoff, system_config
- Files: 7
...
### purchase_items
- Used by modules: purchase, batch_production, db_utils, masters_common
- Files: 4
- Functions using this table:
...
### purchases
- Used by modules: batch_production, blending, masters_common, app, opening_balance, purchase, sku_production, db_utils
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: customers, masters_common, locations, masters_crud, sku_management, package_sizes
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sales
- Used by modules: app, sku_outbound, material_sales, masters_common
- Files: 4
...
### sku_expiry_tracking
- Used by modules: locations, sku_outbound, expiry_utils, sku_production, db_utils
- Files: 5
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: locations, sku_outbound, material_writeoff, sku_production, db_utils
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: sku_production, app, masters_crud, sku_outbound, material_writeoff, expiry_utils, sku_management, system_config, package_sizes, db_utils
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: app, sku_outbound, material_writeoff, expiry_utils, sku_management, sku_production, db_utils
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### status
- Used by modules: app, masters_crud, opening_balance, sku_outbound, sku_production
- Files: 5
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: blending, db_utils, masters_common, masters_crud, purchase
- Files: 5
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: customers, batch_production, blending, material_sales, writeoff_analytics, locations, app, package_sizes, opening_balance, sku_outbound, purchase, expiry_utils, material_writeoff, sku_management, masters_crud, system_config, sku_production, cost_management
- Files: 18
...
### suppliers
- Used by modules: traceability, masters_common, app, opening_balance, purchase, system_config, sku_production, db_utils
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### utils
- Used by modules: customers, batch_production, blending, material_sales, writeoff_analytics, locations, masters_crud, opening_balance, sku_outbound, purchase, expiry_utils, material_writeoff, sku_management, sku_production, cost_management
- Files: 15

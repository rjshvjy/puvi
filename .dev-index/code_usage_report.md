...
Generated: 2025-09-02 04:46:02.958502
...
### allocations
- Used by modules: sku_production, expiry_utils, sku_outbound, material_sales
- Files: 4
...
### an
- Used by modules: sku_management, locations, masters_crud, customers
- Files: 4
- Functions using this table:
...
### batch
- Used by modules: db_utils, opening_balance, material_writeoff, app, batch_production, traceability, writeoff_analytics, sku_production, cost_management, blending, masters_crud, material_sales
- Files: 14
- Functions using this table:
...
- Used by modules: db_utils, masters_common, batch_production, cost_management
- Files: 4
- Functions using this table:
...
### batches
- Used by modules: opening_balance, material_writeoff, app, batch_production, sku_production, blending, material_sales
- Files: 7
- Functions using this table:
...
### blend_batches
- Used by modules: sku_production, db_utils, blending, masters_crud
- Files: 4
- Functions using this table:
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
  - create_blend in puvi-backend/puvi-backend-main/modules/blending.py
...
### categories
- Used by modules: material_writeoff, masters_common, sku_production, system_config, masters_crud
- Files: 10

### categories_master
- Used by modules: db_utils, material_writeoff, masters_common, blending, sku_outbound, masters_crud, purchase
- Files: 7
- Functions using this table:
...
- Used by modules: db_utils, masters_common, batch_production, system_config, package_sizes, sku_production, cost_management
- Files: 7
- Functions using this table:
...
### database
- Used by modules: material_writeoff, masters_common, batch_production, traceability, system_config, sku_production, cost_management, blending
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: sku_management, opening_balance, blending, masters_common, app, expiry_utils, traceability, date_utils, sku_production, package_sizes, cost_management, inventory_utils, sku_outbound, masters_crud
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: sku_management, opening_balance, purchase, material_writeoff, masters_common, app, batch_production, writeoff_analytics, system_config, package_sizes, sku_production, customers, cost_management, locations, blending, sku_outbound, masters_crud, material_sales
- Files: 18

### decimal
- Used by modules: sku_management, opening_balance, blending, purchase, masters_common, batch_production, expiry_utils, writeoff_analytics, package_sizes, sku_production, cost_management, validation, locations, inventory_utils, sku_outbound, masters_crud, material_sales
- Files: 17
...
### dependencies
- Used by modules: sku_management, locations, masters_crud, masters_common
- Files: 4
...
### errors
- Used by modules: sku_management, db_utils, opening_balance, app, customers, locations, masters_crud
- Files: 7

### existing
- Used by modules: opening_balance, batch_production, expiry_utils, traceability, package_sizes, cost_management, inventory_utils
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: sku_management, opening_balance, purchase, material_writeoff, app, batch_production, writeoff_analytics, system_config, package_sizes, sku_production, customers, cost_management, locations, blending, sku_outbound, masters_crud, material_sales
- Files: 17
...
### inventory
- Used by modules: db_utils, opening_balance, purchase, material_writeoff, batch_production, inventory_utils, sku_production, blending, masters_crud, material_sales
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### items
- Used by modules: sku_production, sku_outbound, material_writeoff, purchase
- Files: 4
...
### locations_master
- Used by modules: app, expiry_utils, sku_production, locations, sku_outbound
- Files: 5
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### material_writeoffs
- Used by modules: db_utils, opening_balance, material_writeoff, writeoff_analytics, masters_common
- Files: 5
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: db_utils, opening_balance, material_writeoff, app, batch_production, traceability, writeoff_analytics, system_config, sku_production, masters_common, blending, masters_crud, purchase
- Files: 26
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: opening_balance, material_writeoff, masters_common, writeoff_analytics, sku_production, cost_management, locations, sku_outbound, material_sales
- Files: 9
...
### oil_cake_inventory
- Used by modules: db_utils, material_writeoff, batch_production, material_sales
- Files: 5
- Functions using this table:
  - get_material_sales_inventory in puvi-backend/puvi-backend-main/modules/material_sales.py
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
...
### options
- Used by modules: package_sizes, masters_crud, masters_common, app
- Files: 4
...
### purchase_items
- Used by modules: db_utils, purchase, masters_common, batch_production
- Files: 4
- Functions using this table:
...
### purchases
- Used by modules: db_utils, opening_balance, app, batch_production, sku_production, masters_common, blending, purchase
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: sku_management, package_sizes, customers, masters_common, locations, masters_crud
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sales
- Used by modules: sku_outbound, masters_common, material_sales, app
- Files: 4
...
### sku_expiry_tracking
- Used by modules: db_utils, expiry_utils, sku_production, locations, sku_outbound
- Files: 5
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: db_utils, material_writeoff, expiry_utils, sku_production, locations, sku_outbound
- Files: 6
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: sku_management, db_utils, material_writeoff, app, expiry_utils, package_sizes, sku_production, system_config, sku_outbound, masters_crud
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: sku_management, db_utils, material_writeoff, app, expiry_utils, sku_production, sku_outbound
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### status
- Used by modules: opening_balance, app, sku_production, sku_outbound, masters_crud
- Files: 5
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: db_utils, masters_common, blending, sku_outbound, masters_crud, purchase
- Files: 6
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: sku_management, opening_balance, purchase, material_writeoff, app, batch_production, expiry_utils, writeoff_analytics, system_config, package_sizes, sku_production, customers, cost_management, locations, blending, sku_outbound, masters_crud, material_sales
- Files: 18
...
### suppliers
- Used by modules: db_utils, opening_balance, app, traceability, system_config, sku_production, masters_common, purchase
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### the
- Used by modules: db_utils, traceability, masters_crud, cost_management
- Files: 4
- Functions using this table:
...
### utils
- Used by modules: sku_management, opening_balance, purchase, material_writeoff, batch_production, expiry_utils, writeoff_analytics, sku_production, customers, cost_management, locations, blending, sku_outbound, masters_crud, material_sales
- Files: 15
...
### writeoff_reasons
- Used by modules: material_writeoff, system_config, writeoff_analytics, masters_common
- Files: 6
- Functions using this table:
  - get_writeoff_dashboard in puvi-backend/puvi-backend-main/modules/writeoff_analytics.py
  - get_writeoff_report in puvi-backend/puvi-backend-main/modules/writeoff_analytics.py

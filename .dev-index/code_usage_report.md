...
Generated: 2025-09-07 12:59:21.168925
...
### batch
- Used by modules: blending, app, material_writeoff, material_sales, masters_crud, writeoff_analytics, sku_production, batch_production, traceability, cost_management, db_utils, opening_balance
- Files: 14
- Functions using this table:
...
### batches
- Used by modules: blending, app, material_writeoff, material_sales, batch_production, opening_balance, sku_production
- Files: 7
- Functions using this table:
...
### categories_master
- Used by modules: blending, material_writeoff, sku_outbound, masters_common, db_utils, purchase, masters_crud
- Files: 7
- Functions using this table:
...
### cost_elements
- Used by modules: system_config, batch_production, masters_common, cost_management, masters_crud
- Files: 25

### cost_elements_master
- Used by modules: package_sizes, masters_crud, batch_production, system_config, masters_common, cost_management, db_utils, sku_production
- Files: 8
- Functions using this table:
...
### database
- Used by modules: blending, material_writeoff, masters_crud, batch_production, system_config, traceability, masters_common, cost_management, sku_production
- Files: 9
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: package_sizes, blending, app, masters_crud, sku_outbound, sku_management, sku_production, expiry_utils, traceability, masters_common, cost_management, date_utils, inventory_utils, opening_balance
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: package_sizes, blending, app, material_writeoff, material_sales, masters_crud, writeoff_analytics, locations, sku_outbound, sku_management, sku_production, batch_production, system_config, masters_common, customers, cost_management, purchase, opening_balance
- Files: 18

### decimal
- Used by modules: package_sizes, blending, material_sales, masters_crud, writeoff_analytics, locations, sku_outbound, sku_management, sku_production, expiry_utils, batch_production, masters_common, cost_management, inventory_utils, purchase, opening_balance, validation
- Files: 17
...
### errors
- Used by modules: app, masters_crud, locations, sku_management, customers, db_utils, opening_balance
- Files: 7

### existing
- Used by modules: package_sizes, expiry_utils, batch_production, traceability, cost_management, inventory_utils, opening_balance
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: package_sizes, blending, app, material_writeoff, material_sales, masters_crud, writeoff_analytics, locations, sku_outbound, sku_management, sku_production, batch_production, system_config, customers, cost_management, purchase, opening_balance
- Files: 17
...
### in
- Used by modules: package_sizes, masters_crud, sku_management, cost_management
- Files: 4
- Functions using this table:
  - bulk_update_cost_elements in puvi-backend/puvi-backend-main/modules/cost_management.py
  - bulk_update_package_sizes in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### inventory
- Used by modules: blending, material_writeoff, material_sales, masters_crud, sku_production, batch_production, db_utils, inventory_utils, purchase, opening_balance
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### locations_master
- Used by modules: app, locations, sku_outbound, expiry_utils, sku_production
- Files: 5
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### materials
- Used by modules: blending, app, material_writeoff, masters_crud, writeoff_analytics, sku_production, batch_production, system_config, traceability, masters_common, db_utils, purchase, opening_balance
- Files: 25
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: material_writeoff, material_sales, writeoff_analytics, locations, sku_outbound, opening_balance, masters_common, cost_management, sku_production
- Files: 9
...
- Used by modules: package_sizes, sku_production, masters_common, db_utils, masters_crud
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - create_production_plan in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### purchases
- Used by modules: blending, app, batch_production, opening_balance, masters_common, db_utils, purchase, sku_production
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: package_sizes, locations, sku_management, masters_common, customers, masters_crud
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sku_expiry_tracking
- Used by modules: locations, sku_outbound, expiry_utils, db_utils, sku_production
- Files: 5
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: material_writeoff, locations, sku_outbound, expiry_utils, db_utils, sku_production
- Files: 6
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: package_sizes, app, material_writeoff, masters_crud, sku_outbound, sku_management, expiry_utils, system_config, db_utils, sku_production
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: app, material_writeoff, sku_outbound, sku_management, expiry_utils, db_utils, sku_production
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### status
- Used by modules: app, masters_crud, sku_outbound, opening_balance, sku_production
- Files: 5
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: blending, sku_outbound, masters_common, db_utils, purchase, masters_crud
- Files: 6
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: package_sizes, blending, app, material_writeoff, material_sales, masters_crud, writeoff_analytics, locations, sku_outbound, sku_management, sku_production, expiry_utils, batch_production, system_config, customers, cost_management, purchase, opening_balance
- Files: 18
...
### suppliers
- Used by modules: app, system_config, opening_balance, traceability, masters_common, db_utils, purchase, sku_production
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### updates
- Used by modules: package_sizes, masters_crud, cost_management
- Files: 3
...
### utils
- Used by modules: blending, material_writeoff, material_sales, masters_crud, writeoff_analytics, locations, sku_outbound, sku_management, sku_production, expiry_utils, batch_production, customers, cost_management, purchase, opening_balance
- Files: 15

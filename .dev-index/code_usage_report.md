...
Generated: 2025-09-02 04:38:50.193689

## Summary
- Tables found in code: 373
...
### allocations
- Used by modules: sku_production, expiry_utils, material_sales, sku_outbound
- Files: 4
...
### batch
- Used by modules: traceability, writeoff_analytics, opening_balance, blending, cost_management, material_writeoff, batch_production, material_sales, db_utils, app, sku_production, masters_crud
- Files: 14
- Functions using this table:
...
- Used by modules: masters_common, batch_production, cost_management, db_utils
- Files: 4
- Functions using this table:
...
### batches
- Used by modules: opening_balance, blending, material_writeoff, batch_production, material_sales, app, sku_production
- Files: 7
- Functions using this table:
...
### blend_batches
- Used by modules: sku_production, blending, masters_crud, db_utils
- Files: 4
- Functions using this table:
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
  - create_blend in puvi-backend/puvi-backend-main/modules/blending.py
...
### categories
- Used by modules: masters_common, system_config, material_writeoff, sku_production, masters_crud
- Files: 10

### categories_master
- Used by modules: masters_common, purchase, sku_outbound, blending, material_writeoff, db_utils, masters_crud
- Files: 7
- Functions using this table:
...
### cost_elements
- Used by modules: masters_common, cost_management, system_config, batch_production, masters_crud
- Files: 25

### cost_elements_master
- Used by modules: masters_common, cost_management, system_config, package_sizes, batch_production, db_utils, sku_production
- Files: 7
- Functions using this table:
...
### customers
- Used by modules: locations, customers, sku_outbound, app
- Files: 14
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_outbound_history in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### database
- Used by modules: traceability, masters_common, blending, cost_management, system_config, material_writeoff, batch_production, sku_production
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: traceability, masters_common, inventory_utils, sku_management, sku_outbound, opening_balance, expiry_utils, blending, cost_management, package_sizes, date_utils, app, sku_production, masters_crud
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: masters_common, purchase, sku_management, writeoff_analytics, sku_outbound, opening_balance, cost_management, blending, system_config, package_sizes, material_writeoff, batch_production, material_sales, customers, app, sku_production, locations, masters_crud
- Files: 18

### decimal
- Used by modules: masters_common, purchase, inventory_utils, sku_management, writeoff_analytics, sku_outbound, opening_balance, expiry_utils, blending, cost_management, package_sizes, batch_production, material_sales, validation, sku_production, locations, masters_crud
- Files: 17
...
### dependencies
- Used by modules: masters_common, locations, sku_management, masters_crud
- Files: 4
...
### errors
- Used by modules: sku_management, opening_balance, app, customers, db_utils, locations, masters_crud
- Files: 7

### existing
- Used by modules: traceability, inventory_utils, opening_balance, expiry_utils, cost_management, package_sizes, batch_production
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: purchase, sku_management, writeoff_analytics, sku_outbound, opening_balance, cost_management, blending, system_config, package_sizes, material_writeoff, batch_production, material_sales, customers, app, sku_production, locations, masters_crud
- Files: 17
...
### in
- Used by modules: sku_management, cost_management, package_sizes
- Files: 3
- Functions using this table:
  - bulk_update_cost_elements in puvi-backend/puvi-backend-main/modules/cost_management.py
  - bulk_update_package_sizes in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### inventory
- Used by modules: purchase, inventory_utils, opening_balance, blending, material_writeoff, batch_production, material_sales, db_utils, sku_production, masters_crud
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### items
- Used by modules: sku_production, purchase, sku_outbound, material_writeoff
- Files: 4
...
### locations_master
- Used by modules: sku_outbound, expiry_utils, app, sku_production, locations
- Files: 5
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### material_writeoffs
- Used by modules: masters_common, writeoff_analytics, opening_balance, material_writeoff, db_utils
- Files: 5
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: traceability, masters_common, purchase, writeoff_analytics, opening_balance, blending, system_config, material_writeoff, batch_production, db_utils, app, sku_production, masters_crud
- Files: 26
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: masters_common, writeoff_analytics, sku_outbound, opening_balance, cost_management, material_writeoff, material_sales, sku_production, locations
- Files: 9
...
### oil_cake_inventory
- Used by modules: batch_production, material_sales, db_utils, material_writeoff
- Files: 5
- Functions using this table:
  - get_material_sales_inventory in puvi-backend/puvi-backend-main/modules/material_sales.py
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
...
- Used by modules: sku_production, package_sizes, db_utils
- Files: 3
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - create_production_plan in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### purchases
- Used by modules: masters_common, purchase, opening_balance, blending, batch_production, db_utils, app, sku_production
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: masters_common, sku_management, package_sizes, customers, locations, masters_crud
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sku_expiry_tracking
- Used by modules: sku_outbound, expiry_utils, db_utils, sku_production, locations
- Files: 5
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: sku_outbound, expiry_utils, material_writeoff, db_utils, sku_production, locations
- Files: 6
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: sku_management, sku_outbound, expiry_utils, system_config, package_sizes, material_writeoff, db_utils, app, sku_production, masters_crud
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: sku_management, sku_outbound, expiry_utils, material_writeoff, db_utils, app, sku_production
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### status
- Used by modules: sku_outbound, opening_balance, app, sku_production, masters_crud
- Files: 5
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: masters_common, purchase, sku_outbound, blending, db_utils, masters_crud
- Files: 6
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: purchase, sku_management, writeoff_analytics, sku_outbound, opening_balance, expiry_utils, blending, cost_management, system_config, package_sizes, material_writeoff, batch_production, material_sales, customers, app, sku_production, locations, masters_crud
- Files: 18
...
### suppliers
- Used by modules: traceability, masters_common, purchase, opening_balance, system_config, db_utils, app, sku_production
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### the
- Used by modules: traceability, cost_management, masters_crud, db_utils
- Files: 4
- Functions using this table:
...
### utils
- Used by modules: purchase, sku_management, writeoff_analytics, sku_outbound, opening_balance, expiry_utils, blending, cost_management, material_writeoff, batch_production, material_sales, customers, sku_production, locations, masters_crud
- Files: 15

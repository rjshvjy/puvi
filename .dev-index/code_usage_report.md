...
Generated: 2025-08-30 06:50:08.148336

## Summary
- Tables found in code: 368
- Backend files scanned: 27
- Frontend files scanned: 39
...
### batch
- Used by modules: material_writeoff, sku_production, db_utils, material_sales, batch_production, writeoff_analytics, masters_crud, app, cost_management, opening_balance, blending, traceability
- Files: 14
- Functions using this table:
...
- Used by modules: batch_production, cost_management, db_utils, masters_common
- Files: 4
- Functions using this table:
...
### batches
- Used by modules: material_writeoff, sku_production, material_sales, batch_production, app, opening_balance, blending
- Files: 7
- Functions using this table:
...
### categories
- Used by modules: material_writeoff, system_config, sku_production, sku_management, masters_common, masters_crud
- Files: 11
...
### cost_elements
- Used by modules: system_config, batch_production, masters_common, sku_outbound, masters_crud, cost_management
- Files: 26

### cost_elements_master
- Used by modules: system_config, sku_production, sku_management, db_utils, package_sizes, batch_production, masters_common, cost_management
- Files: 8
- Functions using this table:
...
### database
- Used by modules: material_writeoff, system_config, sku_production, batch_production, masters_common, cost_management, blending, traceability
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: expiry_utils, date_utils, sku_production, sku_management, package_sizes, inventory_utils, masters_common, sku_outbound, masters_crud, app, cost_management, opening_balance, blending, traceability
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: material_writeoff, system_config, customers, sku_production, sku_management, purchase, material_sales, package_sizes, batch_production, locations, writeoff_analytics, masters_common, sku_outbound, app, masters_crud, cost_management, opening_balance, blending
- Files: 18

### decimal
- Used by modules: expiry_utils, sku_production, sku_management, purchase, material_sales, package_sizes, inventory_utils, batch_production, locations, writeoff_analytics, masters_common, sku_outbound, masters_crud, cost_management, opening_balance, validation, blending
- Files: 17
...
### errors
- Used by modules: customers, sku_management, db_utils, locations, masters_crud, app, opening_balance
- Files: 7

### existing
- Used by modules: expiry_utils, sku_management, package_sizes, inventory_utils, batch_production, cost_management, opening_balance, traceability
- Files: 8
- Functions using this table:
...
### flask
- Used by modules: material_writeoff, system_config, customers, sku_production, sku_management, purchase, material_sales, package_sizes, batch_production, locations, writeoff_analytics, sku_outbound, masters_crud, app, cost_management, opening_balance, blending
- Files: 17
...
### inventory
- Used by modules: material_writeoff, sku_production, db_utils, purchase, material_sales, inventory_utils, batch_production, masters_crud, opening_balance, blending
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### material_writeoffs
- Used by modules: material_writeoff, db_utils, writeoff_analytics, masters_common, opening_balance
- Files: 5
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: material_writeoff, system_config, sku_production, sku_management, db_utils, purchase, batch_production, writeoff_analytics, masters_common, masters_crud, app, opening_balance, blending, traceability
- Files: 27
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: material_writeoff, sku_production, sku_management, material_sales, locations, writeoff_analytics, masters_common, sku_outbound, cost_management, opening_balance
- Files: 10
...
### purchases
- Used by modules: sku_production, db_utils, purchase, batch_production, masters_common, app, opening_balance, blending
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: customers, sku_management, package_sizes, locations, masters_common, masters_crud
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sku_expiry_tracking
- Used by modules: expiry_utils, sku_production, db_utils, locations, sku_outbound
- Files: 5
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: material_writeoff, sku_production, db_utils, locations, sku_outbound
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: material_writeoff, expiry_utils, system_config, sku_production, sku_management, db_utils, package_sizes, sku_outbound, masters_crud, app
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: material_writeoff, expiry_utils, sku_production, sku_management, db_utils, sku_outbound, app
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### status
- Used by modules: sku_production, masters_crud, sku_outbound, app, opening_balance
- Files: 5
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### success
- Used by modules: material_writeoff, expiry_utils, system_config, sku_production, customers, sku_management, purchase, material_sales, package_sizes, batch_production, locations, writeoff_analytics, sku_outbound, masters_crud, app, cost_management, opening_balance, blending
- Files: 18
...
### suppliers
- Used by modules: system_config, sku_production, db_utils, purchase, masters_common, app, opening_balance, traceability
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### utils
- Used by modules: material_writeoff, expiry_utils, customers, sku_production, sku_management, purchase, material_sales, batch_production, locations, writeoff_analytics, sku_outbound, masters_crud, cost_management, opening_balance, blending
- Files: 15

...
Generated: 2025-09-08 14:09:31.058076
...
### allocations
- Used by modules: expiry_utils, sku_outbound, tm_configs, material_sales, tm_output_operations, sku_production
- Files: 6
...
### an
- Used by modules: masters_crud, locations, sku_management, customers
- Files: 4
- Functions using this table:
...
### batch
- Used by modules: cost_management, tm_configs, material_writeoff, blending, masters_crud, tm_production_operations, material_sales, db_utils, app, traceability, writeoff_analytics, tm_output_operations, tm_input_operations, sku_production, opening_balance, batch_production
- Files: 18
- Functions using this table:
...
- Used by modules: cost_management, tm_configs, tm_production_operations, masters_common, db_utils, masters_crud, batch_production
- Files: 7
- Functions using this table:
...
### batches
- Used by modules: material_writeoff, blending, tm_production_operations, material_sales, app, sku_production, opening_balance, batch_production
- Files: 8
- Functions using this table:
...
- Used by modules: tm_configs, blending, tm_production_operations, db_utils, sku_production
- Files: 5
- Functions using this table:
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### blend_batches
- Used by modules: tm_configs, blending, tm_main, masters_crud, tm_production_operations, db_utils, tm_output_operations, sku_production
- Files: 8
- Functions using this table:
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
  - create_blend in puvi-backend/puvi-backend-main/modules/blending.py
...
### blends
- Used by modules: tm_production_operations, blending
- Files: 2
...
### bottles
- Used by modules: system_config, material_writeoff, tm_input_operations
- Files: 3
...
### cascade_fields
- Used by modules: tm_main, tm_production_operations, tm_configs, tm_input_operations
- Files: 4
...
### categories_master
- Used by modules: sku_outbound, purchase, material_writeoff, blending, masters_common, db_utils, masters_crud
- Files: 7
- Functions using this table:
...
### cost_elements
- Used by modules: system_config, cost_management, masters_common, masters_crud, batch_production
- Files: 24

### cost_elements_master
- Used by modules: system_config, cost_management, masters_crud, tm_production_operations, masters_common, package_sizes, db_utils, sku_production, batch_production
- Files: 9
- Functions using this table:
...
### customers
- Used by modules: customers, sku_outbound, app, tm_output_operations, locations
- Files: 16
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_customer_all_locations in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### database
- Used by modules: system_config, cost_management, material_writeoff, blending, masters_crud, masters_common, traceability, sku_production
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: sku_outbound, cost_management, sku_management, date_utils, app, package_sizes, masters_crud, sku_production, opening_balance, tm_production_operations, masters_common, traceability, expiry_utils, blending, tm_input_operations, tm_configs, inventory_utils, tm_main, tm_output_operations
- Files: 19
- Functions using this table:
...
### db_utils
- Used by modules: system_config, sku_outbound, cost_management, material_writeoff, sku_management, package_sizes, app, masters_crud, sku_production, opening_balance, tm_production_operations, masters_common, writeoff_analytics, blending, material_sales, tm_input_operations, customers, purchase, tm_main, tm_output_operations, locations, batch_production
- Files: 22

### decimal
- Used by modules: sku_outbound, cost_management, sku_management, package_sizes, masters_crud, sku_production, opening_balance, tm_production_operations, validation, masters_common, writeoff_analytics, expiry_utils, blending, material_sales, tm_input_operations, purchase, inventory_utils, tm_output_operations, locations, batch_production
- Files: 20
...
### dependencies
- Used by modules: sku_management, tm_production_operations, masters_common, tm_output_operations, locations, masters_crud
- Files: 6
...
### edit_status
- Used by modules: tm_output_operations, tm_production_operations, tm_configs, tm_input_operations
- Files: 4
...
### errors
- Used by modules: customers, sku_management, db_utils, app, locations, masters_crud, opening_balance
- Files: 7

### existing
- Used by modules: expiry_utils, cost_management, inventory_utils, tm_production_operations, package_sizes, traceability, opening_balance, batch_production
- Files: 8
- Functions using this table:
...
### flask
- Used by modules: system_config, sku_outbound, cost_management, material_writeoff, sku_management, package_sizes, app, masters_crud, sku_production, opening_balance, tm_production_operations, writeoff_analytics, blending, material_sales, tm_input_operations, customers, purchase, tm_main, tm_output_operations, locations, batch_production
- Files: 21
...
### has_dependencies
- Used by modules: tm_production_operations, masters_common, tm_input_operations, tm_output_operations, locations, masters_crud
- Files: 6
...
### impact
- Used by modules: material_writeoff, writeoff_analytics, tm_input_operations
- Files: 3
- Functions using this table:
  - refresh_writeoff_metrics in puvi-backend/puvi-backend-main/modules/writeoff_analytics.py
...
### in
- Used by modules: sku_management, masters_crud, package_sizes
- Files: 3
- Functions using this table:
  - bulk_update_package_sizes in puvi-backend/puvi-backend-main/modules/package_sizes.py
  - bulk_update_weights in puvi-backend/puvi-backend-main/modules/sku_management.py
...
### inventory
- Used by modules: purchase, material_writeoff, inventory_utils, blending, masters_crud, tm_production_operations, material_sales, db_utils, tm_input_operations, sku_production, opening_balance, batch_production
- Files: 14
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### items
- Used by modules: sku_outbound, tm_configs, purchase, material_writeoff, tm_input_operations, tm_output_operations, sku_production
- Files: 7
...
### locations_master
- Used by modules: expiry_utils, sku_outbound, app, tm_output_operations, locations, sku_production
- Files: 6
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### material_writeoffs
- Used by modules: tm_configs, material_writeoff, tm_main, masters_common, db_utils, writeoff_analytics, tm_input_operations, opening_balance
- Files: 8
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: system_config, purchase, material_writeoff, blending, masters_crud, tm_production_operations, masters_common, db_utils, app, traceability, writeoff_analytics, tm_output_operations, tm_input_operations, sku_production, opening_balance, batch_production
- Files: 27
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### net_loss
- Used by modules: tm_configs, material_writeoff, writeoff_analytics, tm_input_operations
- Files: 4
...
### notes
- Used by modules: sku_outbound, cost_management, tm_configs, material_writeoff, tm_production_operations, masters_common, material_sales, writeoff_analytics, tm_input_operations, tm_output_operations, locations, sku_production, opening_balance, batch_production
- Files: 14
...
### oil_cake_inventory
- Used by modules: material_writeoff, tm_production_operations, material_sales, db_utils, tm_input_operations, tm_output_operations, batch_production
- Files: 8
- Functions using this table:
  - get_material_sales_inventory in puvi-backend/puvi-backend-main/modules/material_sales.py
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
...
- Used by modules: tm_configs, tm_production_operations, material_sales, db_utils, tm_output_operations
- Files: 5
- Functions using this table:
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
...
### oil_cake_sales
- Used by modules: tm_configs, tm_main, material_sales, db_utils, tm_output_operations, batch_production
- Files: 7
- Functions using this table:
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
  - get_material_sales_history in puvi-backend/puvi-backend-main/modules/material_sales.py
...
### oil_types
- Used by modules: system_config, material_writeoff, blending, material_sales, batch_production
- Files: 7
...
### outbounds
- Used by modules: tm_output_operations, app, sku_outbound
- Files: 3
...
- Used by modules: masters_crud, masters_common, package_sizes, db_utils, sku_production
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - create_production_plan in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### permissions
- Used by modules: tm_output_operations, tm_production_operations, tm_main, tm_input_operations
- Files: 4
...
### productions
- Used by modules: tm_output_operations, sku_management, sku_production, app
- Files: 4
...
### purchase_items
- Used by modules: tm_configs, purchase, masters_common, db_utils, tm_input_operations, batch_production
- Files: 6
- Functions using this table:
...
### purchases
- Used by modules: tm_configs, purchase, blending, tm_main, masters_common, db_utils, app, tm_input_operations, tm_output_operations, sku_production, opening_balance, batch_production
- Files: 16
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: customers, sku_management, tm_main, tm_production_operations, masters_common, package_sizes, tm_input_operations, tm_output_operations, locations, masters_crud
- Files: 10
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sales
- Used by modules: masters_crud, material_sales, app, sku_outbound
- Files: 4
...
### set
- Used by modules: opening_balance, traceability, sku_outbound
- Files: 3
- Functions using this table:
  - get_next_serial in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_next_batch_serial in puvi-backend/puvi-backend-main/utils/traceability.py
...
### sku
- Used by modules: system_config, sku_outbound, material_writeoff, tm_output_operations, batch_production
- Files: 59
- Functions using this table:
  - get_oil_types in puvi-backend/puvi-backend-main/modules/batch_production.py
  - get_config in puvi-backend/puvi-backend-main/modules/system_config.py
...
### sku_expiry_tracking
- Used by modules: expiry_utils, sku_outbound, db_utils, tm_output_operations, locations, sku_production
- Files: 6
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: expiry_utils, sku_outbound, material_writeoff, db_utils, tm_input_operations, tm_output_operations, locations, sku_production
- Files: 8
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: expiry_utils, system_config, sku_outbound, material_writeoff, sku_management, masters_crud, db_utils, app, package_sizes, tm_input_operations, tm_output_operations, sku_production, batch_production
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_oil_allocation
- Used by modules: tm_configs, tm_production_operations, db_utils, tm_output_operations, sku_production
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - get_production_summary_report in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_production
- Used by modules: expiry_utils, sku_outbound, material_writeoff, sku_management, db_utils, app, tm_output_operations, sku_production
- Files: 8
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### statistics
- Used by modules: tm_main, writeoff_analytics, app, masters_crud, opening_balance
- Files: 5
...
### status
- Used by modules: sku_outbound, tm_configs, tm_main, tm_production_operations, app, tm_input_operations, tm_output_operations, sku_production, masters_crud, opening_balance
- Files: 10
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: sku_outbound, purchase, blending, masters_common, db_utils, masters_crud, batch_production
- Files: 7
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: system_config, sku_outbound, cost_management, material_writeoff, sku_management, package_sizes, app, masters_crud, sku_production, opening_balance, tm_production_operations, writeoff_analytics, expiry_utils, blending, material_sales, tm_input_operations, customers, purchase, tm_main, tm_output_operations, locations, batch_production
- Files: 22
...
### suppliers
- Used by modules: system_config, purchase, masters_common, db_utils, app, traceability, tm_input_operations, sku_production, opening_balance
- Files: 14
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### tags
- Used by modules: purchase, masters_common, db_utils
- Files: 3
- Functions using this table:
  - standardize_select_value in puvi-backend/puvi-backend-main/modules/masters_common.py
  - get_materials in puvi-backend/puvi-backend-main/modules/purchase.py
...
### the
- Used by modules: cost_management, tm_production_operations, db_utils, traceability, tm_input_operations, masters_crud, batch_production
- Files: 7
- Functions using this table:
...
### utils
- Used by modules: expiry_utils, customers, sku_outbound, cost_management, purchase, material_writeoff, sku_management, blending, masters_crud, tm_production_operations, material_sales, writeoff_analytics, tm_input_operations, tm_output_operations, locations, sku_production, opening_balance, batch_production
- Files: 18
...
### writeoffs
- Used by modules: writeoff_analytics, material_writeoff, opening_balance, tm_input_operations
- Files: 4

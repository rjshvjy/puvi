...
Generated: 2025-09-09 06:18:19.281502
...
### allocations
- Used by modules: tm_output_operations, material_sales, tm_configs, expiry_utils, sku_outbound, sku_production
- Files: 6
...
### an
- Used by modules: locations, masters_crud, sku_management, customers
- Files: 4
- Functions using this table:
...
### batch
- Used by modules: tm_output_operations, material_sales, tm_production_operations, db_utils, app, tm_configs, writeoff_analytics, traceability, blending, material_writeoff, opening_balance, masters_crud, batch_production, cost_management, sku_production, tm_input_operations
- Files: 18
- Functions using this table:
...
- Used by modules: tm_production_operations, tm_configs, db_utils, masters_crud, batch_production, cost_management, masters_common
- Files: 7
- Functions using this table:
...
### batches
- Used by modules: material_sales, tm_production_operations, app, blending, material_writeoff, opening_balance, batch_production, sku_production, tm_main
- Files: 9
- Functions using this table:
...
- Used by modules: tm_production_operations, tm_configs, db_utils, blending, sku_production
- Files: 5
- Functions using this table:
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### blend_batches
- Used by modules: tm_output_operations, tm_production_operations, tm_configs, db_utils, blending, masters_crud, sku_production, tm_main
- Files: 8
- Functions using this table:
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
  - create_blend in puvi-backend/puvi-backend-main/modules/blending.py
...
### categories
- Used by modules: system_config, material_writeoff, masters_crud, sku_production, masters_common
- Files: 9

### categories_master
- Used by modules: db_utils, sku_outbound, blending, material_writeoff, masters_crud, masters_common, purchase
- Files: 7
- Functions using this table:
...
### cost_elements
- Used by modules: system_config, masters_crud, batch_production, cost_management, masters_common
- Files: 24

### cost_elements_master
- Used by modules: tm_production_operations, db_utils, system_config, masters_crud, batch_production, package_sizes, cost_management, sku_production, masters_common
- Files: 9
- Functions using this table:
...
### customers
- Used by modules: tm_output_operations, app, sku_outbound, locations, customers
- Files: 16
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_customer_all_locations in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### database
- Used by modules: system_config, blending, traceability, material_writeoff, masters_crud, cost_management, sku_production, masters_common
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: date_utils, expiry_utils, app, package_sizes, tm_main, tm_output_operations, opening_balance, cost_management, masters_common, inventory_utils, sku_outbound, traceability, blending, masters_crud, sku_production, tm_production_operations, sku_management, tm_configs, tm_input_operations
- Files: 19
- Functions using this table:
...
### db_utils
- Used by modules: material_sales, app, locations, package_sizes, tm_main, customers, tm_output_operations, writeoff_analytics, opening_balance, cost_management, masters_common, purchase, system_config, sku_outbound, blending, masters_crud, sku_production, tm_production_operations, material_writeoff, batch_production, sku_management, tm_input_operations
- Files: 22

### decimal
- Used by modules: material_sales, expiry_utils, locations, validation, package_sizes, tm_output_operations, writeoff_analytics, opening_balance, cost_management, masters_common, inventory_utils, purchase, sku_outbound, blending, masters_crud, sku_production, tm_production_operations, batch_production, sku_management, tm_input_operations
- Files: 20
...
### dependencies
- Used by modules: tm_output_operations, tm_production_operations, masters_crud, locations, sku_management, masters_common
- Files: 6
...
### errors
- Used by modules: db_utils, app, masters_crud, opening_balance, locations, sku_management, customers
- Files: 7

### existing
- Used by modules: tm_production_operations, expiry_utils, traceability, opening_balance, batch_production, package_sizes, cost_management, inventory_utils
- Files: 8
- Functions using this table:
...
### flask
- Used by modules: material_sales, app, locations, package_sizes, tm_main, customers, tm_output_operations, writeoff_analytics, opening_balance, cost_management, purchase, system_config, sku_outbound, blending, masters_crud, sku_production, tm_production_operations, material_writeoff, batch_production, sku_management, tm_input_operations
- Files: 21
...
### handling_charges
- Used by modules: tm_configs, tm_input_operations, purchase
- Files: 3

### has_dependencies
- Used by modules: tm_output_operations, tm_production_operations, masters_crud, locations, masters_common, tm_input_operations
- Files: 6
...
### if
- Used by modules: tm_output_operations, masters_crud, tm_production_operations
- Files: 3
- Functions using this table:
  - update_record in puvi-backend/puvi-backend-main/modules/masters_crud.py
...
### inventory
- Used by modules: material_sales, tm_production_operations, db_utils, blending, material_writeoff, masters_crud, opening_balance, batch_production, tm_input_operations, sku_production, inventory_utils, purchase
- Files: 14
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### items
- Used by modules: tm_output_operations, tm_configs, sku_outbound, material_writeoff, sku_production, tm_input_operations, purchase
- Files: 7
...
### locations_master
- Used by modules: tm_output_operations, expiry_utils, app, sku_outbound, locations, sku_production
- Files: 6
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### masters_audit_log
- Used by modules: masters_common, sku_management, db_utils, opening_balance
- Files: 4
- Functions using this table:
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - close_financial_year in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### material_writeoffs
- Used by modules: tm_configs, db_utils, writeoff_analytics, material_writeoff, opening_balance, masters_common, tm_main, tm_input_operations
- Files: 8
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: tm_output_operations, tm_production_operations, db_utils, app, system_config, writeoff_analytics, blending, traceability, material_writeoff, opening_balance, masters_crud, batch_production, sku_production, masters_common, tm_input_operations, purchase
- Files: 27
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### net_loss
- Used by modules: writeoff_analytics, material_writeoff, tm_configs, tm_input_operations
- Files: 4
...
### notes
- Used by modules: tm_output_operations, material_sales, tm_production_operations, tm_configs, writeoff_analytics, sku_outbound, material_writeoff, opening_balance, locations, batch_production, cost_management, sku_production, masters_common, tm_input_operations
- Files: 14
...
### oil_cake_inventory
- Used by modules: tm_output_operations, material_sales, tm_production_operations, db_utils, material_writeoff, batch_production, tm_input_operations
- Files: 8
- Functions using this table:
  - get_material_sales_inventory in puvi-backend/puvi-backend-main/modules/material_sales.py
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
...
- Used by modules: tm_output_operations, material_sales, tm_production_operations, db_utils, tm_configs
- Files: 5
- Functions using this table:
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
...
### oil_cake_sales
- Used by modules: tm_output_operations, material_sales, db_utils, batch_production, tm_configs, tm_main
- Files: 7
- Functions using this table:
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
  - get_material_sales_history in puvi-backend/puvi-backend-main/modules/material_sales.py
...
### oil_types
- Used by modules: material_sales, system_config, material_writeoff, blending, batch_production
- Files: 7
...
### outbounds
- Used by modules: sku_outbound, tm_main, tm_output_operations, app
- Files: 4
...
- Used by modules: db_utils, masters_crud, package_sizes, sku_production, masters_common
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - create_production_plan in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### productions
- Used by modules: tm_output_operations, app, sku_management, sku_production, tm_main
- Files: 5
...
### purchase_items
- Used by modules: tm_configs, db_utils, batch_production, masters_common, tm_input_operations, purchase
- Files: 6
- Functions using this table:
...
### purchases
- Used by modules: tm_output_operations, tm_configs, db_utils, app, blending, opening_balance, batch_production, sku_production, tm_main, masters_common, tm_input_operations, purchase
- Files: 16
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: tm_output_operations, tm_production_operations, masters_crud, locations, sku_management, package_sizes, tm_input_operations, masters_common, tm_main, customers
- Files: 10
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### records
- Used by modules: tm_main, masters_crud, expiry_utils
- Files: 3
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sales
- Used by modules: tm_output_operations, material_sales, app, sku_outbound, masters_crud, tm_main
- Files: 6
...
### sku
- Used by modules: tm_output_operations, system_config, sku_outbound, material_writeoff, batch_production
- Files: 59
- Functions using this table:
  - get_oil_types in puvi-backend/puvi-backend-main/modules/batch_production.py
  - get_config in puvi-backend/puvi-backend-main/modules/system_config.py
...
### sku_expiry_tracking
- Used by modules: tm_output_operations, db_utils, expiry_utils, sku_outbound, locations, sku_production
- Files: 6
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: tm_output_operations, db_utils, expiry_utils, sku_outbound, material_writeoff, locations, sku_production, tm_input_operations
- Files: 8
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: tm_output_operations, expiry_utils, db_utils, app, system_config, sku_outbound, material_writeoff, masters_crud, batch_production, package_sizes, sku_management, sku_production, tm_input_operations
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_oil_allocation
- Used by modules: tm_output_operations, tm_production_operations, tm_configs, db_utils, sku_production
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - get_production_summary_report in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_production
- Used by modules: tm_output_operations, expiry_utils, db_utils, app, sku_outbound, material_writeoff, sku_management, sku_production
- Files: 8
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### statistics
- Used by modules: app, writeoff_analytics, masters_crud, opening_balance, tm_main
- Files: 5
...
### status
- Used by modules: tm_output_operations, tm_production_operations, tm_configs, app, sku_outbound, masters_crud, opening_balance, sku_production, tm_main, tm_input_operations
- Files: 10
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: db_utils, sku_outbound, blending, masters_crud, batch_production, masters_common, purchase
- Files: 7
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: material_sales, expiry_utils, app, locations, package_sizes, tm_main, customers, tm_output_operations, writeoff_analytics, opening_balance, cost_management, purchase, system_config, sku_outbound, blending, masters_crud, sku_production, tm_production_operations, material_writeoff, batch_production, sku_management, tm_input_operations
- Files: 22
...
### suppliers
- Used by modules: db_utils, app, system_config, traceability, opening_balance, sku_production, masters_common, tm_input_operations, purchase
- Files: 14
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### the
- Used by modules: tm_production_operations, db_utils, traceability, masters_crud, batch_production, cost_management, tm_input_operations
- Files: 7
- Functions using this table:
...
### utils
- Used by modules: tm_output_operations, material_sales, tm_production_operations, expiry_utils, writeoff_analytics, sku_outbound, blending, material_writeoff, masters_crud, opening_balance, locations, batch_production, sku_management, tm_input_operations, cost_management, sku_production, customers, purchase
- Files: 18
...
### writeoff_reasons
- Used by modules: writeoff_analytics, masters_common, system_config, material_writeoff
- Files: 6
- Functions using this table:
  - get_writeoff_dashboard in puvi-backend/puvi-backend-main/modules/writeoff_analytics.py
  - get_writeoff_report in puvi-backend/puvi-backend-main/modules/writeoff_analytics.py
...
### writeoffs
- Used by modules: writeoff_analytics, material_writeoff, opening_balance, tm_main, tm_input_operations
- Files: 5

...
Generated: 2025-08-30 18:49:30.201588
...
### batch
- Used by modules: batch_production, material_writeoff, opening_balance, material_sales, blending, cost_management, traceability, sku_production, app, masters_crud, writeoff_analytics, db_utils
- Files: 14
- Functions using this table:
...
### batches
- Used by modules: batch_production, material_writeoff, opening_balance, material_sales, blending, sku_production, app
- Files: 7
- Functions using this table:
...
### categories
- Used by modules: material_writeoff, masters_common, sku_production, masters_crud, system_config
- Files: 10
...
### cost_elements
- Used by modules: batch_production, cost_management, masters_common, masters_crud, system_config
- Files: 25

### cost_elements_master
- Used by modules: package_sizes, batch_production, cost_management, masters_common, sku_production, system_config, db_utils
- Files: 7
- Functions using this table:
...
### database
- Used by modules: batch_production, material_writeoff, cost_management, blending, traceability, masters_common, sku_production, system_config
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: package_sizes, sku_management, opening_balance, blending, expiry_utils, traceability, cost_management, masters_common, inventory_utils, app, sku_production, sku_outbound, masters_crud, date_utils
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: package_sizes, customers, sku_management, batch_production, material_writeoff, opening_balance, material_sales, cost_management, blending, masters_common, sku_production, app, sku_outbound, writeoff_analytics, system_config, masters_crud, purchase, locations
- Files: 18

### decimal
- Used by modules: package_sizes, sku_management, batch_production, opening_balance, material_sales, blending, expiry_utils, cost_management, masters_common, inventory_utils, sku_production, sku_outbound, validation, purchase, writeoff_analytics, masters_crud, locations
- Files: 17
...
### errors
- Used by modules: sku_management, customers, opening_balance, masters_crud, app, locations, db_utils
- Files: 7

### existing
- Used by modules: package_sizes, batch_production, opening_balance, cost_management, expiry_utils, traceability, inventory_utils
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: package_sizes, customers, sku_management, batch_production, material_writeoff, opening_balance, material_sales, cost_management, blending, sku_production, app, sku_outbound, writeoff_analytics, system_config, masters_crud, purchase, locations
- Files: 17
...
### inventory
- Used by modules: batch_production, material_writeoff, opening_balance, material_sales, blending, inventory_utils, sku_production, masters_crud, purchase, db_utils
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### material_writeoffs
- Used by modules: material_writeoff, opening_balance, masters_common, writeoff_analytics, db_utils
- Files: 5
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: batch_production, material_writeoff, opening_balance, blending, traceability, masters_common, sku_production, app, masters_crud, writeoff_analytics, system_config, purchase, db_utils
- Files: 26
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: material_writeoff, opening_balance, material_sales, cost_management, masters_common, sku_production, sku_outbound, writeoff_analytics, locations
- Files: 9
...
### oil_types
- Used by modules: batch_production, material_writeoff, material_sales, blending, system_config
- Files: 7
...
### purchases
- Used by modules: batch_production, opening_balance, blending, masters_common, sku_production, app, purchase, db_utils
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: package_sizes, sku_management, customers, masters_common, masters_crud, locations
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sku_master
- Used by modules: package_sizes, sku_management, material_writeoff, expiry_utils, sku_production, app, sku_outbound, masters_crud, system_config, db_utils
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: sku_management, material_writeoff, expiry_utils, sku_production, sku_outbound, app, db_utils
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### status
- Used by modules: opening_balance, masters_crud, sku_outbound, sku_production, app
- Files: 5
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: blending, masters_common, masters_crud, purchase, db_utils
- Files: 5
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: package_sizes, customers, sku_management, batch_production, material_writeoff, opening_balance, material_sales, blending, expiry_utils, cost_management, sku_production, app, sku_outbound, writeoff_analytics, system_config, masters_crud, purchase, locations
- Files: 18
...
### suppliers
- Used by modules: opening_balance, traceability, masters_common, sku_production, app, system_config, purchase, db_utils
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### the
- Used by modules: traceability, db_utils, masters_crud, cost_management
- Files: 4
- Functions using this table:
...
### utils
- Used by modules: customers, sku_management, batch_production, material_writeoff, opening_balance, material_sales, cost_management, expiry_utils, blending, sku_production, sku_outbound, masters_crud, writeoff_analytics, purchase, locations
- Files: 15

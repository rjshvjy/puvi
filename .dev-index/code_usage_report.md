...
Generated: 2025-09-08 17:50:56.133148
...
### tm_main
Tables used: blend_batches, cascade_fields, config, datetime, db_utils, flask, function, has_items, immutable_fields, jwt, list_fields, material_writeoffs, modules, new_values, oil_cake_sales, old_values, operation, permissions, purchases, query, request, safe_fields, statistics, status, success, transaction, transaction_audit_log
...
### allocations
- Used by modules: sku_production, sku_outbound, tm_configs, expiry_utils, tm_output_operations, material_sales
- Files: 6
...
### an
- Used by modules: customers, sku_management, masters_crud, locations
- Files: 4
- Functions using this table:
...
### batch
- Used by modules: tm_production_operations, material_writeoff, sku_production, cost_management, masters_crud, tm_configs, traceability, opening_balance, batch_production, tm_input_operations, app, blending, writeoff_analytics, tm_output_operations, db_utils, material_sales
- Files: 18
- Functions using this table:
...
- Used by modules: tm_production_operations, masters_crud, cost_management, tm_configs, batch_production, db_utils, masters_common
- Files: 7
- Functions using this table:
...
### batches
- Used by modules: tm_production_operations, material_writeoff, sku_production, opening_balance, batch_production, app, blending, material_sales
- Files: 8
- Functions using this table:
...
- Used by modules: tm_production_operations, sku_production, tm_configs, blending, db_utils
- Files: 5
- Functions using this table:
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### blend_batches
- Used by modules: tm_production_operations, masters_crud, sku_production, tm_configs, tm_main, blending, tm_output_operations, db_utils
- Files: 8
- Functions using this table:
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
  - create_blend in puvi-backend/puvi-backend-main/modules/blending.py
...
### cascade_fields
- Used by modules: tm_production_operations, tm_main, tm_input_operations, tm_configs
- Files: 4

### categories
- Used by modules: material_writeoff, masters_crud, sku_production, system_config, masters_common
- Files: 9

### categories_master
- Used by modules: material_writeoff, masters_crud, sku_outbound, blending, purchase, db_utils, masters_common
- Files: 7
- Functions using this table:
...
### cost_elements
- Used by modules: masters_crud, cost_management, batch_production, system_config, masters_common
- Files: 24

### cost_elements_master
- Used by modules: tm_production_operations, sku_production, cost_management, masters_crud, package_sizes, batch_production, system_config, db_utils, masters_common
- Files: 9
- Functions using this table:
...
### cost_override_log
- Used by modules: tm_configs, masters_common, db_utils, cost_management
- Files: 4
- Functions using this table:
  - save_batch_costs in puvi-backend/puvi-backend-main/modules/cost_management.py
...
### customers
- Used by modules: locations, sku_outbound, app, customers, tm_output_operations
- Files: 16
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_customer_all_locations in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### database
- Used by modules: material_writeoff, sku_production, cost_management, masters_crud, traceability, system_config, blending, masters_common
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: cost_management, sku_management, sku_production, sku_outbound, masters_crud, date_utils, tm_configs, traceability, tm_input_operations, opening_balance, app, tm_output_operations, tm_production_operations, inventory_utils, package_sizes, tm_main, expiry_utils, blending, masters_common
- Files: 19
- Functions using this table:
...
### db_utils
- Used by modules: cost_management, sku_management, batch_production, sku_production, sku_outbound, masters_crud, tm_input_operations, customers, material_writeoff, opening_balance, app, tm_output_operations, purchase, material_sales, tm_production_operations, locations, package_sizes, system_config, tm_main, blending, writeoff_analytics, masters_common
- Files: 22

### decimal
- Used by modules: cost_management, sku_management, batch_production, sku_production, sku_outbound, masters_crud, tm_input_operations, opening_balance, tm_output_operations, purchase, material_sales, tm_production_operations, inventory_utils, locations, validation, package_sizes, expiry_utils, blending, writeoff_analytics, masters_common
- Files: 20
...
### dependencies
- Used by modules: tm_production_operations, locations, masters_crud, sku_management, tm_output_operations, masters_common
- Files: 6
...
### errors
- Used by modules: locations, masters_crud, sku_management, opening_balance, app, customers, db_utils
- Files: 7

### existing
- Used by modules: tm_production_operations, inventory_utils, cost_management, package_sizes, opening_balance, traceability, batch_production, expiry_utils
- Files: 8
- Functions using this table:
...
### flask
- Used by modules: cost_management, sku_management, batch_production, sku_production, sku_outbound, masters_crud, tm_input_operations, customers, material_writeoff, opening_balance, app, tm_output_operations, purchase, material_sales, tm_production_operations, locations, package_sizes, system_config, tm_main, blending, writeoff_analytics
- Files: 21
...
### has_dependencies
- Used by modules: tm_production_operations, locations, masters_crud, tm_input_operations, tm_output_operations, masters_common
- Files: 6
...
### impact
- Used by modules: tm_input_operations, material_writeoff, writeoff_analytics
- Files: 3
- Functions using this table:
  - refresh_writeoff_metrics in puvi-backend/puvi-backend-main/modules/writeoff_analytics.py
...
### inventory
- Used by modules: tm_production_operations, inventory_utils, material_writeoff, sku_production, masters_crud, opening_balance, batch_production, tm_input_operations, blending, purchase, db_utils, material_sales
- Files: 14
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### items
- Used by modules: material_writeoff, sku_production, sku_outbound, tm_configs, tm_input_operations, tm_output_operations, purchase
- Files: 7
...
### locations_master
- Used by modules: locations, sku_production, sku_outbound, app, expiry_utils, tm_output_operations
- Files: 6
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### masters_audit_log
- Used by modules: sku_management, opening_balance, db_utils, masters_common
- Files: 4
- Functions using this table:
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - close_financial_year in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### material
- Used by modules: purchase, masters_crud, batch_production
- Files: 3
- Functions using this table:
  - add_batch in puvi-backend/puvi-backend-main/modules/batch_production.py
...
### material_writeoffs
- Used by modules: material_writeoff, tm_configs, opening_balance, tm_main, tm_input_operations, writeoff_analytics, db_utils, masters_common
- Files: 8
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: tm_production_operations, material_writeoff, sku_production, masters_crud, tm_output_operations, traceability, opening_balance, batch_production, system_config, tm_input_operations, app, blending, writeoff_analytics, purchase, db_utils, masters_common
- Files: 27
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### net_loss
- Used by modules: tm_configs, tm_input_operations, material_writeoff, writeoff_analytics
- Files: 4
...
### notes
- Used by modules: tm_production_operations, material_writeoff, locations, sku_production, cost_management, sku_outbound, tm_configs, masters_common, opening_balance, batch_production, tm_input_operations, writeoff_analytics, tm_output_operations, material_sales
- Files: 14
...
### oil
- Used by modules: tm_production_operations, material_writeoff, tm_output_operations, sku_production
- Files: 11
- Functions using this table:
...
### oil_cake_inventory
- Used by modules: tm_production_operations, material_writeoff, batch_production, tm_input_operations, tm_output_operations, db_utils, material_sales
- Files: 8
- Functions using this table:
  - get_material_sales_inventory in puvi-backend/puvi-backend-main/modules/material_sales.py
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
...
- Used by modules: tm_production_operations, tm_configs, tm_output_operations, db_utils, material_sales
- Files: 5
- Functions using this table:
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
...
### oil_cake_sales
- Used by modules: tm_configs, batch_production, tm_main, tm_output_operations, db_utils, material_sales
- Files: 7
- Functions using this table:
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
  - get_material_sales_history in puvi-backend/puvi-backend-main/modules/material_sales.py
...
### oil_types
- Used by modules: material_writeoff, batch_production, system_config, blending, material_sales
- Files: 7
...
### outbounds
- Used by modules: sku_outbound, tm_output_operations, app
- Files: 3
...
- Used by modules: masters_crud, sku_production, package_sizes, db_utils, masters_common
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - create_production_plan in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### permissions
- Used by modules: tm_production_operations, tm_main, tm_input_operations, tm_output_operations
- Files: 4
...
### productions
- Used by modules: sku_management, tm_output_operations, sku_production, app
- Files: 4
...
### purchase_items
- Used by modules: tm_configs, batch_production, tm_input_operations, purchase, db_utils, masters_common
- Files: 6
- Functions using this table:
...
### purchases
- Used by modules: sku_production, tm_configs, opening_balance, batch_production, tm_main, tm_input_operations, app, blending, tm_output_operations, purchase, db_utils, masters_common
- Files: 16
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: tm_production_operations, locations, masters_crud, package_sizes, sku_management, tm_main, tm_input_operations, customers, tm_output_operations, masters_common
- Files: 10
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### rates
- Used by modules: system_config, masters_crud, batch_production
- Files: 3
- Functions using this table:
  - bulk_update_cost_elements in puvi-backend/puvi-backend-main/modules/masters_crud.py
...
### sales
- Used by modules: masters_crud, sku_outbound, app, tm_output_operations, material_sales
- Files: 5
...
### sku
- Used by modules: material_writeoff, sku_outbound, batch_production, system_config, tm_output_operations
- Files: 59
- Functions using this table:
  - get_oil_types in puvi-backend/puvi-backend-main/modules/batch_production.py
  - get_config in puvi-backend/puvi-backend-main/modules/system_config.py
...
### sku_expiry_tracking
- Used by modules: locations, sku_production, sku_outbound, expiry_utils, tm_output_operations, db_utils
- Files: 6
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: material_writeoff, locations, sku_production, sku_outbound, tm_input_operations, expiry_utils, tm_output_operations, db_utils
- Files: 8
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: material_writeoff, sku_production, sku_outbound, masters_crud, package_sizes, sku_management, batch_production, system_config, tm_input_operations, app, expiry_utils, tm_output_operations, db_utils
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_oil_allocation
- Used by modules: tm_production_operations, sku_production, tm_configs, tm_output_operations, db_utils
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - get_production_summary_report in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_production
- Used by modules: material_writeoff, sku_production, sku_outbound, sku_management, app, expiry_utils, tm_output_operations, db_utils
- Files: 8
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### statistics
- Used by modules: masters_crud, opening_balance, tm_main, app, writeoff_analytics
- Files: 5
...
### status
- Used by modules: tm_production_operations, masters_crud, sku_outbound, sku_production, tm_configs, opening_balance, tm_main, tm_input_operations, app, tm_output_operations
- Files: 10
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: masters_crud, sku_outbound, batch_production, blending, purchase, db_utils, masters_common
- Files: 7
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: cost_management, sku_management, batch_production, sku_production, sku_outbound, masters_crud, tm_input_operations, customers, material_writeoff, opening_balance, app, tm_output_operations, purchase, material_sales, tm_production_operations, locations, package_sizes, system_config, tm_main, expiry_utils, blending, writeoff_analytics
- Files: 22
...
### suppliers
- Used by modules: sku_production, traceability, opening_balance, system_config, tm_input_operations, app, purchase, db_utils, masters_common
- Files: 14
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### the
- Used by modules: tm_production_operations, masters_crud, cost_management, traceability, batch_production, tm_input_operations, db_utils
- Files: 7
- Functions using this table:
...
### utils
- Used by modules: tm_production_operations, material_writeoff, locations, customers, sku_production, cost_management, sku_outbound, masters_crud, tm_output_operations, sku_management, opening_balance, batch_production, tm_input_operations, expiry_utils, blending, writeoff_analytics, purchase, material_sales
- Files: 18
...
### writeoff_reasons
- Used by modules: system_config, material_writeoff, writeoff_analytics, masters_common
- Files: 6
- Functions using this table:
  - get_writeoff_dashboard in puvi-backend/puvi-backend-main/modules/writeoff_analytics.py
  - get_writeoff_report in puvi-backend/puvi-backend-main/modules/writeoff_analytics.py
...
### writeoffs
- Used by modules: tm_input_operations, material_writeoff, writeoff_analytics, opening_balance
- Files: 4

...
Generated: 2025-08-31 07:24:29.088604
...
### allocations
- Used by modules: material_sales, sku_outbound, sku_production, expiry_utils
- Files: 4
...
### batch
- Used by modules: blending, batch_production, traceability, opening_balance, writeoff_analytics, material_writeoff, masters_crud, db_utils, material_sales, app, sku_production, cost_management
- Files: 14
- Functions using this table:
...
### batches
- Used by modules: blending, batch_production, opening_balance, material_writeoff, material_sales, app, sku_production
- Files: 7
- Functions using this table:
...
### categories
- Used by modules: material_writeoff, masters_crud, system_config, masters_common, sku_production
- Files: 10

### categories_master
- Used by modules: blending, material_writeoff, masters_crud, db_utils, masters_common, purchase
- Files: 6
- Functions using this table:
...
### cost_elements
- Used by modules: batch_production, masters_crud, system_config, masters_common, cost_management
- Files: 25

### cost_elements_master
- Used by modules: batch_production, package_sizes, db_utils, masters_common, system_config, sku_production, cost_management
- Files: 7
- Functions using this table:
...
### database
- Used by modules: blending, batch_production, traceability, material_writeoff, masters_common, system_config, sku_production, cost_management
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: blending, traceability, opening_balance, expiry_utils, date_utils, inventory_utils, masters_crud, package_sizes, sku_management, masters_common, app, sku_production, cost_management, sku_outbound
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: blending, batch_production, opening_balance, writeoff_analytics, material_writeoff, locations, masters_crud, package_sizes, sku_management, material_sales, masters_common, system_config, purchase, app, sku_production, customers, cost_management, sku_outbound
- Files: 18

### decimal
- Used by modules: blending, batch_production, opening_balance, writeoff_analytics, locations, expiry_utils, inventory_utils, masters_crud, package_sizes, sku_management, material_sales, masters_common, purchase, validation, sku_production, cost_management, sku_outbound
- Files: 17
...
### errors
- Used by modules: opening_balance, locations, masters_crud, sku_management, db_utils, customers, app
- Files: 7

### existing
- Used by modules: batch_production, opening_balance, traceability, expiry_utils, inventory_utils, package_sizes, cost_management
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: blending, batch_production, opening_balance, writeoff_analytics, material_writeoff, locations, masters_crud, package_sizes, sku_management, material_sales, system_config, customers, purchase, app, sku_production, cost_management, sku_outbound
- Files: 17
...
### inventory
- Used by modules: blending, batch_production, opening_balance, material_writeoff, inventory_utils, masters_crud, db_utils, material_sales, purchase, sku_production
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### material_writeoffs
- Used by modules: opening_balance, writeoff_analytics, material_writeoff, db_utils, masters_common
- Files: 5
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: blending, batch_production, traceability, opening_balance, writeoff_analytics, material_writeoff, masters_crud, db_utils, masters_common, system_config, purchase, app, sku_production
- Files: 26
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: opening_balance, writeoff_analytics, material_writeoff, locations, material_sales, masters_common, sku_production, cost_management, sku_outbound
- Files: 9
...
### purchases
- Used by modules: blending, batch_production, opening_balance, db_utils, masters_common, purchase, app, sku_production
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### sales
- Used by modules: material_sales, masters_common, sku_outbound, app
- Files: 4
...
### sku_expiry_tracking
- Used by modules: locations, expiry_utils, db_utils, sku_production, sku_outbound
- Files: 5
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_master
- Used by modules: material_writeoff, expiry_utils, masters_crud, package_sizes, db_utils, sku_management, system_config, app, sku_production, sku_outbound
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: material_writeoff, expiry_utils, sku_management, db_utils, app, sku_production, sku_outbound
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### subcategories_master
- Used by modules: blending, masters_crud, db_utils, masters_common, purchase
- Files: 5
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: blending, batch_production, opening_balance, writeoff_analytics, material_writeoff, expiry_utils, locations, masters_crud, package_sizes, sku_management, material_sales, system_config, customers, purchase, app, sku_production, cost_management, sku_outbound
- Files: 18
...
### suppliers
- Used by modules: traceability, opening_balance, db_utils, masters_common, system_config, purchase, app, sku_production
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### the
- Used by modules: cost_management, traceability, masters_crud, db_utils
- Files: 4
- Functions using this table:
...
### utils
- Used by modules: blending, batch_production, opening_balance, writeoff_analytics, material_writeoff, expiry_utils, locations, masters_crud, sku_management, material_sales, customers, purchase, sku_production, cost_management, sku_outbound
- Files: 15

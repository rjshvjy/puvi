...
Generated: 2025-09-07 13:22:52.248599
...
### batch
- Used by modules: opening_balance, material_writeoff, writeoff_analytics, material_sales, cost_management, traceability, masters_crud, batch_production, sku_production, blending, db_utils, app
- Files: 14
- Functions using this table:
...
- Used by modules: masters_common, cost_management, masters_crud, batch_production, db_utils
- Files: 5
- Functions using this table:
...
### batches
- Used by modules: opening_balance, material_writeoff, material_sales, batch_production, sku_production, blending, app
- Files: 7
- Functions using this table:
...
### categories
- Used by modules: material_writeoff, masters_common, masters_crud, system_config, sku_production
- Files: 10

### categories_master
- Used by modules: masters_common, material_writeoff, sku_outbound, purchase, masters_crud, blending, db_utils
- Files: 7
- Functions using this table:
...
- Used by modules: masters_common, cost_management, masters_crud, batch_production, system_config, sku_production, db_utils, package_sizes
- Files: 8
- Functions using this table:
...
### database
- Used by modules: masters_common, material_writeoff, cost_management, traceability, masters_crud, batch_production, system_config, sku_production, blending
- Files: 9
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: opening_balance, expiry_utils, masters_common, package_sizes, sku_outbound, cost_management, sku_management, traceability, masters_crud, sku_production, blending, date_utils, app, inventory_utils
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: opening_balance, masters_common, writeoff_analytics, material_writeoff, material_sales, sku_outbound, cost_management, sku_management, purchase, masters_crud, customers, locations, batch_production, system_config, sku_production, blending, app, package_sizes
- Files: 18

### decimal
- Used by modules: opening_balance, expiry_utils, writeoff_analytics, package_sizes, material_sales, masters_common, sku_outbound, cost_management, sku_management, purchase, masters_crud, locations, batch_production, sku_production, blending, validation, inventory_utils
- Files: 17
...
### errors
- Used by modules: opening_balance, sku_management, masters_crud, customers, locations, db_utils, app
- Files: 7

### existing
- Used by modules: opening_balance, expiry_utils, package_sizes, cost_management, traceability, batch_production, inventory_utils
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: opening_balance, material_writeoff, writeoff_analytics, material_sales, sku_outbound, cost_management, sku_management, purchase, masters_crud, customers, locations, batch_production, system_config, sku_production, blending, app, package_sizes
- Files: 17
...
### inventory
- Used by modules: opening_balance, material_writeoff, material_sales, purchase, masters_crud, batch_production, sku_production, blending, db_utils, inventory_utils
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### locations_master
- Used by modules: expiry_utils, sku_outbound, locations, sku_production, app
- Files: 5
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### materials
- Used by modules: opening_balance, masters_common, writeoff_analytics, material_writeoff, purchase, traceability, masters_crud, batch_production, system_config, sku_production, blending, db_utils, app
- Files: 25
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: opening_balance, masters_common, writeoff_analytics, material_writeoff, material_sales, sku_outbound, cost_management, locations, sku_production
- Files: 9
...
### oil_types
- Used by modules: material_writeoff, material_sales, batch_production, system_config, blending
- Files: 7
...
- Used by modules: masters_common, masters_crud, sku_production, db_utils, package_sizes
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - create_production_plan in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### purchases
- Used by modules: opening_balance, masters_common, purchase, batch_production, sku_production, blending, db_utils, app
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: masters_common, sku_management, masters_crud, customers, locations, package_sizes
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sku_expiry_tracking
- Used by modules: expiry_utils, sku_outbound, locations, sku_production, db_utils
- Files: 5
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: material_writeoff, expiry_utils, sku_outbound, locations, sku_production, db_utils
- Files: 6
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: expiry_utils, material_writeoff, sku_outbound, sku_management, masters_crud, system_config, sku_production, db_utils, app, package_sizes
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: expiry_utils, material_writeoff, sku_outbound, sku_management, sku_production, db_utils, app
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### status
- Used by modules: opening_balance, sku_outbound, masters_crud, sku_production, app
- Files: 5
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: masters_common, sku_outbound, purchase, masters_crud, blending, db_utils
- Files: 6
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: opening_balance, expiry_utils, writeoff_analytics, material_writeoff, material_sales, sku_outbound, cost_management, sku_management, purchase, masters_crud, customers, locations, batch_production, system_config, sku_production, blending, app, package_sizes
- Files: 18
...
### suppliers
- Used by modules: opening_balance, masters_common, purchase, traceability, system_config, sku_production, db_utils, app
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### utils
- Used by modules: opening_balance, expiry_utils, writeoff_analytics, material_writeoff, material_sales, sku_outbound, cost_management, sku_management, purchase, masters_crud, customers, locations, batch_production, sku_production, blending
- Files: 15

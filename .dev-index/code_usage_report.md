...
Generated: 2025-09-08 18:12:00.733767
...
### allocations
- Used by modules: tm_configs, tm_output_operations, sku_outbound, expiry_utils, material_sales, sku_production
- Files: 6
...
### batch
- Used by modules: traceability, masters_crud, blending, tm_configs, cost_management, batch_production, writeoff_analytics, material_writeoff, tm_output_operations, tm_input_operations, app, tm_production_operations, material_sales, db_utils, opening_balance, sku_production
- Files: 18
- Functions using this table:
...
- Used by modules: masters_crud, masters_common, tm_configs, cost_management, batch_production, tm_production_operations, db_utils
- Files: 7
- Functions using this table:
...
### batches
- Used by modules: blending, material_writeoff, batch_production, app, tm_production_operations, material_sales, opening_balance, sku_production
- Files: 8
- Functions using this table:
...
- Used by modules: blending, tm_configs, tm_production_operations, db_utils, sku_production
- Files: 5
- Functions using this table:
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### blend_batches
- Used by modules: masters_crud, blending, tm_configs, tm_output_operations, tm_production_operations, db_utils, tm_main, sku_production
- Files: 8
- Functions using this table:
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
  - create_blend in puvi-backend/puvi-backend-main/modules/blending.py
...
### bottles
- Used by modules: tm_input_operations, system_config, material_writeoff
- Files: 3
...
### cascade_fields
- Used by modules: tm_production_operations, tm_input_operations, tm_configs, tm_main
- Files: 4

### categories
- Used by modules: masters_crud, masters_common, system_config, material_writeoff, sku_production
- Files: 9

### categories_master
- Used by modules: masters_common, masters_crud, blending, material_writeoff, sku_outbound, purchase, db_utils
- Files: 7
- Functions using this table:
...
### cost_elements
- Used by modules: masters_crud, masters_common, system_config, cost_management, batch_production
- Files: 24

### cost_elements_master
- Used by modules: package_sizes, masters_common, masters_crud, system_config, cost_management, batch_production, tm_production_operations, db_utils, sku_production
- Files: 9
- Functions using this table:
...
### cost_override_log
- Used by modules: tm_configs, db_utils, masters_common, cost_management
- Files: 4
- Functions using this table:
  - save_batch_costs in puvi-backend/puvi-backend-main/modules/cost_management.py
...
### customers
- Used by modules: locations, tm_output_operations, sku_outbound, customers, app
- Files: 16
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_customer_all_locations in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### database
- Used by modules: traceability, masters_common, masters_crud, blending, system_config, cost_management, material_writeoff, sku_production
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: masters_crud, date_utils, blending, inventory_utils, cost_management, tm_output_operations, sku_production, sku_management, expiry_utils, tm_production_operations, opening_balance, traceability, package_sizes, masters_common, tm_main, tm_configs, tm_input_operations, sku_outbound, app
- Files: 19
- Functions using this table:
...
### db_utils
- Used by modules: locations, masters_crud, blending, cost_management, tm_output_operations, sku_production, sku_management, batch_production, tm_production_operations, material_sales, opening_balance, package_sizes, masters_common, system_config, material_writeoff, customers, tm_main, writeoff_analytics, tm_input_operations, sku_outbound, app, purchase
- Files: 22

### decimal
- Used by modules: locations, masters_crud, blending, inventory_utils, cost_management, tm_output_operations, sku_production, sku_management, batch_production, expiry_utils, tm_production_operations, material_sales, opening_balance, package_sizes, masters_common, validation, writeoff_analytics, tm_input_operations, sku_outbound, purchase
- Files: 20
...
### dependencies
- Used by modules: locations, sku_management, masters_crud, masters_common, tm_output_operations, tm_production_operations
- Files: 6
...
### edit_status
- Used by modules: tm_output_operations, tm_input_operations, tm_configs, tm_production_operations
- Files: 4
...
### errors
- Used by modules: locations, sku_management, masters_crud, customers, app, db_utils, opening_balance
- Files: 7

### existing
- Used by modules: traceability, package_sizes, inventory_utils, cost_management, batch_production, expiry_utils, tm_production_operations, opening_balance
- Files: 8
- Functions using this table:
...
### expiry
- Used by modules: tm_output_operations, sku_outbound, expiry_utils
- Files: 3
- Functions using this table:
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_outbound in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### flask
- Used by modules: locations, masters_crud, blending, cost_management, tm_output_operations, sku_production, sku_management, batch_production, tm_production_operations, material_sales, opening_balance, package_sizes, system_config, material_writeoff, customers, tm_main, writeoff_analytics, tm_input_operations, sku_outbound, app, purchase
- Files: 21
...
### has_dependencies
- Used by modules: locations, masters_crud, masters_common, tm_output_operations, tm_input_operations, tm_production_operations
- Files: 6
...
### inventory
- Used by modules: masters_crud, blending, inventory_utils, material_writeoff, batch_production, tm_input_operations, purchase, tm_production_operations, material_sales, db_utils, opening_balance, sku_production
- Files: 14
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### items
- Used by modules: tm_configs, material_writeoff, tm_output_operations, tm_input_operations, purchase, sku_outbound, sku_production
- Files: 7
...
### locations_master
- Used by modules: locations, tm_output_operations, sku_outbound, expiry_utils, app, sku_production
- Files: 6
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### masters_audit_log
- Used by modules: sku_management, db_utils, opening_balance, masters_common
- Files: 4
- Functions using this table:
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - close_financial_year in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### material_writeoffs
- Used by modules: masters_common, tm_main, tm_configs, material_writeoff, writeoff_analytics, tm_input_operations, db_utils, opening_balance
- Files: 8
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: traceability, masters_common, masters_crud, blending, system_config, material_writeoff, batch_production, writeoff_analytics, tm_output_operations, tm_input_operations, purchase, app, tm_production_operations, db_utils, opening_balance, sku_production
- Files: 27
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: locations, masters_common, tm_configs, cost_management, batch_production, writeoff_analytics, material_writeoff, tm_output_operations, tm_input_operations, sku_outbound, tm_production_operations, material_sales, opening_balance, sku_production
- Files: 14
...
### oil_cake_inventory
- Used by modules: material_writeoff, batch_production, tm_output_operations, tm_input_operations, tm_production_operations, material_sales, db_utils
- Files: 8
- Functions using this table:
  - get_material_sales_inventory in puvi-backend/puvi-backend-main/modules/material_sales.py
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
...
- Used by modules: tm_configs, tm_output_operations, tm_production_operations, material_sales, db_utils
- Files: 5
- Functions using this table:
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
...
### oil_cake_sales
- Used by modules: tm_configs, batch_production, tm_output_operations, material_sales, db_utils, tm_main
- Files: 7
- Functions using this table:
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
  - get_material_sales_history in puvi-backend/puvi-backend-main/modules/material_sales.py
...
### options
- Used by modules: masters_crud, package_sizes, masters_common, app
- Files: 4
...
- Used by modules: package_sizes, masters_crud, masters_common, db_utils, sku_production
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - create_production_plan in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### productions
- Used by modules: tm_output_operations, sku_management, app, sku_production
- Files: 4
...
### purchase_items
- Used by modules: masters_common, tm_configs, batch_production, tm_input_operations, purchase, db_utils
- Files: 6
- Functions using this table:
...
### purchases
- Used by modules: masters_common, tm_main, blending, tm_configs, batch_production, tm_output_operations, tm_input_operations, purchase, app, db_utils, opening_balance, sku_production
- Files: 16
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: locations, package_sizes, sku_management, masters_crud, masters_common, tm_output_operations, tm_input_operations, customers, tm_production_operations, tm_main
- Files: 10
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sales
- Used by modules: masters_crud, tm_output_operations, sku_outbound, app, material_sales
- Files: 5
...
### sku
- Used by modules: system_config, material_writeoff, batch_production, tm_output_operations, sku_outbound
- Files: 59
- Functions using this table:
  - get_oil_types in puvi-backend/puvi-backend-main/modules/batch_production.py
  - get_config in puvi-backend/puvi-backend-main/modules/system_config.py
...
### sku_expiry_tracking
- Used by modules: locations, tm_output_operations, sku_outbound, expiry_utils, db_utils, sku_production
- Files: 6
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: locations, material_writeoff, tm_output_operations, tm_input_operations, sku_outbound, expiry_utils, db_utils, sku_production
- Files: 8
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: package_sizes, sku_management, masters_crud, system_config, material_writeoff, batch_production, tm_output_operations, tm_input_operations, expiry_utils, app, sku_outbound, db_utils, sku_production
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_oil_allocation
- Used by modules: tm_configs, tm_output_operations, tm_production_operations, db_utils, sku_production
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - get_production_summary_report in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_production
- Used by modules: sku_management, material_writeoff, tm_output_operations, sku_outbound, expiry_utils, app, db_utils, sku_production
- Files: 8
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### statistics
- Used by modules: masters_crud, tm_main, writeoff_analytics, app, opening_balance
- Files: 5
...
### status
- Used by modules: masters_crud, tm_main, tm_configs, tm_output_operations, tm_input_operations, sku_outbound, app, tm_production_operations, opening_balance, sku_production
- Files: 10
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: masters_common, masters_crud, blending, batch_production, sku_outbound, purchase, db_utils
- Files: 7
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: locations, masters_crud, blending, cost_management, tm_output_operations, sku_production, sku_management, batch_production, expiry_utils, tm_production_operations, material_sales, opening_balance, package_sizes, system_config, material_writeoff, customers, tm_main, writeoff_analytics, tm_input_operations, sku_outbound, app, purchase
- Files: 22
...
### suppliers
- Used by modules: traceability, masters_common, system_config, tm_input_operations, purchase, app, db_utils, opening_balance, sku_production
- Files: 14
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### the
- Used by modules: traceability, masters_crud, cost_management, batch_production, tm_input_operations, tm_production_operations, db_utils
- Files: 7
- Functions using this table:
...
### utils
- Used by modules: locations, sku_management, masters_crud, blending, cost_management, batch_production, writeoff_analytics, material_writeoff, tm_output_operations, tm_input_operations, expiry_utils, sku_outbound, purchase, customers, material_sales, tm_production_operations, opening_balance, sku_production
- Files: 18
...
### writeoffs
- Used by modules: writeoff_analytics, tm_input_operations, opening_balance, material_writeoff
- Files: 4

...
Generated: 2025-09-07 16:47:23.895720
...
### allocations
- Used by modules: sku_production, material_sales, expiry_utils, sku_outbound
- Files: 4
...
### batch
- Used by modules: sku_production, material_sales, writeoff_analytics, traceability, blending, batch_production, app, db_utils, material_writeoff, opening_balance, masters_crud, cost_management
- Files: 14
- Functions using this table:
...
- Used by modules: masters_common, batch_production, db_utils, masters_crud, cost_management
- Files: 5
- Functions using this table:
...
### batches
- Used by modules: sku_production, material_sales, blending, batch_production, app, material_writeoff, opening_balance
- Files: 7
- Functions using this table:
...
### categories
- Used by modules: sku_production, system_config, masters_crud, material_writeoff, masters_common
- Files: 9

### categories_master
- Used by modules: blending, masters_crud, db_utils, material_writeoff, masters_common, purchase, sku_outbound
- Files: 7
- Functions using this table:
...
### cost_elements
- Used by modules: system_config, masters_common, batch_production, masters_crud, cost_management
- Files: 25

### cost_elements_master
- Used by modules: sku_production, system_config, package_sizes, masters_crud, db_utils, masters_common, cost_management
- Files: 7
- Functions using this table:
...
### database
- Used by modules: sku_production, system_config, traceability, blending, batch_production, masters_crud, material_writeoff, masters_common, cost_management
- Files: 9
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: sku_production, cost_management, expiry_utils, package_sizes, traceability, blending, sku_management, masters_common, app, masters_crud, opening_balance, date_utils, inventory_utils, sku_outbound
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: sku_production, system_config, customers, material_sales, locations, package_sizes, blending, writeoff_analytics, sku_management, batch_production, app, masters_crud, material_writeoff, opening_balance, masters_common, purchase, cost_management, sku_outbound
- Files: 18

### decimal
- Used by modules: sku_production, material_sales, cost_management, expiry_utils, locations, validation, blending, package_sizes, writeoff_analytics, sku_management, batch_production, masters_crud, opening_balance, masters_common, purchase, inventory_utils, sku_outbound
- Files: 17
...
### dependencies
- Used by modules: masters_common, locations, masters_crud, sku_management
- Files: 4
...
### errors
- Used by modules: customers, locations, sku_management, app, db_utils, opening_balance, masters_crud
- Files: 7

### existing
- Used by modules: expiry_utils, inventory_utils, package_sizes, traceability, batch_production, opening_balance, cost_management
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: sku_production, system_config, customers, material_sales, locations, package_sizes, blending, writeoff_analytics, sku_management, batch_production, app, material_writeoff, opening_balance, masters_crud, purchase, cost_management, sku_outbound
- Files: 17
...
### in
- Used by modules: sku_management, cost_management, masters_crud, package_sizes
- Files: 4
- Functions using this table:
  - bulk_update_cost_elements in puvi-backend/puvi-backend-main/modules/cost_management.py
  - bulk_update_package_sizes in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### inventory
- Used by modules: sku_production, material_sales, blending, batch_production, db_utils, material_writeoff, opening_balance, masters_crud, purchase, inventory_utils
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### locations_master
- Used by modules: sku_production, locations, expiry_utils, app, sku_outbound
- Files: 5
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### masters
- Used by modules: batch_production, app
- Files: 46
- Functions using this table:
...
### material_writeoffs
- Used by modules: writeoff_analytics, db_utils, material_writeoff, opening_balance, masters_common
- Files: 5
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: sku_production, system_config, writeoff_analytics, traceability, blending, batch_production, app, masters_crud, db_utils, material_writeoff, opening_balance, masters_common, purchase
- Files: 24
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### modules
- Used by modules: masters_crud, batch_production, app
- Files: 3
- Functions using this table:
  - get_cost_elements_for_batch in puvi-backend/puvi-backend-main/modules/batch_production.py
...
### notes
- Used by modules: sku_production, material_sales, locations, writeoff_analytics, material_writeoff, opening_balance, masters_common, cost_management, sku_outbound
- Files: 9
...
### oil_cake_inventory
- Used by modules: material_writeoff, material_sales, db_utils, batch_production
- Files: 5
- Functions using this table:
  - get_material_sales_inventory in puvi-backend/puvi-backend-main/modules/material_sales.py
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
...
### oil_types
- Used by modules: system_config, material_sales, blending, batch_production, material_writeoff
- Files: 7
...
- Used by modules: sku_production, package_sizes, masters_crud, db_utils, masters_common
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - create_production_plan in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### purchases
- Used by modules: sku_production, blending, batch_production, app, db_utils, opening_balance, masters_common, purchase
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: customers, locations, sku_management, package_sizes, masters_crud, masters_common
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sales
- Used by modules: material_sales, masters_crud, sku_outbound, app
- Files: 4
...
### sku_expiry_tracking
- Used by modules: sku_production, locations, expiry_utils, db_utils, sku_outbound
- Files: 5
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: sku_production, expiry_utils, locations, db_utils, material_writeoff, sku_outbound
- Files: 6
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: sku_production, system_config, expiry_utils, package_sizes, sku_management, app, db_utils, material_writeoff, masters_crud, sku_outbound
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: sku_production, expiry_utils, sku_management, app, db_utils, material_writeoff, sku_outbound
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### statistics
- Used by modules: opening_balance, masters_crud, writeoff_analytics, app
- Files: 4
...
### status
- Used by modules: sku_production, app, opening_balance, masters_crud, sku_outbound
- Files: 5
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: blending, masters_crud, db_utils, masters_common, purchase, sku_outbound
- Files: 6
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: sku_production, system_config, customers, material_sales, expiry_utils, locations, package_sizes, blending, writeoff_analytics, sku_management, batch_production, app, material_writeoff, opening_balance, masters_crud, purchase, cost_management, sku_outbound
- Files: 18
...
### suppliers
- Used by modules: sku_production, system_config, traceability, app, db_utils, opening_balance, masters_common, purchase
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### utils
- Used by modules: sku_production, customers, material_sales, expiry_utils, locations, writeoff_analytics, blending, sku_management, batch_production, material_writeoff, opening_balance, masters_crud, purchase, cost_management, sku_outbound
- Files: 15

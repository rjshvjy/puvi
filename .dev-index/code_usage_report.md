...
Generated: 2025-09-08 14:42:36.246765

## Summary
- Tables found in code: 448
...
### allocations
- Used by modules: material_sales, expiry_utils, sku_outbound, tm_configs, sku_production, tm_output_operations
- Files: 6
...
### an
- Used by modules: sku_management, customers, locations, masters_crud
- Files: 4
- Functions using this table:
...
### batch
- Used by modules: material_sales, writeoff_analytics, cost_management, sku_production, tm_configs, app, blending, tm_output_operations, masters_crud, traceability, db_utils, batch_production, tm_production_operations, tm_input_operations, opening_balance, material_writeoff
- Files: 18
- Functions using this table:
...
- Used by modules: cost_management, masters_common, masters_crud, db_utils, batch_production, tm_configs, tm_production_operations
- Files: 7
- Functions using this table:
...
### batches
- Used by modules: material_sales, blending, app, opening_balance, batch_production, tm_production_operations, sku_production, material_writeoff
- Files: 8
- Functions using this table:
...
- Used by modules: blending, db_utils, tm_configs, tm_production_operations, sku_production
- Files: 5
- Functions using this table:
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### blend_batches
- Used by modules: tm_main, blending, masters_crud, db_utils, tm_configs, tm_production_operations, sku_production, tm_output_operations
- Files: 8
- Functions using this table:
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
  - create_blend in puvi-backend/puvi-backend-main/modules/blending.py
...
### cascade_fields
- Used by modules: tm_configs, tm_production_operations, tm_input_operations, tm_main
- Files: 4

### categories
- Used by modules: sku_production, masters_common, masters_crud, system_config, material_writeoff
- Files: 9

### categories_master
- Used by modules: sku_outbound, blending, masters_common, masters_crud, db_utils, purchase, material_writeoff
- Files: 7
- Functions using this table:
...
### cost_elements
- Used by modules: cost_management, masters_common, masters_crud, batch_production, system_config
- Files: 24

### cost_elements_master
- Used by modules: system_config, cost_management, masters_common, package_sizes, masters_crud, db_utils, batch_production, tm_production_operations, sku_production
- Files: 9
- Functions using this table:
...
### customers
- Used by modules: sku_outbound, app, customers, locations, tm_output_operations
- Files: 16
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_customer_all_locations in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### database
- Used by modules: system_config, cost_management, masters_common, blending, masters_crud, traceability, sku_production, material_writeoff
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: package_sizes, date_utils, traceability, inventory_utils, opening_balance, expiry_utils, blending, masters_crud, tm_production_operations, sku_outbound, masters_common, tm_configs, sku_production, sku_management, tm_main, cost_management, app, tm_input_operations, tm_output_operations
- Files: 19
- Functions using this table:
...
### db_utils
- Used by modules: material_sales, writeoff_analytics, package_sizes, locations, opening_balance, blending, masters_crud, tm_production_operations, system_config, material_writeoff, sku_outbound, masters_common, batch_production, purchase, sku_production, sku_management, tm_main, cost_management, app, customers, tm_input_operations, tm_output_operations
- Files: 22

### decimal
- Used by modules: material_sales, writeoff_analytics, package_sizes, locations, inventory_utils, validation, opening_balance, expiry_utils, blending, masters_crud, tm_production_operations, sku_outbound, masters_common, batch_production, purchase, sku_production, sku_management, cost_management, tm_input_operations, tm_output_operations
- Files: 20
...
### dependencies
- Used by modules: sku_management, masters_common, locations, masters_crud, tm_production_operations, tm_output_operations
- Files: 6
...
### edit_status
- Used by modules: tm_configs, tm_production_operations, tm_input_operations, tm_output_operations
- Files: 4
...
### errors
- Used by modules: sku_management, app, customers, locations, masters_crud, db_utils, opening_balance
- Files: 7

### existing
- Used by modules: cost_management, expiry_utils, package_sizes, traceability, inventory_utils, tm_production_operations, batch_production, opening_balance
- Files: 8
- Functions using this table:
...
### flask
- Used by modules: material_sales, writeoff_analytics, package_sizes, locations, opening_balance, blending, masters_crud, tm_production_operations, system_config, material_writeoff, sku_outbound, batch_production, purchase, sku_production, sku_management, tm_main, cost_management, app, customers, tm_input_operations, tm_output_operations
- Files: 21
...
### has_dependencies
- Used by modules: masters_common, locations, masters_crud, tm_production_operations, tm_input_operations, tm_output_operations
- Files: 6
...
### inventory
- Used by modules: material_sales, tm_input_operations, sku_production, blending, masters_crud, purchase, db_utils, inventory_utils, tm_production_operations, batch_production, opening_balance, material_writeoff
- Files: 14
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### items
- Used by modules: tm_input_operations, sku_outbound, material_writeoff, tm_configs, purchase, sku_production, tm_output_operations
- Files: 7
...
### locations
- Used by modules: app, locations, sku_outbound
- Files: 11

### locations_master
- Used by modules: expiry_utils, sku_outbound, app, locations, sku_production, tm_output_operations
- Files: 6
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### material_writeoffs
- Used by modules: writeoff_analytics, tm_main, masters_common, db_utils, tm_configs, tm_input_operations, opening_balance, material_writeoff
- Files: 8
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: system_config, writeoff_analytics, tm_input_operations, sku_production, blending, app, masters_common, tm_output_operations, masters_crud, traceability, db_utils, batch_production, tm_production_operations, purchase, opening_balance, material_writeoff
- Files: 27
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: material_sales, writeoff_analytics, cost_management, sku_outbound, tm_configs, masters_common, tm_output_operations, locations, opening_balance, batch_production, tm_production_operations, tm_input_operations, sku_production, material_writeoff
- Files: 14
...
### oil_cake_inventory
- Used by modules: material_sales, material_writeoff, db_utils, batch_production, tm_production_operations, tm_input_operations, tm_output_operations
- Files: 8
- Functions using this table:
  - get_material_sales_inventory in puvi-backend/puvi-backend-main/modules/material_sales.py
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
...
- Used by modules: material_sales, db_utils, tm_configs, tm_production_operations, tm_output_operations
- Files: 5
- Functions using this table:
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
...
### oil_cake_sales
- Used by modules: tm_main, material_sales, db_utils, batch_production, tm_configs, tm_output_operations
- Files: 7
- Functions using this table:
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
  - get_material_sales_history in puvi-backend/puvi-backend-main/modules/material_sales.py
...
### oil_types
- Used by modules: material_sales, blending, batch_production, system_config, material_writeoff
- Files: 7
...
### outbounds
- Used by modules: app, tm_output_operations, sku_outbound
- Files: 3
...
- Used by modules: masters_common, package_sizes, masters_crud, db_utils, sku_production
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - create_production_plan in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### productions
- Used by modules: app, sku_management, sku_production, tm_output_operations
- Files: 4
...
### purchase_items
- Used by modules: masters_common, purchase, db_utils, batch_production, tm_configs, tm_input_operations
- Files: 6
- Functions using this table:
...
### purchases
- Used by modules: tm_input_operations, tm_main, blending, app, masters_common, opening_balance, db_utils, batch_production, tm_configs, purchase, sku_production, tm_output_operations
- Files: 16
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: sku_management, tm_main, masters_common, customers, package_sizes, locations, masters_crud, tm_production_operations, tm_input_operations, tm_output_operations
- Files: 10
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sku
- Used by modules: sku_outbound, material_writeoff, batch_production, system_config, tm_output_operations
- Files: 59
- Functions using this table:
  - get_oil_types in puvi-backend/puvi-backend-main/modules/batch_production.py
  - get_config in puvi-backend/puvi-backend-main/modules/system_config.py
...
### sku_expiry_tracking
- Used by modules: expiry_utils, sku_outbound, locations, db_utils, sku_production, tm_output_operations
- Files: 6
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: expiry_utils, sku_outbound, tm_output_operations, locations, db_utils, tm_input_operations, sku_production, material_writeoff
- Files: 8
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: system_config, sku_management, expiry_utils, sku_outbound, app, tm_output_operations, package_sizes, masters_crud, db_utils, batch_production, tm_input_operations, sku_production, material_writeoff
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: sku_management, expiry_utils, sku_outbound, app, tm_output_operations, db_utils, sku_production, material_writeoff
- Files: 8
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### status
- Used by modules: tm_main, sku_outbound, tm_configs, app, masters_crud, opening_balance, tm_production_operations, tm_input_operations, sku_production, tm_output_operations
- Files: 10
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: sku_outbound, blending, masters_common, masters_crud, db_utils, batch_production, purchase
- Files: 7
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: material_sales, writeoff_analytics, package_sizes, locations, opening_balance, expiry_utils, blending, masters_crud, tm_production_operations, system_config, material_writeoff, sku_outbound, batch_production, purchase, sku_production, sku_management, tm_main, cost_management, app, customers, tm_input_operations, tm_output_operations
- Files: 22
...
### suppliers
- Used by modules: db_utils, system_config, tm_input_operations, app, masters_common, opening_balance, traceability, purchase, sku_production
- Files: 14
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### the
- Used by modules: cost_management, masters_crud, traceability, db_utils, batch_production, tm_production_operations, tm_input_operations
- Files: 7
- Functions using this table:
...
### utils
- Used by modules: material_sales, writeoff_analytics, expiry_utils, cost_management, sku_production, sku_outbound, blending, sku_management, customers, locations, tm_output_operations, masters_crud, tm_input_operations, batch_production, tm_production_operations, purchase, opening_balance, material_writeoff
- Files: 18
...
### writeoff_reasons
- Used by modules: masters_common, writeoff_analytics, system_config, material_writeoff
- Files: 6
- Functions using this table:
  - get_writeoff_dashboard in puvi-backend/puvi-backend-main/modules/writeoff_analytics.py
  - get_writeoff_report in puvi-backend/puvi-backend-main/modules/writeoff_analytics.py
...
### writeoffs
- Used by modules: tm_input_operations, writeoff_analytics, opening_balance, material_writeoff
- Files: 4

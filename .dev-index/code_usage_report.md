...
Generated: 2025-09-07 11:09:18.388590
...
### batch
- Used by modules: opening_balance, batch_production, db_utils, traceability, material_sales, writeoff_analytics, sku_production, material_writeoff, app, cost_management, blending, masters_crud
- Files: 14
- Functions using this table:
...
- Used by modules: batch_production, db_utils, cost_management, masters_crud, masters_common
- Files: 5
- Functions using this table:
...
### batches
- Used by modules: opening_balance, batch_production, material_sales, sku_production, material_writeoff, app, blending
- Files: 7
- Functions using this table:
...
### categories
- Used by modules: system_config, sku_production, material_writeoff, masters_crud, masters_common
- Files: 10

### categories_master
- Used by modules: db_utils, material_writeoff, purchase, blending, sku_outbound, masters_crud, masters_common
- Files: 7
- Functions using this table:
...
- Used by modules: package_sizes, batch_production, db_utils, system_config, sku_production, cost_management, masters_crud, masters_common
- Files: 8
- Functions using this table:
...
### database
- Used by modules: batch_production, system_config, traceability, sku_production, material_writeoff, cost_management, blending, masters_crud, masters_common
- Files: 9
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: package_sizes, opening_balance, expiry_utils, traceability, sku_production, sku_outbound, app, cost_management, blending, date_utils, sku_management, inventory_utils, masters_crud, masters_common
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: package_sizes, locations, opening_balance, batch_production, system_config, material_sales, writeoff_analytics, sku_production, customers, material_writeoff, cost_management, app, purchase, blending, sku_management, sku_outbound, masters_crud, masters_common
- Files: 18

### decimal
- Used by modules: package_sizes, opening_balance, expiry_utils, batch_production, material_sales, writeoff_analytics, sku_production, sku_outbound, validation, cost_management, purchase, locations, blending, sku_management, inventory_utils, masters_crud, masters_common
- Files: 17
...
### errors
- Used by modules: opening_balance, db_utils, customers, app, locations, sku_management, masters_crud
- Files: 7

### existing
- Used by modules: package_sizes, opening_balance, expiry_utils, batch_production, traceability, cost_management, inventory_utils
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: package_sizes, locations, opening_balance, batch_production, system_config, material_sales, writeoff_analytics, sku_production, customers, material_writeoff, cost_management, app, purchase, blending, sku_management, sku_outbound, masters_crud
- Files: 17
...
### inventory
- Used by modules: opening_balance, batch_production, db_utils, material_sales, sku_production, material_writeoff, purchase, blending, inventory_utils, masters_crud
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### locations_master
- Used by modules: expiry_utils, sku_production, app, locations, sku_outbound
- Files: 5
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### material_writeoffs
- Used by modules: opening_balance, db_utils, writeoff_analytics, material_writeoff, masters_common
- Files: 5
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: opening_balance, batch_production, db_utils, system_config, traceability, writeoff_analytics, sku_production, material_writeoff, app, purchase, blending, masters_crud, masters_common
- Files: 26
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: opening_balance, material_sales, writeoff_analytics, sku_production, material_writeoff, cost_management, locations, sku_outbound, masters_common
- Files: 9
...
- Used by modules: package_sizes, db_utils, sku_production, masters_crud, masters_common
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - create_production_plan in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### purchases
- Used by modules: opening_balance, batch_production, db_utils, sku_production, app, purchase, blending, masters_common
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: package_sizes, customers, locations, sku_management, masters_crud, masters_common
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sku_inventory
- Used by modules: expiry_utils, db_utils, sku_production, material_writeoff, locations, sku_outbound
- Files: 6
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: package_sizes, expiry_utils, db_utils, system_config, sku_production, material_writeoff, app, sku_management, sku_outbound, masters_crud
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: expiry_utils, db_utils, sku_production, material_writeoff, app, sku_management, sku_outbound
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### status
- Used by modules: opening_balance, sku_production, app, sku_outbound, masters_crud
- Files: 5
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: db_utils, purchase, blending, sku_outbound, masters_crud, masters_common
- Files: 6
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: package_sizes, locations, opening_balance, expiry_utils, batch_production, system_config, material_sales, writeoff_analytics, sku_production, customers, material_writeoff, app, cost_management, purchase, blending, sku_management, sku_outbound, masters_crud
- Files: 18
...
### suppliers
- Used by modules: opening_balance, db_utils, system_config, traceability, sku_production, app, purchase, masters_common
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### utils
- Used by modules: opening_balance, expiry_utils, batch_production, material_sales, writeoff_analytics, sku_production, customers, material_writeoff, cost_management, purchase, locations, blending, sku_management, sku_outbound, masters_crud
- Files: 15

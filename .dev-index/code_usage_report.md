...
Generated: 2025-09-02 07:11:41.835403
...
### batch
- Used by modules: cost_management, db_utils, sku_production, blending, batch_production, material_sales, opening_balance, masters_crud, material_writeoff, traceability, writeoff_analytics, app
- Files: 14
- Functions using this table:
...
### batches
- Used by modules: blending, batch_production, material_sales, opening_balance, material_writeoff, sku_production, app
- Files: 7
- Functions using this table:
...
### blend_batches
- Used by modules: db_utils, sku_production, blending, masters_crud
- Files: 4
- Functions using this table:
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
  - create_blend in puvi-backend/puvi-backend-main/modules/blending.py
...
### categories
- Used by modules: system_config, masters_crud, material_writeoff, masters_common, sku_production
- Files: 10

### categories_master
- Used by modules: sku_outbound, db_utils, blending, purchase, masters_crud, material_writeoff, masters_common
- Files: 7
- Functions using this table:
...
- Used by modules: cost_management, db_utils, batch_production, system_config, package_sizes, masters_common, sku_production
- Files: 7
- Functions using this table:
...
### database
- Used by modules: cost_management, blending, batch_production, system_config, material_writeoff, masters_common, sku_production, traceability
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: cost_management, sku_outbound, inventory_utils, sku_production, blending, package_sizes, opening_balance, date_utils, sku_management, masters_crud, masters_common, traceability, expiry_utils, app
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: cost_management, sku_outbound, locations, blending, batch_production, purchase, material_sales, package_sizes, opening_balance, system_config, customers, sku_management, material_writeoff, masters_common, masters_crud, sku_production, writeoff_analytics, app
- Files: 18

### decimal
- Used by modules: cost_management, sku_outbound, inventory_utils, writeoff_analytics, locations, blending, batch_production, purchase, material_sales, package_sizes, opening_balance, sku_management, validation, masters_crud, masters_common, sku_production, expiry_utils
- Files: 17
...
### errors
- Used by modules: locations, db_utils, customers, opening_balance, sku_management, masters_crud, app
- Files: 7

### existing
- Used by modules: cost_management, inventory_utils, batch_production, package_sizes, opening_balance, traceability, expiry_utils
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: cost_management, sku_outbound, locations, blending, batch_production, purchase, material_sales, package_sizes, opening_balance, system_config, customers, sku_management, material_writeoff, masters_crud, sku_production, writeoff_analytics, app
- Files: 17
...
### inventory
- Used by modules: inventory_utils, db_utils, blending, batch_production, purchase, material_sales, opening_balance, masters_crud, material_writeoff, sku_production
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### material_writeoffs
- Used by modules: db_utils, opening_balance, material_writeoff, masters_common, writeoff_analytics
- Files: 5
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: db_utils, sku_production, blending, batch_production, purchase, system_config, opening_balance, masters_crud, material_writeoff, masters_common, traceability, writeoff_analytics, app
- Files: 26
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: cost_management, sku_outbound, locations, material_sales, opening_balance, material_writeoff, masters_common, sku_production, writeoff_analytics
- Files: 9
...
### oil_types
- Used by modules: blending, batch_production, material_sales, system_config, material_writeoff
- Files: 7
...
### purchases
- Used by modules: db_utils, blending, batch_production, purchase, opening_balance, masters_common, sku_production, app
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: locations, package_sizes, masters_crud, sku_management, customers, masters_common
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sku_expiry_tracking
- Used by modules: sku_outbound, locations, db_utils, sku_production, expiry_utils
- Files: 5
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: sku_outbound, locations, db_utils, material_writeoff, sku_production, expiry_utils
- Files: 6
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: sku_outbound, db_utils, system_config, package_sizes, sku_management, masters_crud, material_writeoff, sku_production, expiry_utils, app
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: sku_outbound, db_utils, sku_management, material_writeoff, sku_production, expiry_utils, app
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### subcategories_master
- Used by modules: sku_outbound, db_utils, blending, purchase, masters_crud, masters_common
- Files: 6
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: cost_management, sku_outbound, writeoff_analytics, locations, blending, batch_production, purchase, material_sales, package_sizes, opening_balance, system_config, customers, sku_management, material_writeoff, masters_crud, sku_production, expiry_utils, app
- Files: 18
...
### suppliers
- Used by modules: db_utils, purchase, system_config, opening_balance, masters_common, sku_production, app, traceability
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### utils
- Used by modules: cost_management, sku_outbound, writeoff_analytics, locations, blending, batch_production, purchase, material_sales, customers, opening_balance, sku_management, masters_crud, material_writeoff, sku_production, expiry_utils
- Files: 15

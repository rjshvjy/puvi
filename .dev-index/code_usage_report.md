...
Generated: 2025-09-07 12:53:35.566787
...
### batch
- Used by modules: blending, material_sales, traceability, app, writeoff_analytics, cost_management, masters_crud, opening_balance, batch_production, db_utils, material_writeoff, sku_production
- Files: 14
- Functions using this table:
...
### batches
- Used by modules: blending, material_sales, app, opening_balance, batch_production, material_writeoff, sku_production
- Files: 7
- Functions using this table:
...
### categories_master
- Used by modules: blending, sku_outbound, purchase, masters_common, masters_crud, db_utils, material_writeoff
- Files: 7
- Functions using this table:
...
- Used by modules: masters_common, cost_management, masters_crud, batch_production, db_utils, system_config, sku_production, package_sizes
- Files: 8
- Functions using this table:
...
### database
- Used by modules: blending, traceability, masters_common, cost_management, masters_crud, batch_production, material_writeoff, system_config, sku_production
- Files: 9
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: blending, date_utils, sku_outbound, traceability, masters_common, expiry_utils, app, cost_management, masters_crud, opening_balance, inventory_utils, sku_management, sku_production, package_sizes
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: blending, sku_outbound, material_sales, purchase, locations, masters_common, app, writeoff_analytics, cost_management, masters_crud, opening_balance, batch_production, material_writeoff, sku_management, system_config, customers, sku_production, package_sizes
- Files: 18

### decimal
- Used by modules: blending, sku_outbound, material_sales, purchase, locations, masters_common, expiry_utils, inventory_utils, cost_management, writeoff_analytics, masters_crud, opening_balance, batch_production, validation, sku_management, sku_production, package_sizes
- Files: 17
...
### errors
- Used by modules: locations, app, masters_crud, opening_balance, db_utils, sku_management, customers
- Files: 7

### existing
- Used by modules: traceability, expiry_utils, cost_management, opening_balance, batch_production, inventory_utils, package_sizes
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: blending, sku_outbound, material_sales, purchase, locations, app, writeoff_analytics, cost_management, masters_crud, opening_balance, batch_production, material_writeoff, sku_management, system_config, customers, sku_production, package_sizes
- Files: 17
...
### inventory
- Used by modules: blending, material_sales, purchase, masters_crud, opening_balance, batch_production, db_utils, material_writeoff, inventory_utils, sku_production
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### locations_master
- Used by modules: sku_outbound, locations, expiry_utils, app, sku_production
- Files: 5
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### material_writeoffs
- Used by modules: masters_common, writeoff_analytics, opening_balance, db_utils, material_writeoff
- Files: 5
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: blending, purchase, traceability, masters_common, app, writeoff_analytics, masters_crud, opening_balance, batch_production, db_utils, material_writeoff, system_config, sku_production
- Files: 25
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: sku_outbound, material_sales, locations, masters_common, writeoff_analytics, cost_management, opening_balance, material_writeoff, sku_production
- Files: 9
...
- Used by modules: masters_common, masters_crud, db_utils, sku_production, package_sizes
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - create_production_plan in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### purchase_items
- Used by modules: batch_production, db_utils, purchase, masters_common
- Files: 4
- Functions using this table:
...
### purchases
- Used by modules: blending, purchase, masters_common, app, opening_balance, batch_production, db_utils, sku_production
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: locations, masters_common, masters_crud, sku_management, customers, package_sizes
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sku_expiry_tracking
- Used by modules: sku_outbound, locations, expiry_utils, db_utils, sku_production
- Files: 5
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: sku_outbound, locations, expiry_utils, db_utils, material_writeoff, sku_production
- Files: 6
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: sku_outbound, expiry_utils, app, masters_crud, db_utils, material_writeoff, system_config, sku_management, sku_production, package_sizes
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: sku_outbound, expiry_utils, app, db_utils, material_writeoff, sku_management, sku_production
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### statistics
- Used by modules: app, writeoff_analytics, masters_crud, opening_balance
- Files: 4
...
### status
- Used by modules: sku_outbound, app, masters_crud, opening_balance, sku_production
- Files: 5
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### success
- Used by modules: blending, sku_outbound, material_sales, purchase, locations, expiry_utils, app, writeoff_analytics, cost_management, masters_crud, opening_balance, batch_production, material_writeoff, sku_management, system_config, customers, sku_production, package_sizes
- Files: 18
...
### suppliers
- Used by modules: purchase, traceability, masters_common, app, opening_balance, db_utils, system_config, sku_production
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### the
- Used by modules: db_utils, cost_management, traceability, masters_crud
- Files: 4
- Functions using this table:
...
### utils
- Used by modules: blending, sku_outbound, material_sales, purchase, locations, expiry_utils, writeoff_analytics, cost_management, masters_crud, opening_balance, batch_production, material_writeoff, sku_management, customers, sku_production
- Files: 15

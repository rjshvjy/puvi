...
Generated: 2025-09-01 07:11:36.700830
...
### batch
- Used by modules: batch_production, material_writeoff, opening_balance, cost_management, app, sku_production, blending, masters_crud, traceability, writeoff_analytics, db_utils, material_sales
- Files: 14
- Functions using this table:
...
- Used by modules: masters_common, cost_management, batch_production, db_utils
- Files: 4
- Functions using this table:
...
### batches
- Used by modules: batch_production, material_writeoff, opening_balance, app, sku_production, blending, material_sales
- Files: 7
- Functions using this table:
...
### categories
- Used by modules: masters_common, material_writeoff, sku_production, masters_crud, system_config
- Files: 10

### categories_master
- Used by modules: masters_common, material_writeoff, blending, masters_crud, sku_outbound, purchase, db_utils
- Files: 7
- Functions using this table:
...
### cost_elements
- Used by modules: masters_common, batch_production, cost_management, masters_crud, system_config
- Files: 25

### cost_elements_master
- Used by modules: masters_common, package_sizes, batch_production, cost_management, sku_production, system_config, db_utils
- Files: 7
- Functions using this table:
...
### customers
- Used by modules: app, locations, sku_outbound, customers
- Files: 14
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_outbound_history in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### database
- Used by modules: masters_common, batch_production, material_writeoff, cost_management, sku_production, blending, system_config, traceability
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: masters_common, package_sizes, date_utils, opening_balance, cost_management, inventory_utils, app, expiry_utils, sku_production, blending, sku_management, masters_crud, sku_outbound, traceability
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: masters_common, package_sizes, batch_production, customers, material_writeoff, opening_balance, cost_management, locations, app, sku_production, sku_management, blending, masters_crud, system_config, sku_outbound, purchase, writeoff_analytics, material_sales
- Files: 18

### decimal
- Used by modules: masters_common, package_sizes, batch_production, validation, opening_balance, cost_management, inventory_utils, expiry_utils, sku_production, sku_management, blending, masters_crud, sku_outbound, locations, purchase, writeoff_analytics, material_sales
- Files: 17
...
### errors
- Used by modules: opening_balance, locations, app, sku_management, masters_crud, customers, db_utils
- Files: 7

### existing
- Used by modules: package_sizes, batch_production, opening_balance, cost_management, inventory_utils, expiry_utils, traceability
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: package_sizes, batch_production, customers, material_writeoff, opening_balance, cost_management, locations, app, sku_production, sku_management, blending, masters_crud, system_config, sku_outbound, purchase, writeoff_analytics, material_sales
- Files: 17
...
### inventory
- Used by modules: batch_production, material_writeoff, opening_balance, inventory_utils, sku_production, blending, masters_crud, purchase, db_utils, material_sales
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### material_writeoffs
- Used by modules: masters_common, material_writeoff, opening_balance, writeoff_analytics, db_utils
- Files: 5
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: masters_common, batch_production, material_writeoff, opening_balance, app, sku_production, purchase, blending, masters_crud, system_config, traceability, writeoff_analytics, db_utils
- Files: 26
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: masters_common, material_writeoff, opening_balance, cost_management, sku_production, sku_outbound, locations, writeoff_analytics, material_sales
- Files: 9
...
### oil_cake_inventory
- Used by modules: material_writeoff, batch_production, db_utils, material_sales
- Files: 5
- Functions using this table:
  - get_material_sales_inventory in puvi-backend/puvi-backend-main/modules/material_sales.py
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
...
### purchase_items
- Used by modules: purchase, masters_common, batch_production, db_utils
- Files: 4
- Functions using this table:
...
### purchases
- Used by modules: masters_common, batch_production, opening_balance, app, sku_production, blending, purchase, db_utils
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: masters_common, package_sizes, locations, sku_management, masters_crud, customers
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sku_expiry_tracking
- Used by modules: expiry_utils, sku_production, sku_outbound, locations, db_utils
- Files: 5
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: material_writeoff, sku_production, sku_outbound, locations, db_utils
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: package_sizes, material_writeoff, app, expiry_utils, sku_production, sku_management, masters_crud, system_config, sku_outbound, db_utils
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: material_writeoff, app, expiry_utils, sku_production, sku_management, sku_outbound, db_utils
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### status
- Used by modules: opening_balance, app, sku_production, masters_crud, sku_outbound
- Files: 5
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: masters_common, blending, masters_crud, sku_outbound, purchase, db_utils
- Files: 6
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: package_sizes, batch_production, customers, material_writeoff, opening_balance, cost_management, locations, app, expiry_utils, sku_production, blending, sku_management, masters_crud, system_config, sku_outbound, purchase, writeoff_analytics, material_sales
- Files: 18
...
### suppliers
- Used by modules: masters_common, opening_balance, app, sku_production, purchase, system_config, traceability, db_utils
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### the
- Used by modules: traceability, masters_crud, cost_management, db_utils
- Files: 4
- Functions using this table:
...
### utils
- Used by modules: batch_production, material_writeoff, opening_balance, cost_management, locations, expiry_utils, sku_production, sku_management, blending, masters_crud, sku_outbound, customers, purchase, writeoff_analytics, material_sales
- Files: 15

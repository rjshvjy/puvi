...
Generated: 2025-08-31 13:55:02.891085

## Summary
- Tables found in code: 370
...
### batch
- Used by modules: material_sales, db_utils, traceability, material_writeoff, masters_crud, app, blending, batch_production, sku_production, cost_management, writeoff_analytics, opening_balance
- Files: 14
- Functions using this table:
...
- Used by modules: cost_management, db_utils, batch_production, masters_common
- Files: 4
- Functions using this table:
...
### batches
- Used by modules: material_sales, material_writeoff, blending, app, batch_production, sku_production, opening_balance
- Files: 7
- Functions using this table:
...
### categories
- Used by modules: material_writeoff, system_config, masters_crud, masters_common, sku_production
- Files: 10

### categories_master
- Used by modules: db_utils, material_writeoff, masters_crud, masters_common, blending, purchase
- Files: 6
- Functions using this table:
...
- Used by modules: db_utils, system_config, masters_common, batch_production, sku_production, cost_management, package_sizes
- Files: 7
- Functions using this table:
...
### customers
- Used by modules: sku_outbound, locations, customers, app
- Files: 14
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_outbound_history in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### database
- Used by modules: traceability, material_writeoff, system_config, masters_common, blending, batch_production, sku_production, cost_management
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: inventory_utils, traceability, expiry_utils, sku_management, masters_crud, masters_common, app, blending, date_utils, sku_production, sku_outbound, cost_management, package_sizes, opening_balance
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: material_sales, material_writeoff, system_config, sku_management, locations, masters_crud, masters_common, blending, app, batch_production, purchase, sku_production, customers, sku_outbound, cost_management, writeoff_analytics, package_sizes, opening_balance
- Files: 18

### decimal
- Used by modules: material_sales, inventory_utils, expiry_utils, sku_management, locations, masters_crud, masters_common, blending, validation, batch_production, sku_production, purchase, sku_outbound, cost_management, writeoff_analytics, package_sizes, opening_balance
- Files: 17
...
### dependencies
- Used by modules: locations, masters_crud, masters_common, sku_management
- Files: 4
...
### errors
- Used by modules: db_utils, locations, masters_crud, app, customers, sku_management, opening_balance
- Files: 7

### existing
- Used by modules: inventory_utils, traceability, expiry_utils, batch_production, cost_management, package_sizes, opening_balance
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: material_sales, material_writeoff, system_config, sku_management, locations, masters_crud, blending, app, batch_production, purchase, sku_production, customers, sku_outbound, cost_management, writeoff_analytics, package_sizes, opening_balance
- Files: 17
...
### inventory
- Used by modules: material_sales, inventory_utils, db_utils, material_writeoff, masters_crud, blending, batch_production, purchase, sku_production, opening_balance
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### items
- Used by modules: material_writeoff, purchase, sku_production, sku_outbound
- Files: 4
...
### material_writeoffs
- Used by modules: db_utils, material_writeoff, masters_common, writeoff_analytics, opening_balance
- Files: 5
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: db_utils, traceability, material_writeoff, system_config, masters_crud, masters_common, blending, app, batch_production, purchase, sku_production, sku_outbound, writeoff_analytics, opening_balance
- Files: 27
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: material_sales, material_writeoff, locations, masters_common, sku_production, sku_outbound, cost_management, writeoff_analytics, opening_balance
- Files: 9
...
### oil_cake_inventory
- Used by modules: material_sales, db_utils, batch_production, material_writeoff
- Files: 5
- Functions using this table:
  - get_material_sales_inventory in puvi-backend/puvi-backend-main/modules/material_sales.py
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
...
### oil_types
- Used by modules: material_sales, material_writeoff, system_config, blending, batch_production
- Files: 7
...
### purchases
- Used by modules: db_utils, masters_common, blending, app, batch_production, purchase, sku_production, opening_balance
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: locations, masters_crud, masters_common, customers, sku_management, package_sizes
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sales
- Used by modules: material_sales, sku_outbound, masters_common, app
- Files: 4
...
### sku_expiry_tracking
- Used by modules: db_utils, expiry_utils, locations, sku_production, sku_outbound
- Files: 5
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: db_utils, material_writeoff, locations, sku_production, sku_outbound
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: db_utils, material_writeoff, expiry_utils, system_config, masters_crud, app, sku_production, sku_outbound, sku_management, package_sizes
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: db_utils, material_writeoff, expiry_utils, app, sku_production, sku_outbound, sku_management
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### statistics
- Used by modules: writeoff_analytics, masters_crud, opening_balance, app
- Files: 4
...
### status
- Used by modules: masters_crud, app, sku_production, sku_outbound, opening_balance
- Files: 5
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: db_utils, masters_crud, masters_common, blending, purchase
- Files: 5
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: material_sales, material_writeoff, expiry_utils, system_config, sku_management, locations, masters_crud, blending, app, batch_production, purchase, sku_production, customers, sku_outbound, cost_management, writeoff_analytics, package_sizes, opening_balance
- Files: 18
...
### suppliers
- Used by modules: db_utils, traceability, system_config, masters_common, app, purchase, sku_production, opening_balance
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### the
- Used by modules: cost_management, masters_crud, db_utils, traceability
- Files: 4
- Functions using this table:
...
### utils
- Used by modules: material_sales, material_writeoff, expiry_utils, sku_management, locations, masters_crud, blending, batch_production, purchase, sku_production, customers, sku_outbound, cost_management, writeoff_analytics, opening_balance
- Files: 15

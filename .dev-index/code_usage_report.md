...
Generated: 2025-08-31 13:48:13.576205
...
### allocations
- Used by modules: sku_outbound, material_sales, sku_production, expiry_utils
- Files: 4
...
### batch
- Used by modules: writeoff_analytics, db_utils, app, material_sales, cost_management, blending, material_writeoff, opening_balance, batch_production, masters_crud, traceability, sku_production
- Files: 14
- Functions using this table:
...
- Used by modules: db_utils, batch_production, masters_common, cost_management
- Files: 4
- Functions using this table:
...
### batches
- Used by modules: app, material_sales, blending, material_writeoff, opening_balance, batch_production, sku_production
- Files: 7
- Functions using this table:
...
### categories
- Used by modules: masters_common, material_writeoff, masters_crud, system_config, sku_production
- Files: 10

### categories_master
- Used by modules: db_utils, masters_common, blending, purchase, material_writeoff, masters_crud
- Files: 6
- Functions using this table:
...
### cost_elements
- Used by modules: masters_common, cost_management, batch_production, masters_crud, system_config
- Files: 25

### cost_elements_master
- Used by modules: db_utils, package_sizes, masters_common, cost_management, batch_production, system_config, sku_production
- Files: 7
- Functions using this table:
...
### database
- Used by modules: masters_common, cost_management, blending, material_writeoff, batch_production, traceability, system_config, sku_production
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: inventory_utils, package_sizes, sku_management, app, masters_common, cost_management, expiry_utils, blending, opening_balance, sku_outbound, date_utils, masters_crud, traceability, sku_production
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: writeoff_analytics, package_sizes, sku_management, app, masters_common, material_sales, cost_management, customers, blending, purchase, opening_balance, batch_production, sku_outbound, material_writeoff, masters_crud, locations, system_config, sku_production
- Files: 18

### decimal
- Used by modules: writeoff_analytics, inventory_utils, validation, package_sizes, sku_management, masters_common, material_sales, cost_management, expiry_utils, blending, purchase, opening_balance, batch_production, sku_outbound, locations, masters_crud, sku_production
- Files: 17
...
### errors
- Used by modules: db_utils, sku_management, app, customers, locations, opening_balance, masters_crud
- Files: 7

### existing
- Used by modules: inventory_utils, package_sizes, cost_management, expiry_utils, opening_balance, batch_production, traceability
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: writeoff_analytics, package_sizes, sku_management, app, material_sales, cost_management, customers, blending, purchase, opening_balance, batch_production, sku_outbound, material_writeoff, masters_crud, locations, system_config, sku_production
- Files: 17
...
### inventory
- Used by modules: inventory_utils, db_utils, material_sales, blending, purchase, opening_balance, batch_production, material_writeoff, masters_crud, sku_production
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### material_writeoffs
- Used by modules: writeoff_analytics, db_utils, masters_common, material_writeoff, opening_balance
- Files: 5
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: writeoff_analytics, db_utils, app, masters_common, blending, purchase, opening_balance, batch_production, sku_outbound, material_writeoff, masters_crud, traceability, system_config, sku_production
- Files: 27
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: writeoff_analytics, masters_common, material_sales, cost_management, locations, material_writeoff, opening_balance, sku_outbound, sku_production
- Files: 9
...
### purchase_items
- Used by modules: purchase, db_utils, batch_production, masters_common
- Files: 4
- Functions using this table:
...
### purchases
- Used by modules: db_utils, app, masters_common, blending, purchase, opening_balance, batch_production, sku_production
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: package_sizes, sku_management, masters_common, customers, locations, masters_crud
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sku_expiry_tracking
- Used by modules: db_utils, expiry_utils, locations, sku_outbound, sku_production
- Files: 5
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: db_utils, locations, material_writeoff, sku_outbound, sku_production
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: db_utils, package_sizes, sku_management, app, expiry_utils, material_writeoff, sku_outbound, masters_crud, system_config, sku_production
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: db_utils, sku_management, app, expiry_utils, material_writeoff, sku_outbound, sku_production
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### subcategories_master
- Used by modules: db_utils, masters_common, blending, purchase, masters_crud
- Files: 5
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: writeoff_analytics, package_sizes, sku_management, app, material_sales, cost_management, expiry_utils, blending, purchase, opening_balance, batch_production, sku_outbound, customers, material_writeoff, masters_crud, locations, system_config, sku_production
- Files: 18
...
### suppliers
- Used by modules: db_utils, app, masters_common, purchase, opening_balance, traceability, system_config, sku_production
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### utils
- Used by modules: writeoff_analytics, sku_management, material_sales, cost_management, expiry_utils, blending, purchase, opening_balance, batch_production, sku_outbound, customers, material_writeoff, masters_crud, locations, sku_production
- Files: 15

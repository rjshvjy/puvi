...
Generated: 2025-09-02 01:54:32.273821
...
### allocations
- Used by modules: sku_production, material_sales, sku_outbound, expiry_utils
- Files: 4
...
### batch
- Used by modules: material_sales, masters_crud, traceability, opening_balance, app, batch_production, material_writeoff, cost_management, blending, writeoff_analytics, sku_production, db_utils
- Files: 14
- Functions using this table:
...
### batches
- Used by modules: material_sales, opening_balance, app, batch_production, material_writeoff, blending, sku_production
- Files: 7
- Functions using this table:
...
### blend_batches
- Used by modules: sku_production, masters_crud, db_utils, blending
- Files: 4
- Functions using this table:
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
  - create_blend in puvi-backend/puvi-backend-main/modules/blending.py
...
### categories
- Used by modules: system_config, masters_crud, masters_common, material_writeoff, sku_production
- Files: 10

### categories_master
- Used by modules: masters_crud, sku_outbound, masters_common, material_writeoff, blending, purchase, db_utils
- Files: 7
- Functions using this table:
...
- Used by modules: system_config, masters_common, batch_production, cost_management, package_sizes, sku_production, db_utils
- Files: 7
- Functions using this table:
...
### customers
- Used by modules: sku_outbound, customers, locations, app
- Files: 14
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_outbound_history in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### database
- Used by modules: system_config, traceability, masters_common, batch_production, material_writeoff, cost_management, blending, sku_production
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: masters_crud, traceability, opening_balance, app, sku_outbound, masters_common, sku_management, package_sizes, expiry_utils, cost_management, blending, inventory_utils, sku_production, date_utils
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: system_config, material_sales, masters_crud, writeoff_analytics, opening_balance, app, purchase, sku_outbound, masters_common, customers, batch_production, sku_management, material_writeoff, cost_management, blending, package_sizes, locations, sku_production
- Files: 18

### decimal
- Used by modules: material_sales, masters_crud, writeoff_analytics, opening_balance, purchase, sku_outbound, masters_common, batch_production, sku_management, package_sizes, expiry_utils, validation, blending, inventory_utils, cost_management, locations, sku_production
- Files: 17
...
### errors
- Used by modules: masters_crud, opening_balance, app, customers, sku_management, locations, db_utils
- Files: 7

### existing
- Used by modules: traceability, opening_balance, batch_production, package_sizes, cost_management, expiry_utils, inventory_utils
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: system_config, material_sales, masters_crud, writeoff_analytics, opening_balance, app, purchase, sku_outbound, customers, batch_production, sku_management, material_writeoff, cost_management, blending, package_sizes, locations, sku_production
- Files: 17
...
### inventory
- Used by modules: material_sales, masters_crud, opening_balance, purchase, batch_production, material_writeoff, blending, inventory_utils, sku_production, db_utils
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### locations_master
- Used by modules: app, sku_outbound, expiry_utils, locations, sku_production
- Files: 5
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### material_writeoffs
- Used by modules: opening_balance, masters_common, material_writeoff, writeoff_analytics, db_utils
- Files: 5
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: system_config, masters_crud, traceability, opening_balance, app, purchase, masters_common, batch_production, material_writeoff, blending, writeoff_analytics, sku_production, db_utils
- Files: 26
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: material_sales, opening_balance, sku_outbound, masters_common, material_writeoff, cost_management, locations, writeoff_analytics, sku_production
- Files: 9
...
### oil_types
- Used by modules: system_config, material_sales, batch_production, material_writeoff, blending
- Files: 7
...
### purchases
- Used by modules: opening_balance, app, purchase, masters_common, batch_production, blending, sku_production, db_utils
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: masters_crud, masters_common, customers, sku_management, locations, package_sizes
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sales
- Used by modules: sku_outbound, material_sales, masters_common, app
- Files: 4
...
### sku_expiry_tracking
- Used by modules: sku_outbound, expiry_utils, locations, sku_production, db_utils
- Files: 5
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: sku_outbound, material_writeoff, expiry_utils, locations, sku_production, db_utils
- Files: 6
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: system_config, masters_crud, app, sku_outbound, sku_management, material_writeoff, expiry_utils, package_sizes, sku_production, db_utils
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: app, sku_outbound, sku_management, material_writeoff, expiry_utils, sku_production, db_utils
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### status
- Used by modules: masters_crud, opening_balance, app, sku_outbound, sku_production
- Files: 5
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: masters_crud, sku_outbound, masters_common, blending, purchase, db_utils
- Files: 6
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: system_config, material_sales, masters_crud, writeoff_analytics, opening_balance, app, purchase, sku_outbound, customers, batch_production, sku_management, material_writeoff, expiry_utils, cost_management, blending, package_sizes, locations, sku_production
- Files: 18
...
### suppliers
- Used by modules: system_config, traceability, opening_balance, app, purchase, masters_common, sku_production, db_utils
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### the
- Used by modules: masters_crud, db_utils, traceability, cost_management
- Files: 4
- Functions using this table:
...
### utils
- Used by modules: material_sales, masters_crud, opening_balance, purchase, sku_outbound, customers, batch_production, sku_management, material_writeoff, cost_management, expiry_utils, blending, writeoff_analytics, locations, sku_production
- Files: 15

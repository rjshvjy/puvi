...
Generated: 2025-09-01 07:19:32.938841
...
### allocations
- Used by modules: material_sales, expiry_utils, sku_outbound, sku_production
- Files: 4
...
### batch
- Used by modules: material_sales, material_writeoff, batch_production, app, blending, cost_management, writeoff_analytics, masters_crud, traceability, sku_production, db_utils, opening_balance
- Files: 14
- Functions using this table:
...
### batches
- Used by modules: material_sales, material_writeoff, batch_production, app, blending, sku_production, opening_balance
- Files: 7
- Functions using this table:
...
### blend_batches
- Used by modules: db_utils, masters_crud, blending, sku_production
- Files: 4
- Functions using this table:
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
  - create_blend in puvi-backend/puvi-backend-main/modules/blending.py
...
### categories
- Used by modules: material_writeoff, system_config, masters_common, masters_crud, sku_production
- Files: 10

### categories_master
- Used by modules: material_writeoff, sku_outbound, blending, masters_common, masters_crud, db_utils, purchase
- Files: 7
- Functions using this table:
...
### cost_elements
- Used by modules: batch_production, system_config, cost_management, masters_common, masters_crud
- Files: 25

### cost_elements_master
- Used by modules: batch_production, system_config, cost_management, masters_common, sku_production, db_utils, package_sizes
- Files: 7
- Functions using this table:
...
### customers
- Used by modules: customers, locations, app, sku_outbound
- Files: 14
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_outbound_history in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### database
- Used by modules: material_writeoff, batch_production, system_config, blending, cost_management, masters_common, traceability, sku_production
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: sku_outbound, inventory_utils, sku_management, app, blending, cost_management, masters_common, masters_crud, traceability, sku_production, date_utils, expiry_utils, opening_balance, package_sizes
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: material_sales, purchase, customers, material_writeoff, batch_production, sku_outbound, locations, sku_management, system_config, app, blending, cost_management, writeoff_analytics, masters_common, masters_crud, sku_production, opening_balance, package_sizes
- Files: 18

### decimal
- Used by modules: material_sales, purchase, locations, batch_production, sku_outbound, inventory_utils, sku_management, blending, validation, cost_management, writeoff_analytics, masters_common, masters_crud, sku_production, expiry_utils, opening_balance, package_sizes
- Files: 17
...
### errors
- Used by modules: customers, locations, sku_management, app, masters_crud, db_utils, opening_balance
- Files: 7

### existing
- Used by modules: batch_production, inventory_utils, cost_management, traceability, expiry_utils, opening_balance, package_sizes
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: material_sales, purchase, customers, material_writeoff, batch_production, sku_outbound, locations, sku_management, system_config, app, blending, cost_management, writeoff_analytics, masters_crud, sku_production, opening_balance, package_sizes
- Files: 17
...
### inventory
- Used by modules: material_sales, material_writeoff, batch_production, inventory_utils, blending, masters_crud, sku_production, db_utils, opening_balance, purchase
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### items
- Used by modules: material_writeoff, sku_outbound, sku_production, purchase
- Files: 4
...
### material_writeoffs
- Used by modules: material_writeoff, writeoff_analytics, masters_common, db_utils, opening_balance
- Files: 5
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: material_writeoff, batch_production, system_config, app, blending, writeoff_analytics, masters_common, masters_crud, traceability, sku_production, db_utils, opening_balance, purchase
- Files: 26
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: material_sales, material_writeoff, locations, sku_outbound, cost_management, writeoff_analytics, masters_common, sku_production, opening_balance
- Files: 9
...
### oil_cake_inventory
- Used by modules: db_utils, material_writeoff, material_sales, batch_production
- Files: 5
- Functions using this table:
  - get_material_sales_inventory in puvi-backend/puvi-backend-main/modules/material_sales.py
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
...
- Used by modules: db_utils, sku_production, package_sizes
- Files: 3
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - create_production_plan in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### purchase_items
- Used by modules: db_utils, masters_common, batch_production, purchase
- Files: 4
- Functions using this table:
...
### purchases
- Used by modules: batch_production, app, blending, masters_common, sku_production, db_utils, opening_balance, purchase
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: customers, locations, sku_management, masters_common, masters_crud, package_sizes
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sku_expiry_tracking
- Used by modules: locations, sku_outbound, sku_production, db_utils, expiry_utils
- Files: 5
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: material_writeoff, locations, sku_outbound, sku_production, db_utils
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: material_writeoff, sku_outbound, sku_management, system_config, app, masters_crud, sku_production, db_utils, expiry_utils, package_sizes
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: material_writeoff, sku_outbound, sku_management, app, sku_production, db_utils, expiry_utils
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### statistics
- Used by modules: writeoff_analytics, masters_crud, app, opening_balance
- Files: 4
...
### status
- Used by modules: sku_outbound, app, masters_crud, sku_production, opening_balance
- Files: 5
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: sku_outbound, blending, masters_common, masters_crud, db_utils, purchase
- Files: 6
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: material_sales, purchase, customers, material_writeoff, batch_production, sku_outbound, locations, sku_management, system_config, app, blending, cost_management, writeoff_analytics, masters_crud, sku_production, expiry_utils, opening_balance, package_sizes
- Files: 18
...
### suppliers
- Used by modules: system_config, app, masters_common, traceability, sku_production, db_utils, opening_balance, purchase
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### utils
- Used by modules: material_sales, customers, material_writeoff, locations, batch_production, sku_outbound, sku_management, blending, cost_management, writeoff_analytics, masters_crud, sku_production, expiry_utils, opening_balance, purchase
- Files: 15

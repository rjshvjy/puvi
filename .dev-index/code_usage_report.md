...
Generated: 2025-09-07 19:19:27.746227

## Summary
- Tables found in code: 386
...
### batch
- Used by modules: writeoff_analytics, masters_crud, app, material_sales, cost_management, sku_production, traceability, blending, batch_production, opening_balance, db_utils, material_writeoff
- Files: 14
- Functions using this table:
...
- Used by modules: masters_crud, masters_common, cost_management, batch_production, db_utils
- Files: 5
- Functions using this table:
...
### batches
- Used by modules: material_sales, sku_production, blending, batch_production, opening_balance, app, material_writeoff
- Files: 7
- Functions using this table:
...
### blend_batches
- Used by modules: blending, sku_production, masters_crud, db_utils
- Files: 4
- Functions using this table:
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
  - create_blend in puvi-backend/puvi-backend-main/modules/blending.py
...
### categories
- Used by modules: masters_crud, masters_common, system_config, sku_production, material_writeoff
- Files: 9

### categories_master
- Used by modules: masters_crud, masters_common, purchase, blending, db_utils, sku_outbound, material_writeoff
- Files: 7
- Functions using this table:
...
- Used by modules: masters_crud, masters_common, system_config, package_sizes, cost_management, sku_production, batch_production, db_utils
- Files: 8
- Functions using this table:
...
### database
- Used by modules: masters_crud, masters_common, system_config, cost_management, sku_production, blending, traceability, material_writeoff
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: date_utils, sku_management, masters_crud, inventory_utils, masters_common, package_sizes, cost_management, sku_production, traceability, blending, opening_balance, app, sku_outbound, expiry_utils
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: writeoff_analytics, sku_management, masters_crud, locations, masters_common, system_config, package_sizes, material_sales, cost_management, purchase, sku_production, blending, customers, batch_production, opening_balance, app, sku_outbound, material_writeoff
- Files: 18

### decimal
- Used by modules: validation, writeoff_analytics, sku_management, masters_crud, inventory_utils, locations, masters_common, package_sizes, material_sales, cost_management, purchase, sku_production, blending, batch_production, opening_balance, sku_outbound, expiry_utils
- Files: 17
...
### errors
- Used by modules: sku_management, masters_crud, app, locations, customers, opening_balance, db_utils
- Files: 7

### existing
- Used by modules: inventory_utils, package_sizes, cost_management, traceability, batch_production, opening_balance, expiry_utils
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: writeoff_analytics, sku_management, masters_crud, locations, system_config, package_sizes, material_sales, cost_management, purchase, sku_production, blending, customers, batch_production, opening_balance, app, sku_outbound, material_writeoff
- Files: 17
...
### inventory
- Used by modules: masters_crud, inventory_utils, material_sales, purchase, sku_production, blending, batch_production, opening_balance, db_utils, material_writeoff
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### items
- Used by modules: purchase, sku_production, sku_outbound, material_writeoff
- Files: 4
...
### locations_master
- Used by modules: locations, sku_production, app, sku_outbound, expiry_utils
- Files: 5
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### material_writeoffs
- Used by modules: writeoff_analytics, masters_common, opening_balance, db_utils, material_writeoff
- Files: 5
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: writeoff_analytics, masters_crud, app, masters_common, system_config, purchase, sku_production, blending, traceability, batch_production, opening_balance, db_utils, material_writeoff
- Files: 24
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: writeoff_analytics, locations, masters_common, material_sales, cost_management, sku_production, batch_production, opening_balance, sku_outbound, material_writeoff
- Files: 10
...
### oil_cake_inventory
- Used by modules: batch_production, db_utils, material_sales, material_writeoff
- Files: 5
- Functions using this table:
  - get_material_sales_inventory in puvi-backend/puvi-backend-main/modules/material_sales.py
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
...
### oil_cake_sales
- Used by modules: batch_production, db_utils, material_sales
- Files: 4
- Functions using this table:
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
  - get_material_sales_history in puvi-backend/puvi-backend-main/modules/material_sales.py
...
- Used by modules: masters_crud, masters_common, package_sizes, sku_production, db_utils
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - create_production_plan in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### purchase_items
- Used by modules: batch_production, masters_common, db_utils, purchase
- Files: 4
- Functions using this table:
...
### purchases
- Used by modules: app, masters_common, purchase, sku_production, blending, batch_production, opening_balance, db_utils
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: sku_management, masters_crud, locations, masters_common, package_sizes, customers
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sales
- Used by modules: sku_outbound, masters_crud, app, material_sales
- Files: 4
...
### sku
- Used by modules: batch_production, system_config, sku_outbound, material_writeoff
- Files: 58
- Functions using this table:
  - get_oil_types in puvi-backend/puvi-backend-main/modules/batch_production.py
  - get_config in puvi-backend/puvi-backend-main/modules/system_config.py
...
### sku_expiry_tracking
- Used by modules: locations, sku_production, db_utils, sku_outbound, expiry_utils
- Files: 5
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: expiry_utils, locations, sku_production, db_utils, sku_outbound, material_writeoff
- Files: 6
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: sku_management, masters_crud, app, material_writeoff, system_config, package_sizes, sku_production, batch_production, db_utils, sku_outbound, expiry_utils
- Files: 11
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: sku_management, app, material_writeoff, sku_production, db_utils, sku_outbound, expiry_utils
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### status
- Used by modules: masters_crud, sku_production, opening_balance, app, sku_outbound
- Files: 5
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: masters_crud, masters_common, purchase, blending, batch_production, db_utils, sku_outbound
- Files: 7
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: writeoff_analytics, sku_management, masters_crud, material_writeoff, locations, system_config, package_sizes, material_sales, cost_management, purchase, sku_production, blending, customers, batch_production, opening_balance, app, sku_outbound, expiry_utils
- Files: 18
...
### suppliers
- Used by modules: app, masters_common, system_config, purchase, sku_production, traceability, opening_balance, db_utils
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### the
- Used by modules: masters_crud, cost_management, traceability, batch_production, db_utils
- Files: 5
- Functions using this table:
...
### utils
- Used by modules: writeoff_analytics, sku_management, masters_crud, material_writeoff, locations, material_sales, cost_management, purchase, sku_production, blending, customers, batch_production, opening_balance, sku_outbound, expiry_utils
- Files: 15

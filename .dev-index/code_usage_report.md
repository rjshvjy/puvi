...
Generated: 2025-09-07 13:18:15.478229
...
### batch
- Used by modules: db_utils, blending, material_writeoff, masters_crud, opening_balance, traceability, app, writeoff_analytics, batch_production, material_sales, sku_production, cost_management
- Files: 14
- Functions using this table:
...
### batches
- Used by modules: blending, material_writeoff, opening_balance, app, batch_production, material_sales, sku_production
- Files: 7
- Functions using this table:
...
### categories
- Used by modules: material_writeoff, masters_crud, masters_common, system_config, sku_production
- Files: 10

### categories_master
- Used by modules: db_utils, blending, sku_outbound, material_writeoff, masters_crud, purchase, masters_common
- Files: 7
- Functions using this table:
...
- Used by modules: db_utils, masters_crud, package_sizes, masters_common, system_config, batch_production, sku_production, cost_management
- Files: 8
- Functions using this table:
...
### database
- Used by modules: blending, material_writeoff, masters_crud, traceability, masters_common, system_config, batch_production, sku_production, cost_management
- Files: 9
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: sku_outbound, blending, inventory_utils, masters_crud, package_sizes, opening_balance, traceability, app, masters_common, sku_management, expiry_utils, date_utils, sku_production, cost_management
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: customers, sku_outbound, blending, material_writeoff, masters_crud, package_sizes, opening_balance, purchase, app, masters_common, locations, sku_management, writeoff_analytics, system_config, batch_production, material_sales, sku_production, cost_management
- Files: 18

### decimal
- Used by modules: sku_outbound, blending, inventory_utils, masters_crud, package_sizes, opening_balance, purchase, masters_common, locations, sku_management, expiry_utils, writeoff_analytics, validation, batch_production, material_sales, sku_production, cost_management
- Files: 17
...
### errors
- Used by modules: customers, db_utils, masters_crud, opening_balance, app, locations, sku_management
- Files: 7

### existing
- Used by modules: inventory_utils, package_sizes, opening_balance, traceability, expiry_utils, batch_production, cost_management
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: customers, sku_outbound, blending, material_writeoff, masters_crud, package_sizes, opening_balance, purchase, app, locations, sku_management, writeoff_analytics, system_config, batch_production, material_sales, sku_production, cost_management
- Files: 17
...
### in
- Used by modules: package_sizes, cost_management, masters_crud, sku_management
- Files: 4
- Functions using this table:
  - bulk_update_cost_elements in puvi-backend/puvi-backend-main/modules/cost_management.py
  - bulk_update_package_sizes in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### inventory
- Used by modules: db_utils, blending, inventory_utils, material_writeoff, masters_crud, opening_balance, purchase, batch_production, material_sales, sku_production
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### locations_master
- Used by modules: sku_outbound, app, locations, expiry_utils, sku_production
- Files: 5
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### materials
- Used by modules: db_utils, blending, material_writeoff, masters_crud, opening_balance, purchase, traceability, app, masters_common, writeoff_analytics, system_config, batch_production, sku_production
- Files: 25
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: sku_outbound, material_writeoff, opening_balance, masters_common, locations, writeoff_analytics, material_sales, sku_production, cost_management
- Files: 9
...
### oil_types
- Used by modules: blending, material_writeoff, system_config, batch_production, material_sales
- Files: 7
...
- Used by modules: db_utils, masters_crud, package_sizes, masters_common, sku_production
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - create_production_plan in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### purchases
- Used by modules: db_utils, blending, opening_balance, purchase, app, masters_common, batch_production, sku_production
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: customers, masters_crud, package_sizes, masters_common, locations, sku_management
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sku_expiry_tracking
- Used by modules: db_utils, sku_outbound, locations, expiry_utils, sku_production
- Files: 5
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: db_utils, sku_outbound, material_writeoff, locations, expiry_utils, sku_production
- Files: 6
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: db_utils, sku_outbound, material_writeoff, masters_crud, package_sizes, app, sku_management, expiry_utils, system_config, sku_production
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: db_utils, sku_outbound, material_writeoff, app, sku_management, expiry_utils, sku_production
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### subcategories_master
- Used by modules: db_utils, blending, sku_outbound, masters_crud, purchase, masters_common
- Files: 6
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: customers, sku_outbound, blending, material_writeoff, masters_crud, package_sizes, opening_balance, purchase, app, locations, sku_management, expiry_utils, writeoff_analytics, system_config, batch_production, material_sales, sku_production, cost_management
- Files: 18
...
### suppliers
- Used by modules: db_utils, opening_balance, purchase, traceability, app, masters_common, system_config, sku_production
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### updates
- Used by modules: package_sizes, cost_management, masters_crud
- Files: 3
...
### utils
- Used by modules: customers, sku_outbound, blending, material_writeoff, masters_crud, opening_balance, purchase, locations, sku_management, expiry_utils, writeoff_analytics, batch_production, material_sales, sku_production, cost_management
- Files: 15

...
Generated: 2025-08-30 18:24:37.926004

## Summary
- Tables found in code: 365
...
### batch
- Used by modules: masters_crud, material_sales, blending, writeoff_analytics, sku_production, app, material_writeoff, traceability, db_utils, opening_balance, batch_production, cost_management
- Files: 14
- Functions using this table:
...
### batches
- Used by modules: material_sales, blending, sku_production, app, material_writeoff, opening_balance, batch_production
- Files: 7
- Functions using this table:
...
### bottles
- Used by modules: material_writeoff, sku_management, system_config
- Files: 3
...
### caps
- Used by modules: sku_management, system_config
- Files: 2

### categories
- Used by modules: masters_crud, masters_common, material_writeoff, sku_production, sku_management, system_config
- Files: 11

### categories_master
- Used by modules: masters_crud, blending, purchase, masters_common, material_writeoff, db_utils
- Files: 6
- Functions using this table:
...
- Used by modules: masters_common, sku_production, db_utils, package_sizes, batch_production, cost_management, sku_management, system_config
- Files: 8
- Functions using this table:
...
### customers
- Used by modules: locations, customers, app, sku_outbound
- Files: 14
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_outbound_history in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### database
- Used by modules: blending, masters_common, sku_production, material_writeoff, traceability, batch_production, cost_management, system_config
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: masters_crud, sku_outbound, blending, masters_common, sku_production, app, inventory_utils, traceability, expiry_utils, opening_balance, package_sizes, cost_management, date_utils, sku_management
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: masters_crud, material_sales, sku_outbound, blending, writeoff_analytics, masters_common, purchase, sku_production, app, material_writeoff, locations, opening_balance, package_sizes, customers, batch_production, cost_management, sku_management, system_config
- Files: 18

### decimal
- Used by modules: masters_crud, material_sales, validation, sku_outbound, blending, writeoff_analytics, masters_common, purchase, sku_production, locations, inventory_utils, expiry_utils, opening_balance, package_sizes, batch_production, cost_management, sku_management
- Files: 17
...
### dependencies
- Used by modules: masters_common, masters_crud, locations, sku_management
- Files: 4
...
### errors
- Used by modules: masters_crud, locations, app, db_utils, opening_balance, customers, sku_management
- Files: 7

### existing
- Used by modules: inventory_utils, traceability, expiry_utils, opening_balance, package_sizes, batch_production, cost_management, sku_management
- Files: 8
- Functions using this table:
...
### flask
- Used by modules: masters_crud, material_sales, sku_outbound, blending, writeoff_analytics, purchase, sku_production, app, material_writeoff, locations, opening_balance, package_sizes, customers, batch_production, cost_management, sku_management, system_config
- Files: 17
...
### inventory
- Used by modules: masters_crud, material_sales, blending, purchase, sku_production, material_writeoff, inventory_utils, db_utils, opening_balance, batch_production
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### masters_audit_log
- Used by modules: masters_common, db_utils, opening_balance
- Files: 3
- Functions using this table:
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - close_financial_year in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### material_writeoffs
- Used by modules: writeoff_analytics, masters_common, material_writeoff, db_utils, opening_balance
- Files: 5
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: masters_crud, blending, writeoff_analytics, masters_common, purchase, sku_production, app, material_writeoff, traceability, db_utils, opening_balance, batch_production, sku_management, system_config
- Files: 27
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: material_sales, sku_outbound, writeoff_analytics, masters_common, sku_production, material_writeoff, locations, opening_balance, cost_management, sku_management
- Files: 10
...
### oil_types
- Used by modules: material_sales, blending, material_writeoff, batch_production, system_config
- Files: 7
...
### purchase_items
- Used by modules: masters_common, purchase, db_utils, batch_production
- Files: 4
- Functions using this table:
...
### purchases
- Used by modules: blending, masters_common, purchase, sku_production, app, db_utils, opening_balance, batch_production
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: masters_crud, masters_common, locations, customers, package_sizes, sku_management
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sku_expiry_tracking
- Used by modules: sku_outbound, locations, sku_production, expiry_utils, db_utils
- Files: 5
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: sku_outbound, material_writeoff, locations, sku_production, db_utils
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: masters_crud, sku_outbound, sku_production, app, material_writeoff, expiry_utils, db_utils, package_sizes, sku_management, system_config
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: sku_outbound, sku_production, app, material_writeoff, expiry_utils, db_utils, sku_management
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### status
- Used by modules: masters_crud, sku_outbound, sku_production, app, opening_balance
- Files: 5
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: masters_crud, blending, purchase, masters_common, db_utils
- Files: 5
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: masters_crud, material_sales, sku_outbound, blending, writeoff_analytics, purchase, sku_production, app, material_writeoff, locations, expiry_utils, opening_balance, package_sizes, customers, batch_production, cost_management, sku_management, system_config
- Files: 18
...
### suppliers
- Used by modules: masters_common, purchase, sku_production, app, traceability, db_utils, opening_balance, system_config
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### utils
- Used by modules: masters_crud, material_sales, sku_outbound, blending, writeoff_analytics, purchase, sku_production, material_writeoff, locations, expiry_utils, opening_balance, customers, batch_production, cost_management, sku_management
- Files: 15
...
### writeoff_reasons
- Used by modules: writeoff_analytics, masters_common, material_writeoff, system_config
- Files: 6
- Functions using this table:
  - get_writeoff_dashboard in puvi-backend/puvi-backend-main/modules/writeoff_analytics.py
  - get_writeoff_report in puvi-backend/puvi-backend-main/modules/writeoff_analytics.py

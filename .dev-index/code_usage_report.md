...
Generated: 2025-09-07 18:51:57.809285
...
### batch
- Used by modules: app, opening_balance, blending, db_utils, sku_production, material_writeoff, writeoff_analytics, traceability, material_sales, masters_crud, cost_management, batch_production
- Files: 14
- Functions using this table:
...
- Used by modules: db_utils, masters_common, masters_crud, cost_management, batch_production
- Files: 5
- Functions using this table:
...
### batches
- Used by modules: app, opening_balance, blending, sku_production, material_writeoff, material_sales, batch_production
- Files: 7
- Functions using this table:
...
### categories
- Used by modules: system_config, material_writeoff, sku_production, masters_common, masters_crud
- Files: 9

### categories_master
- Used by modules: blending, db_utils, material_writeoff, purchase, masters_common, sku_outbound, masters_crud
- Files: 7
- Functions using this table:
...
### cost_elements
- Used by modules: system_config, masters_common, masters_crud, cost_management, batch_production
- Files: 24

### cost_elements_master
- Used by modules: package_sizes, system_config, db_utils, sku_production, masters_common, masters_crud, cost_management, batch_production
- Files: 8
- Functions using this table:
...
### database
- Used by modules: blending, system_config, sku_production, material_writeoff, masters_common, traceability, masters_crud, cost_management
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: app, opening_balance, blending, package_sizes, inventory_utils, date_utils, sku_production, masters_common, sku_management, traceability, sku_outbound, masters_crud, cost_management, expiry_utils
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: app, opening_balance, blending, package_sizes, system_config, locations, customers, sku_production, material_writeoff, writeoff_analytics, purchase, masters_common, sku_management, sku_outbound, material_sales, masters_crud, cost_management, batch_production
- Files: 18

### decimal
- Used by modules: opening_balance, blending, package_sizes, locations, inventory_utils, sku_production, writeoff_analytics, purchase, batch_production, masters_common, sku_management, sku_outbound, validation, material_sales, masters_crud, cost_management, expiry_utils
- Files: 17
...
### dependencies
- Used by modules: masters_common, sku_management, masters_crud, locations
- Files: 4
...
### errors
- Used by modules: app, opening_balance, locations, customers, db_utils, sku_management, masters_crud
- Files: 7

### existing
- Used by modules: opening_balance, package_sizes, inventory_utils, batch_production, traceability, cost_management, expiry_utils
- Files: 7
- Functions using this table:
...
### extended_costs
- Used by modules: cost_management, batch_production
- Files: 2
...
### flask
- Used by modules: app, opening_balance, blending, package_sizes, system_config, locations, customers, sku_production, material_writeoff, writeoff_analytics, purchase, sku_management, sku_outbound, material_sales, masters_crud, cost_management, batch_production
- Files: 17
...
### inventory
- Used by modules: opening_balance, blending, inventory_utils, db_utils, sku_production, material_writeoff, purchase, material_sales, masters_crud, batch_production
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### items
- Used by modules: material_writeoff, sku_production, sku_outbound, purchase
- Files: 4
...
### locations_master
- Used by modules: app, locations, sku_production, sku_outbound, expiry_utils
- Files: 5
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### material_writeoffs
- Used by modules: opening_balance, db_utils, material_writeoff, writeoff_analytics, masters_common
- Files: 5
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: app, opening_balance, blending, system_config, db_utils, sku_production, material_writeoff, writeoff_analytics, purchase, masters_common, traceability, masters_crud, batch_production
- Files: 24
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: opening_balance, locations, sku_production, material_writeoff, writeoff_analytics, masters_common, sku_outbound, material_sales, cost_management, batch_production
- Files: 10
...
### oil_cake_sales
- Used by modules: material_sales, db_utils, batch_production
- Files: 4
- Functions using this table:
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
  - get_material_sales_history in puvi-backend/puvi-backend-main/modules/material_sales.py
...
- Used by modules: package_sizes, db_utils, sku_production, masters_common, masters_crud
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - create_production_plan in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### purchases
- Used by modules: app, opening_balance, blending, db_utils, sku_production, purchase, masters_common, batch_production
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: package_sizes, locations, customers, masters_common, sku_management, masters_crud
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sku
- Used by modules: material_writeoff, system_config, sku_outbound, batch_production
- Files: 58
- Functions using this table:
  - get_oil_types in puvi-backend/puvi-backend-main/modules/batch_production.py
  - get_config in puvi-backend/puvi-backend-main/modules/system_config.py
...
### sku_expiry_tracking
- Used by modules: locations, db_utils, sku_production, sku_outbound, expiry_utils
- Files: 5
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: locations, db_utils, material_writeoff, sku_production, sku_outbound, expiry_utils
- Files: 6
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: app, package_sizes, system_config, db_utils, sku_production, material_writeoff, sku_management, expiry_utils, sku_outbound, masters_crud, batch_production
- Files: 11
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: app, db_utils, sku_production, material_writeoff, sku_management, sku_outbound, expiry_utils
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### status
- Used by modules: app, opening_balance, sku_production, sku_outbound, masters_crud
- Files: 5
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: blending, db_utils, purchase, masters_common, sku_outbound, masters_crud, batch_production
- Files: 7
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: app, opening_balance, blending, package_sizes, system_config, locations, customers, sku_production, material_writeoff, writeoff_analytics, purchase, batch_production, sku_management, sku_outbound, material_sales, masters_crud, cost_management, expiry_utils
- Files: 18
...
### suppliers
- Used by modules: app, opening_balance, system_config, db_utils, sku_production, purchase, masters_common, traceability
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### the
- Used by modules: db_utils, traceability, masters_crud, cost_management, batch_production
- Files: 5
- Functions using this table:
...
### utils
- Used by modules: blending, opening_balance, locations, customers, sku_production, material_writeoff, writeoff_analytics, purchase, batch_production, sku_management, sku_outbound, material_sales, masters_crud, cost_management, expiry_utils
- Files: 15

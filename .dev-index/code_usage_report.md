...
Generated: 2025-09-07 12:37:12.529926
...
### batch
- Used by modules: batch_production, sku_production, traceability, app, db_utils, writeoff_analytics, masters_crud, material_writeoff, blending, material_sales, opening_balance, cost_management
- Files: 14
- Functions using this table:
...
- Used by modules: masters_common, db_utils, masters_crud, batch_production, cost_management
- Files: 5
- Functions using this table:
...
### batches
- Used by modules: batch_production, sku_production, app, material_writeoff, blending, material_sales, opening_balance
- Files: 7
- Functions using this table:
...
### categories
- Used by modules: masters_common, sku_production, system_config, material_writeoff, masters_crud
- Files: 10

### categories_master
- Used by modules: masters_common, purchase, sku_outbound, db_utils, masters_crud, material_writeoff, blending
- Files: 7
- Functions using this table:
...
### cost_elements
- Used by modules: masters_common, system_config, masters_crud, batch_production, cost_management
- Files: 25

### cost_elements_master
- Used by modules: masters_common, sku_production, package_sizes, db_utils, system_config, masters_crud, batch_production, cost_management
- Files: 8
- Functions using this table:
...
### database
- Used by modules: masters_common, sku_production, traceability, system_config, masters_crud, material_writeoff, blending, batch_production, cost_management
- Files: 9
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: date_utils, masters_common, sku_production, traceability, sku_outbound, app, package_sizes, expiry_utils, masters_crud, sku_management, inventory_utils, blending, opening_balance, cost_management
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: batch_production, masters_common, sku_production, locations, customers, purchase, sku_outbound, app, package_sizes, system_config, writeoff_analytics, masters_crud, sku_management, material_writeoff, blending, material_sales, opening_balance, cost_management
- Files: 18

### decimal
- Used by modules: batch_production, masters_common, sku_production, locations, validation, purchase, sku_outbound, package_sizes, expiry_utils, writeoff_analytics, masters_crud, sku_management, inventory_utils, blending, material_sales, opening_balance, cost_management
- Files: 17
...
### errors
- Used by modules: locations, customers, app, db_utils, sku_management, masters_crud, opening_balance
- Files: 7

### existing
- Used by modules: traceability, package_sizes, expiry_utils, inventory_utils, batch_production, opening_balance, cost_management
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: batch_production, sku_production, locations, customers, purchase, sku_outbound, app, package_sizes, system_config, writeoff_analytics, masters_crud, sku_management, material_writeoff, blending, material_sales, opening_balance, cost_management
- Files: 17
...
### in
- Used by modules: masters_crud, sku_management, package_sizes, cost_management
- Files: 4
- Functions using this table:
  - bulk_update_cost_elements in puvi-backend/puvi-backend-main/modules/cost_management.py
  - bulk_update_package_sizes in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### inventory
- Used by modules: batch_production, sku_production, purchase, db_utils, masters_crud, material_writeoff, inventory_utils, blending, material_sales, opening_balance
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### locations_master
- Used by modules: sku_production, locations, sku_outbound, app, expiry_utils
- Files: 5
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### material_writeoffs
- Used by modules: masters_common, db_utils, writeoff_analytics, material_writeoff, opening_balance
- Files: 5
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: masters_common, sku_production, traceability, purchase, app, db_utils, system_config, writeoff_analytics, masters_crud, material_writeoff, blending, batch_production, opening_balance
- Files: 25
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: masters_common, sku_production, locations, sku_outbound, writeoff_analytics, material_writeoff, material_sales, opening_balance, cost_management
- Files: 9
...
- Used by modules: masters_common, sku_production, db_utils, package_sizes, masters_crud
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - create_production_plan in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### purchases
- Used by modules: masters_common, sku_production, purchase, app, db_utils, blending, batch_production, opening_balance
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: masters_common, locations, customers, package_sizes, sku_management, masters_crud
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sku_expiry_tracking
- Used by modules: locations, sku_production, sku_outbound, db_utils, expiry_utils
- Files: 5
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: sku_production, locations, sku_outbound, db_utils, expiry_utils, material_writeoff
- Files: 6
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: sku_production, sku_outbound, app, package_sizes, db_utils, expiry_utils, system_config, sku_management, material_writeoff, masters_crud
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: sku_production, sku_outbound, app, db_utils, expiry_utils, sku_management, material_writeoff
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### status
- Used by modules: sku_production, sku_outbound, app, masters_crud, opening_balance
- Files: 5
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: masters_common, purchase, sku_outbound, db_utils, masters_crud, blending
- Files: 6
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: batch_production, sku_production, locations, customers, purchase, sku_outbound, app, package_sizes, expiry_utils, writeoff_analytics, system_config, sku_management, masters_crud, material_writeoff, blending, material_sales, opening_balance, cost_management
- Files: 18
...
### suppliers
- Used by modules: masters_common, sku_production, traceability, app, db_utils, system_config, purchase, opening_balance
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### utils
- Used by modules: batch_production, sku_production, locations, customers, purchase, sku_outbound, expiry_utils, writeoff_analytics, masters_crud, sku_management, material_writeoff, blending, material_sales, opening_balance, cost_management
- Files: 15

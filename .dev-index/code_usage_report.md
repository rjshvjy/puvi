...
Generated: 2025-09-07 19:03:27.270451
...
### batch
- Used by modules: masters_crud, app, sku_production, traceability, batch_production, blending, material_sales, material_writeoff, opening_balance, cost_management, db_utils, writeoff_analytics
- Files: 14
- Functions using this table:
...
- Used by modules: masters_crud, masters_common, batch_production, cost_management, db_utils
- Files: 5
- Functions using this table:
...
### batches
- Used by modules: app, sku_production, batch_production, blending, material_sales, material_writeoff, opening_balance
- Files: 7
- Functions using this table:
...
### categories_master
- Used by modules: masters_crud, purchase, masters_common, blending, material_writeoff, sku_outbound, db_utils
- Files: 7
- Functions using this table:
...
- Used by modules: masters_crud, masters_common, sku_production, batch_production, system_config, cost_management, package_sizes, db_utils
- Files: 8
- Functions using this table:
...
### database
- Used by modules: masters_crud, masters_common, sku_production, traceability, blending, system_config, material_writeoff, cost_management
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: expiry_utils, app, masters_common, masters_crud, date_utils, sku_production, traceability, blending, sku_management, inventory_utils, opening_balance, sku_outbound, cost_management, package_sizes
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: customers, masters_crud, app, masters_common, purchase, sku_production, batch_production, blending, material_sales, sku_management, locations, system_config, opening_balance, sku_outbound, material_writeoff, cost_management, package_sizes, writeoff_analytics
- Files: 18

### decimal
- Used by modules: expiry_utils, purchase, masters_common, validation, sku_production, masters_crud, batch_production, blending, material_sales, sku_management, locations, inventory_utils, opening_balance, sku_outbound, cost_management, package_sizes, writeoff_analytics
- Files: 17
...
### dependencies
- Used by modules: masters_crud, masters_common, sku_management, locations
- Files: 4
...
### errors
- Used by modules: customers, masters_crud, app, sku_management, locations, opening_balance, db_utils
- Files: 7

### existing
- Used by modules: expiry_utils, traceability, batch_production, inventory_utils, opening_balance, cost_management, package_sizes
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: customers, masters_crud, app, purchase, sku_production, batch_production, blending, material_sales, sku_management, locations, system_config, opening_balance, sku_outbound, material_writeoff, cost_management, package_sizes, writeoff_analytics
- Files: 17
...
### inventory
- Used by modules: masters_crud, purchase, sku_production, batch_production, blending, material_sales, material_writeoff, inventory_utils, opening_balance, db_utils
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### masters_audit_log
- Used by modules: opening_balance, masters_common, sku_management, db_utils
- Files: 4
- Functions using this table:
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - close_financial_year in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### material_writeoffs
- Used by modules: masters_common, material_writeoff, opening_balance, db_utils, writeoff_analytics
- Files: 5
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: masters_crud, app, masters_common, purchase, sku_production, traceability, batch_production, blending, system_config, opening_balance, material_writeoff, db_utils, writeoff_analytics
- Files: 24
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: masters_common, sku_production, batch_production, material_sales, locations, material_writeoff, opening_balance, sku_outbound, cost_management, writeoff_analytics
- Files: 10
...
### oil_cake_sales
- Used by modules: batch_production, material_sales, db_utils
- Files: 4
- Functions using this table:
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
  - get_material_sales_history in puvi-backend/puvi-backend-main/modules/material_sales.py
...
- Used by modules: masters_crud, masters_common, sku_production, package_sizes, db_utils
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - create_production_plan in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### purchases
- Used by modules: app, masters_common, purchase, sku_production, batch_production, blending, opening_balance, db_utils
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: customers, masters_crud, masters_common, sku_management, locations, package_sizes
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sales
- Used by modules: sku_outbound, app, masters_crud, material_sales
- Files: 4
...
### sku
- Used by modules: system_config, batch_production, sku_outbound, material_writeoff
- Files: 58
- Functions using this table:
  - get_oil_types in puvi-backend/puvi-backend-main/modules/batch_production.py
  - get_config in puvi-backend/puvi-backend-main/modules/system_config.py
...
### sku_expiry_tracking
- Used by modules: expiry_utils, sku_production, locations, sku_outbound, db_utils
- Files: 5
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: expiry_utils, sku_production, locations, material_writeoff, sku_outbound, db_utils
- Files: 6
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: expiry_utils, app, masters_crud, sku_production, batch_production, sku_management, system_config, material_writeoff, sku_outbound, db_utils, package_sizes
- Files: 11
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: expiry_utils, app, sku_production, sku_management, material_writeoff, sku_outbound, db_utils
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### subcategories_master
- Used by modules: masters_crud, purchase, masters_common, batch_production, blending, sku_outbound, db_utils
- Files: 7
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: customers, expiry_utils, app, purchase, masters_crud, sku_production, batch_production, blending, material_sales, sku_management, locations, system_config, opening_balance, sku_outbound, material_writeoff, cost_management, package_sizes, writeoff_analytics
- Files: 18
...
### suppliers
- Used by modules: app, masters_common, purchase, sku_production, traceability, system_config, opening_balance, db_utils
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### the
- Used by modules: masters_crud, traceability, batch_production, cost_management, db_utils
- Files: 5
- Functions using this table:
...
### utils
- Used by modules: customers, expiry_utils, purchase, masters_crud, sku_production, batch_production, blending, material_sales, sku_management, locations, material_writeoff, opening_balance, sku_outbound, cost_management, writeoff_analytics
- Files: 15

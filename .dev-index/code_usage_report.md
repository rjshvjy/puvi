...
Generated: 2025-09-08 17:46:02.053088
...
### allocations
- Used by modules: material_sales, sku_production, expiry_utils, sku_outbound, tm_configs, tm_output_operations
- Files: 6
...
### batch
- Used by modules: tm_production_operations, material_sales, material_writeoff, sku_production, blending, traceability, opening_balance, app, batch_production, writeoff_analytics, tm_input_operations, db_utils, tm_configs, masters_crud, cost_management, tm_output_operations
- Files: 18
- Functions using this table:
...
- Used by modules: tm_production_operations, masters_common, batch_production, tm_configs, db_utils, masters_crud, cost_management
- Files: 7
- Functions using this table:
...
### batches
- Used by modules: tm_production_operations, material_sales, material_writeoff, sku_production, blending, batch_production, opening_balance, app
- Files: 8
- Functions using this table:
...
- Used by modules: tm_production_operations, sku_production, blending, tm_configs, db_utils
- Files: 5
- Functions using this table:
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### blend_batches
- Used by modules: tm_production_operations, sku_production, tm_main, blending, tm_configs, db_utils, masters_crud, tm_output_operations
- Files: 8
- Functions using this table:
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
  - create_blend in puvi-backend/puvi-backend-main/modules/blending.py
...
### cascade_fields
- Used by modules: tm_input_operations, tm_configs, tm_production_operations, tm_main
- Files: 4

### categories
- Used by modules: material_writeoff, sku_production, masters_common, masters_crud, system_config
- Files: 9

### categories_master
- Used by modules: material_writeoff, sku_outbound, masters_common, blending, db_utils, masters_crud, purchase
- Files: 7
- Functions using this table:
...
### cost_elements
- Used by modules: masters_common, batch_production, masters_crud, system_config, cost_management
- Files: 24

### cost_elements_master
- Used by modules: tm_production_operations, sku_production, masters_common, batch_production, masters_crud, db_utils, system_config, package_sizes, cost_management
- Files: 9
- Functions using this table:
...
### cost_override_log
- Used by modules: tm_configs, cost_management, masters_common, db_utils
- Files: 4
- Functions using this table:
  - save_batch_costs in puvi-backend/puvi-backend-main/modules/cost_management.py
...
### database
- Used by modules: material_writeoff, sku_production, masters_common, blending, traceability, masters_crud, system_config, cost_management
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: expiry_utils, inventory_utils, sku_outbound, app, masters_crud, tm_output_operations, sku_management, date_utils, traceability, tm_production_operations, tm_main, tm_input_operations, tm_configs, package_sizes, cost_management, sku_production, masters_common, blending, opening_balance
- Files: 19
- Functions using this table:
...
### db_utils
- Used by modules: sku_outbound, app, masters_crud, tm_output_operations, purchase, sku_management, material_sales, writeoff_analytics, customers, locations, tm_production_operations, material_writeoff, tm_main, batch_production, tm_input_operations, system_config, package_sizes, cost_management, sku_production, masters_common, blending, opening_balance
- Files: 22

### decimal
- Used by modules: expiry_utils, inventory_utils, sku_outbound, validation, masters_crud, tm_output_operations, purchase, sku_management, material_sales, writeoff_analytics, locations, tm_production_operations, batch_production, tm_input_operations, package_sizes, cost_management, sku_production, masters_common, blending, opening_balance
- Files: 20
...
### dependencies
- Used by modules: locations, sku_management, tm_production_operations, masters_common, masters_crud, tm_output_operations
- Files: 6
...
### edit_status
- Used by modules: tm_input_operations, tm_configs, tm_production_operations, tm_output_operations
- Files: 4
...
### errors
- Used by modules: locations, sku_management, opening_balance, app, db_utils, masters_crud, customers
- Files: 7

### existing
- Used by modules: tm_production_operations, expiry_utils, inventory_utils, batch_production, traceability, opening_balance, package_sizes, cost_management
- Files: 8
- Functions using this table:
...
### flask
- Used by modules: sku_outbound, app, masters_crud, tm_output_operations, purchase, sku_management, material_sales, writeoff_analytics, customers, locations, tm_production_operations, material_writeoff, tm_main, batch_production, tm_input_operations, system_config, package_sizes, cost_management, sku_production, blending, opening_balance
- Files: 21
...
### has_dependencies
- Used by modules: locations, tm_production_operations, masters_common, tm_input_operations, masters_crud, tm_output_operations
- Files: 6
...
### inventory
- Used by modules: tm_production_operations, material_sales, material_writeoff, sku_production, inventory_utils, blending, batch_production, opening_balance, tm_input_operations, db_utils, masters_crud, purchase
- Files: 14
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### items
- Used by modules: material_writeoff, sku_production, sku_outbound, tm_input_operations, tm_configs, tm_output_operations, purchase
- Files: 7
...
### locations_master
- Used by modules: locations, sku_production, expiry_utils, sku_outbound, app, tm_output_operations
- Files: 6
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### material_writeoffs
- Used by modules: material_writeoff, masters_common, tm_main, tm_input_operations, opening_balance, tm_configs, writeoff_analytics, db_utils
- Files: 8
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: tm_output_operations, tm_production_operations, material_writeoff, sku_production, masters_common, blending, traceability, opening_balance, app, batch_production, writeoff_analytics, masters_crud, db_utils, tm_input_operations, system_config, purchase
- Files: 27
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### net_loss
- Used by modules: tm_input_operations, tm_configs, writeoff_analytics, material_writeoff
- Files: 4
...
### notes
- Used by modules: locations, tm_production_operations, material_sales, material_writeoff, sku_production, sku_outbound, masters_common, batch_production, tm_input_operations, opening_balance, tm_configs, writeoff_analytics, cost_management, tm_output_operations
- Files: 14
...
### oil
- Used by modules: sku_production, tm_production_operations, tm_output_operations, material_writeoff
- Files: 11
- Functions using this table:
...
### oil_cake_inventory
- Used by modules: tm_production_operations, material_sales, material_writeoff, batch_production, tm_input_operations, db_utils, tm_output_operations
- Files: 8
- Functions using this table:
  - get_material_sales_inventory in puvi-backend/puvi-backend-main/modules/material_sales.py
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
...
- Used by modules: tm_production_operations, material_sales, tm_configs, db_utils, tm_output_operations
- Files: 5
- Functions using this table:
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
...
### oil_cake_sales
- Used by modules: material_sales, tm_main, batch_production, tm_configs, db_utils, tm_output_operations
- Files: 7
- Functions using this table:
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
  - get_material_sales_history in puvi-backend/puvi-backend-main/modules/material_sales.py
...
### options
- Used by modules: masters_crud, package_sizes, app, masters_common
- Files: 4
...
- Used by modules: sku_production, masters_common, db_utils, masters_crud, package_sizes
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - create_production_plan in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### purchase_items
- Used by modules: masters_common, batch_production, tm_input_operations, tm_configs, db_utils, purchase
- Files: 6
- Functions using this table:
...
### purchases
- Used by modules: tm_output_operations, sku_production, masters_common, blending, batch_production, opening_balance, app, tm_input_operations, tm_main, tm_configs, db_utils, purchase
- Files: 16
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: package_sizes, locations, sku_management, tm_production_operations, masters_common, tm_main, tm_input_operations, masters_crud, customers, tm_output_operations
- Files: 10
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sales
- Used by modules: material_sales, sku_outbound, app, masters_crud, tm_output_operations
- Files: 5
...
### sku_expiry_tracking
- Used by modules: locations, sku_production, expiry_utils, sku_outbound, db_utils, tm_output_operations
- Files: 6
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: locations, material_writeoff, sku_production, expiry_utils, sku_outbound, tm_input_operations, db_utils, tm_output_operations
- Files: 8
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: sku_management, material_writeoff, sku_production, expiry_utils, sku_outbound, batch_production, tm_input_operations, masters_crud, app, db_utils, system_config, package_sizes, tm_output_operations
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_oil_allocation
- Used by modules: tm_production_operations, sku_production, tm_configs, db_utils, tm_output_operations
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - get_production_summary_report in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_production
- Used by modules: sku_management, material_writeoff, sku_production, expiry_utils, sku_outbound, app, db_utils, tm_output_operations
- Files: 8
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### statistics
- Used by modules: tm_main, opening_balance, app, writeoff_analytics, masters_crud
- Files: 5
...
### status
- Used by modules: tm_production_operations, sku_production, sku_outbound, tm_main, tm_input_operations, opening_balance, app, tm_configs, masters_crud, tm_output_operations
- Files: 10
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: sku_outbound, masters_common, blending, batch_production, db_utils, masters_crud, purchase
- Files: 7
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: expiry_utils, sku_outbound, app, masters_crud, tm_output_operations, purchase, sku_management, material_sales, writeoff_analytics, customers, locations, tm_production_operations, material_writeoff, tm_main, batch_production, tm_input_operations, system_config, package_sizes, cost_management, sku_production, blending, opening_balance
- Files: 22
...
### suppliers
- Used by modules: sku_production, masters_common, traceability, opening_balance, app, tm_input_operations, db_utils, system_config, purchase
- Files: 14
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### the
- Used by modules: tm_production_operations, batch_production, traceability, tm_input_operations, db_utils, masters_crud, cost_management
- Files: 7
- Functions using this table:
...
### utils
- Used by modules: tm_output_operations, locations, sku_management, material_sales, tm_production_operations, material_writeoff, sku_production, expiry_utils, sku_outbound, blending, batch_production, opening_balance, tm_input_operations, writeoff_analytics, masters_crud, customers, cost_management, purchase
- Files: 18
...
### writeoffs
- Used by modules: tm_input_operations, opening_balance, writeoff_analytics, material_writeoff
- Files: 4

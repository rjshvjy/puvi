...
Generated: 2025-08-30 08:59:35.999757
...
### batch
- Used by modules: app, material_writeoff, batch_production, opening_balance, cost_management, traceability, sku_production, writeoff_analytics, db_utils, material_sales, blending, masters_crud
- Files: 14
- Functions using this table:
...
### batches
- Used by modules: app, material_writeoff, batch_production, opening_balance, sku_production, material_sales, blending
- Files: 7
- Functions using this table:
...
### categories
- Used by modules: material_writeoff, masters_common, masters_crud, sku_production, sku_management, system_config
- Files: 11

### categories_master
- Used by modules: material_writeoff, purchase, masters_common, db_utils, blending, masters_crud
- Files: 6
- Functions using this table:
...
### cost_elements
- Used by modules: batch_production, cost_management, sku_outbound, masters_common, masters_crud, system_config
- Files: 26

### cost_elements_master
- Used by modules: batch_production, cost_management, masters_common, sku_production, db_utils, package_sizes, sku_management, system_config
- Files: 8
- Functions using this table:
...
### database
- Used by modules: material_writeoff, batch_production, cost_management, traceability, masters_common, sku_production, blending, system_config
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: expiry_utils, app, opening_balance, cost_management, sku_outbound, traceability, masters_common, masters_crud, date_utils, sku_production, blending, inventory_utils, sku_management, package_sizes
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: customers, app, material_writeoff, locations, batch_production, opening_balance, purchase, cost_management, sku_outbound, masters_common, masters_crud, sku_production, writeoff_analytics, material_sales, blending, package_sizes, sku_management, system_config
- Files: 18

### decimal
- Used by modules: expiry_utils, locations, batch_production, opening_balance, purchase, cost_management, sku_outbound, masters_common, masters_crud, sku_production, writeoff_analytics, validation, material_sales, blending, inventory_utils, sku_management, package_sizes
- Files: 17
...
### errors
- Used by modules: customers, app, locations, opening_balance, db_utils, sku_management, masters_crud
- Files: 7

### existing
- Used by modules: expiry_utils, batch_production, opening_balance, cost_management, traceability, inventory_utils, sku_management, package_sizes
- Files: 8
- Functions using this table:
...
### flask
- Used by modules: customers, app, material_writeoff, locations, batch_production, opening_balance, purchase, cost_management, sku_outbound, masters_crud, sku_production, writeoff_analytics, material_sales, blending, package_sizes, sku_management, system_config
- Files: 17
...
### inventory
- Used by modules: material_writeoff, batch_production, opening_balance, purchase, sku_production, db_utils, material_sales, blending, inventory_utils, masters_crud
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### materials
- Used by modules: app, material_writeoff, batch_production, opening_balance, purchase, traceability, masters_common, masters_crud, sku_production, writeoff_analytics, db_utils, blending, sku_management, system_config
- Files: 27
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: material_writeoff, locations, opening_balance, cost_management, sku_outbound, masters_common, sku_production, writeoff_analytics, material_sales, sku_management
- Files: 10
...
### oil_types
- Used by modules: material_writeoff, batch_production, material_sales, blending, system_config
- Files: 7
...
### purchases
- Used by modules: app, batch_production, opening_balance, purchase, masters_common, sku_production, db_utils, blending
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: customers, locations, masters_common, package_sizes, sku_management, masters_crud
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sku_master
- Used by modules: expiry_utils, app, material_writeoff, sku_outbound, masters_crud, sku_production, db_utils, package_sizes, sku_management, system_config
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: expiry_utils, app, material_writeoff, sku_outbound, sku_production, db_utils, sku_management
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### statistics
- Used by modules: opening_balance, app, writeoff_analytics, masters_crud
- Files: 4

### status
- Used by modules: app, opening_balance, sku_outbound, sku_production, masters_crud
- Files: 5
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: purchase, masters_common, db_utils, blending, masters_crud
- Files: 5
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: customers, expiry_utils, app, material_writeoff, locations, batch_production, opening_balance, purchase, cost_management, sku_outbound, masters_crud, sku_production, writeoff_analytics, material_sales, blending, package_sizes, sku_management, system_config
- Files: 18
...
### suppliers
- Used by modules: app, opening_balance, purchase, traceability, masters_common, sku_production, db_utils, system_config
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### utils
- Used by modules: customers, expiry_utils, material_writeoff, locations, batch_production, opening_balance, purchase, cost_management, sku_outbound, sku_production, writeoff_analytics, material_sales, blending, sku_management, masters_crud
- Files: 15

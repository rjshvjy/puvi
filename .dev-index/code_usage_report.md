...
Generated: 2025-08-30 01:24:26.770458

## Summary
- Tables found in code: 359
- Backend files scanned: 25
...
### batch
- Used by modules: writeoff_analytics, masters_crud, sku_production, db_utils, app, blending, material_writeoff, material_sales, traceability, batch_production, cost_management, opening_balance
- Files: 14
- Functions using this table:
...
### batches
- Used by modules: sku_production, app, blending, material_writeoff, material_sales, batch_production, opening_balance
- Files: 7
- Functions using this table:
...
### categories
- Used by modules: system_config, masters_crud, sku_production, sku_management, masters_common, material_writeoff
- Files: 11

### categories_master
- Used by modules: masters_crud, db_utils, masters_common, blending, material_writeoff, purchase
- Files: 6
- Functions using this table:
...
### cost_elements
- Used by modules: system_config, masters_crud, masters_common, sku_outbound, batch_production, cost_management
- Files: 26

### cost_elements_master
- Used by modules: system_config, sku_production, db_utils, sku_management, masters_common, batch_production, cost_management, package_sizes
- Files: 8
- Functions using this table:
...
### database
- Used by modules: system_config, sku_production, blending, masters_common, material_writeoff, traceability, batch_production, cost_management
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: masters_crud, sku_production, sku_management, app, blending, package_sizes, masters_common, sku_outbound, expiry_utils, traceability, cost_management, opening_balance, date_utils, inventory_utils
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: system_config, writeoff_analytics, masters_crud, sku_production, sku_management, app, blending, masters_common, sku_outbound, material_writeoff, material_sales, batch_production, cost_management, opening_balance, purchase, package_sizes
- Files: 16

### decimal
- Used by modules: writeoff_analytics, masters_crud, sku_production, sku_management, package_sizes, blending, masters_common, sku_outbound, material_sales, expiry_utils, validation, cost_management, batch_production, opening_balance, purchase, inventory_utils
- Files: 16
...
### dependencies
- Used by modules: sku_management, masters_common, masters_crud
- Files: 3
...
### errors
- Used by modules: masters_crud, db_utils, sku_management, app, opening_balance
- Files: 5

### existing
- Used by modules: sku_management, package_sizes, expiry_utils, traceability, batch_production, cost_management, opening_balance, inventory_utils
- Files: 8
- Functions using this table:
...
### flask
- Used by modules: system_config, writeoff_analytics, masters_crud, sku_production, sku_management, app, blending, sku_outbound, material_writeoff, material_sales, batch_production, cost_management, opening_balance, purchase, package_sizes
- Files: 15
...
### inventory
- Used by modules: masters_crud, sku_production, db_utils, blending, material_writeoff, material_sales, batch_production, opening_balance, purchase, inventory_utils
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### materials
- Used by modules: system_config, writeoff_analytics, masters_crud, sku_production, db_utils, sku_management, app, blending, masters_common, material_writeoff, traceability, batch_production, opening_balance, purchase
- Files: 27
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: writeoff_analytics, sku_production, sku_management, masters_common, sku_outbound, material_writeoff, material_sales, cost_management, opening_balance
- Files: 9
...
### purchases
- Used by modules: sku_production, db_utils, app, blending, masters_common, batch_production, opening_balance, purchase
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: sku_management, package_sizes, masters_common, masters_crud
- Files: 4
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sku_expiry_tracking
- Used by modules: sku_production, db_utils, expiry_utils, sku_outbound
- Files: 4
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: sku_production, db_utils, material_writeoff, sku_outbound
- Files: 4
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: system_config, masters_crud, sku_production, db_utils, sku_management, app, sku_outbound, material_writeoff, expiry_utils, package_sizes
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: sku_production, db_utils, sku_management, app, sku_outbound, material_writeoff, expiry_utils
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### status
- Used by modules: masters_crud, sku_production, app, sku_outbound, opening_balance
- Files: 5
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: masters_crud, db_utils, masters_common, blending, purchase
- Files: 5
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: system_config, writeoff_analytics, masters_crud, sku_production, sku_management, app, blending, sku_outbound, material_writeoff, material_sales, expiry_utils, batch_production, cost_management, opening_balance, purchase, package_sizes
- Files: 16
...
### suppliers
- Used by modules: system_config, sku_production, db_utils, app, masters_common, traceability, opening_balance, purchase
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### utils
- Used by modules: writeoff_analytics, masters_crud, sku_production, sku_management, blending, sku_outbound, material_writeoff, material_sales, expiry_utils, batch_production, cost_management, opening_balance, purchase
- Files: 13

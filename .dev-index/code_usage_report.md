...
Generated: 2025-09-07 14:05:28.858649
...
### batch
- Used by modules: material_sales, writeoff_analytics, db_utils, blending, traceability, app, sku_production, batch_production, opening_balance, material_writeoff, cost_management, masters_crud
- Files: 14
- Functions using this table:
...
- Used by modules: db_utils, masters_common, batch_production, cost_management, masters_crud
- Files: 5
- Functions using this table:
...
### batches
- Used by modules: material_sales, blending, app, sku_production, batch_production, opening_balance, material_writeoff
- Files: 7
- Functions using this table:
...
### categories
- Used by modules: masters_common, sku_production, material_writeoff, system_config, masters_crud
- Files: 10

### categories_master
- Used by modules: db_utils, purchase, blending, masters_common, material_writeoff, masters_crud, sku_outbound
- Files: 7
- Functions using this table:
...
- Used by modules: package_sizes, db_utils, masters_common, sku_production, batch_production, system_config, cost_management, masters_crud
- Files: 8
- Functions using this table:
...
### database
- Used by modules: blending, traceability, masters_common, sku_production, batch_production, system_config, material_writeoff, cost_management, masters_crud
- Files: 9
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: sku_management, date_utils, expiry_utils, package_sizes, blending, traceability, app, masters_common, sku_production, inventory_utils, opening_balance, cost_management, masters_crud, sku_outbound
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: sku_management, material_sales, customers, writeoff_analytics, package_sizes, blending, purchase, app, masters_common, sku_production, batch_production, opening_balance, system_config, material_writeoff, cost_management, locations, masters_crud, sku_outbound
- Files: 18

### decimal
- Used by modules: sku_management, material_sales, writeoff_analytics, expiry_utils, package_sizes, blending, purchase, masters_common, sku_production, batch_production, opening_balance, inventory_utils, locations, cost_management, masters_crud, sku_outbound, validation
- Files: 17
...
### errors
- Used by modules: sku_management, customers, db_utils, app, opening_balance, locations, masters_crud
- Files: 7

### existing
- Used by modules: expiry_utils, package_sizes, traceability, batch_production, inventory_utils, opening_balance, cost_management
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: sku_management, material_sales, customers, writeoff_analytics, package_sizes, blending, purchase, app, sku_production, batch_production, opening_balance, system_config, material_writeoff, cost_management, locations, masters_crud, sku_outbound
- Files: 17
...
### inventory
- Used by modules: material_sales, db_utils, blending, purchase, sku_production, batch_production, opening_balance, inventory_utils, material_writeoff, masters_crud
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### material_writeoffs
- Used by modules: writeoff_analytics, db_utils, masters_common, opening_balance, material_writeoff
- Files: 5
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: writeoff_analytics, db_utils, blending, purchase, traceability, app, masters_common, sku_production, batch_production, opening_balance, material_writeoff, system_config, masters_crud
- Files: 25
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: material_sales, writeoff_analytics, masters_common, sku_production, opening_balance, locations, material_writeoff, cost_management, sku_outbound
- Files: 9
...
### oil_types
- Used by modules: material_sales, blending, batch_production, material_writeoff, system_config
- Files: 7
...
### purchases
- Used by modules: db_utils, blending, purchase, app, masters_common, sku_production, batch_production, opening_balance
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: sku_management, customers, package_sizes, masters_common, locations, masters_crud
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sales
- Used by modules: material_sales, app, sku_outbound, masters_crud
- Files: 4
...
### sku_expiry_tracking
- Used by modules: expiry_utils, db_utils, sku_production, locations, sku_outbound
- Files: 5
- Functions using this table:
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - update_expiry_tracking in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_inventory
- Used by modules: expiry_utils, db_utils, sku_production, locations, material_writeoff, sku_outbound
- Files: 6
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: sku_management, expiry_utils, package_sizes, db_utils, app, sku_production, material_writeoff, system_config, masters_crud, sku_outbound
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: sku_management, expiry_utils, db_utils, app, sku_production, material_writeoff, sku_outbound
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### status
- Used by modules: app, sku_production, opening_balance, masters_crud, sku_outbound
- Files: 5
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: db_utils, purchase, blending, masters_common, masters_crud, sku_outbound
- Files: 6
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: sku_management, material_sales, customers, writeoff_analytics, expiry_utils, package_sizes, blending, purchase, app, sku_production, batch_production, opening_balance, system_config, material_writeoff, cost_management, locations, masters_crud, sku_outbound
- Files: 18
...
### suppliers
- Used by modules: db_utils, purchase, traceability, app, masters_common, sku_production, opening_balance, system_config
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### utils
- Used by modules: sku_management, material_sales, customers, writeoff_analytics, expiry_utils, blending, purchase, sku_production, batch_production, opening_balance, locations, material_writeoff, cost_management, masters_crud, sku_outbound
- Files: 15

...
Generated: 2025-09-09 05:55:46.416913
...
### address
- Used by modules: customers, locations, masters_common
- Files: 3
...
### allocations
- Used by modules: tm_output_operations, expiry_utils, tm_configs, material_sales, sku_outbound, sku_production
- Files: 6
...
### batch
- Used by modules: tm_production_operations, blending, cost_management, material_writeoff, tm_output_operations, opening_balance, db_utils, writeoff_analytics, tm_configs, sku_production, material_sales, traceability, batch_production, tm_input_operations, app, masters_crud
- Files: 18
- Functions using this table:
...
- Used by modules: tm_production_operations, cost_management, db_utils, masters_common, tm_configs, batch_production, masters_crud
- Files: 7
- Functions using this table:
...
### batches
- Used by modules: tm_production_operations, blending, material_writeoff, opening_balance, sku_production, material_sales, batch_production, tm_main, app
- Files: 9
- Functions using this table:
...
- Used by modules: tm_production_operations, blending, db_utils, tm_configs, sku_production
- Files: 5
- Functions using this table:
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### blend_batches
- Used by modules: tm_production_operations, blending, tm_output_operations, db_utils, tm_configs, tm_main, sku_production, masters_crud
- Files: 8
- Functions using this table:
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
  - create_blend in puvi-backend/puvi-backend-main/modules/blending.py
...
### cascade_fields
- Used by modules: tm_production_operations, tm_input_operations, tm_main, tm_configs
- Files: 4
...
### categories_master
- Used by modules: blending, material_writeoff, db_utils, masters_common, purchase, sku_outbound, masters_crud
- Files: 7
- Functions using this table:
...
### cost_elements
- Used by modules: system_config, cost_management, masters_common, batch_production, masters_crud
- Files: 24

### cost_elements_master
- Used by modules: system_config, tm_production_operations, cost_management, package_sizes, db_utils, masters_common, batch_production, sku_production, masters_crud
- Files: 9
- Functions using this table:
...
### customers
- Used by modules: tm_output_operations, locations, customers, sku_outbound, app
- Files: 16
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_customer_all_locations in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### database
- Used by modules: system_config, blending, cost_management, material_writeoff, masters_common, traceability, sku_production, masters_crud
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: blending, expiry_utils, tm_output_operations, inventory_utils, date_utils, masters_common, traceability, tm_input_operations, sku_production, app, tm_production_operations, package_sizes, tm_main, cost_management, opening_balance, tm_configs, sku_outbound, sku_management, masters_crud
- Files: 19
- Functions using this table:
...
### db_utils
- Used by modules: blending, tm_output_operations, masters_common, customers, tm_input_operations, sku_production, app, tm_production_operations, package_sizes, purchase, tm_main, cost_management, material_writeoff, opening_balance, locations, material_sales, sku_outbound, system_config, writeoff_analytics, batch_production, sku_management, masters_crud
- Files: 22

### decimal
- Used by modules: blending, expiry_utils, tm_output_operations, inventory_utils, masters_common, tm_input_operations, sku_production, tm_production_operations, package_sizes, validation, purchase, cost_management, opening_balance, locations, material_sales, sku_outbound, writeoff_analytics, batch_production, sku_management, masters_crud
- Files: 20
...
### dependencies
- Used by modules: tm_production_operations, tm_output_operations, locations, masters_common, sku_management, masters_crud
- Files: 6
...
### edit_status
- Used by modules: tm_production_operations, tm_input_operations, tm_output_operations, tm_configs
- Files: 4

### editable_fields
- Used by modules: tm_production_operations, tm_input_operations, tm_output_operations
- Files: 3
...
### errors
- Used by modules: opening_balance, db_utils, locations, customers, sku_management, app, masters_crud
- Files: 7

### existing
- Used by modules: tm_production_operations, cost_management, expiry_utils, inventory_utils, opening_balance, package_sizes, traceability, batch_production
- Files: 8
- Functions using this table:
...
### flask
- Used by modules: blending, tm_output_operations, customers, tm_input_operations, sku_production, app, tm_production_operations, package_sizes, purchase, tm_main, cost_management, material_writeoff, opening_balance, locations, material_sales, sku_outbound, system_config, writeoff_analytics, batch_production, sku_management, masters_crud
- Files: 21
...
### has_dependencies
- Used by modules: tm_production_operations, tm_output_operations, locations, masters_common, tm_input_operations, masters_crud
- Files: 6
...
### inventory
- Used by modules: tm_production_operations, blending, material_writeoff, inventory_utils, opening_balance, db_utils, purchase, material_sales, batch_production, tm_input_operations, sku_production, masters_crud
- Files: 14
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### items
- Used by modules: tm_output_operations, material_writeoff, tm_configs, purchase, sku_outbound, tm_input_operations, sku_production
- Files: 7
...
### locations_master
- Used by modules: expiry_utils, tm_output_operations, locations, sku_outbound, app, sku_production
- Files: 6
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### material_writeoffs
- Used by modules: material_writeoff, opening_balance, db_utils, writeoff_analytics, masters_common, tm_configs, tm_main, tm_input_operations
- Files: 8
- Functions using this table:
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
  - initialize_system in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### materials
- Used by modules: system_config, blending, tm_production_operations, material_writeoff, tm_output_operations, opening_balance, db_utils, writeoff_analytics, masters_common, sku_production, purchase, traceability, batch_production, tm_input_operations, app, masters_crud
- Files: 27
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### net_loss
- Used by modules: writeoff_analytics, material_writeoff, tm_input_operations, tm_configs
- Files: 4
...
### notes
- Used by modules: tm_production_operations, cost_management, material_writeoff, tm_output_operations, opening_balance, writeoff_analytics, locations, masters_common, tm_configs, material_sales, batch_production, sku_outbound, tm_input_operations, sku_production
- Files: 14
...
### oil
- Used by modules: tm_output_operations, tm_production_operations, material_writeoff, sku_production
- Files: 11
- Functions using this table:
...
### oil_cake_inventory
- Used by modules: tm_production_operations, tm_output_operations, material_writeoff, db_utils, material_sales, batch_production, tm_input_operations
- Files: 8
- Functions using this table:
  - get_material_sales_inventory in puvi-backend/puvi-backend-main/modules/material_sales.py
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
...
- Used by modules: tm_production_operations, tm_output_operations, db_utils, tm_configs, material_sales
- Files: 5
- Functions using this table:
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
  ...
  - delete_oil_cake_sale in puvi-backend/puvi-backend-main/transaction_management/tm_output_operations.py
  - check_batch_dependencies in puvi-backend/puvi-backend-main/transaction_management/tm_production_operations.py

### oil_cake_sales
- Used by modules: tm_output_operations, db_utils, tm_configs, material_sales, batch_production, tm_main
- Files: 7
- Functions using this table:
  - add_material_sale in puvi-backend/puvi-backend-main/modules/material_sales.py
  - get_material_sales_history in puvi-backend/puvi-backend-main/modules/material_sales.py
...
### oil_types
- Used by modules: system_config, blending, material_writeoff, material_sales, batch_production
- Files: 7
...
- Used by modules: package_sizes, db_utils, masters_common, sku_production, masters_crud
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - create_production_plan in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### productions
- Used by modules: tm_output_operations, app, tm_main, sku_management, sku_production
- Files: 5
...
### purchase_items
- Used by modules: db_utils, masters_common, tm_configs, purchase, batch_production, tm_input_operations
- Files: 6
- Functions using this table:
...
### purchases
- Used by modules: blending, tm_output_operations, opening_balance, db_utils, masters_common, tm_configs, sku_production, purchase, tm_main, batch_production, tm_input_operations, app
- Files: 16
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: tm_production_operations, tm_output_operations, package_sizes, locations, masters_common, customers, tm_main, tm_input_operations, sku_management, masters_crud
- Files: 10
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### records
- Used by modules: tm_main, expiry_utils, masters_crud
- Files: 3
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sales
- Used by modules: tm_output_operations, material_sales, sku_outbound, tm_main, app, masters_crud
- Files: 6
...
### sku_inventory
- Used by modules: expiry_utils, material_writeoff, tm_output_operations, db_utils, locations, sku_outbound, tm_input_operations, sku_production
- Files: 8
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: system_config, expiry_utils, material_writeoff, tm_output_operations, package_sizes, db_utils, sku_production, batch_production, sku_outbound, tm_input_operations, sku_management, app, masters_crud
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_oil_allocation
- Used by modules: tm_production_operations, tm_output_operations, db_utils, tm_configs, sku_production
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
  - get_production_summary_report in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_production
- Used by modules: expiry_utils, material_writeoff, tm_output_operations, db_utils, sku_production, sku_outbound, sku_management, app
- Files: 8
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### source
- Used by modules: blending, traceability, sku_outbound
- Files: 3
- Functions using this table:
  - generate_blend_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - create_blend in puvi-backend/puvi-backend-main/modules/blending.py
...
### status
- Used by modules: tm_production_operations, tm_output_operations, opening_balance, tm_configs, tm_main, sku_outbound, app, tm_input_operations, sku_production, masters_crud
- Files: 10
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: blending, db_utils, masters_common, purchase, sku_outbound, batch_production, masters_crud
- Files: 7
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: blending, expiry_utils, tm_output_operations, customers, tm_input_operations, sku_production, app, tm_production_operations, package_sizes, purchase, tm_main, cost_management, material_writeoff, opening_balance, locations, material_sales, sku_outbound, system_config, writeoff_analytics, batch_production, sku_management, masters_crud
- Files: 22
...
### suppliers
- Used by modules: system_config, opening_balance, db_utils, masters_common, sku_production, purchase, traceability, tm_input_operations, app
- Files: 14
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### the
- Used by modules: tm_production_operations, cost_management, db_utils, traceability, batch_production, tm_input_operations, masters_crud
- Files: 7
- Functions using this table:
...
### utils
- Used by modules: tm_production_operations, blending, cost_management, expiry_utils, material_writeoff, tm_output_operations, opening_balance, writeoff_analytics, locations, purchase, customers, material_sales, batch_production, sku_outbound, tm_input_operations, sku_management, sku_production, masters_crud
- Files: 18
...
### writeoff_reasons
- Used by modules: system_config, writeoff_analytics, material_writeoff, masters_common
- Files: 6
- Functions using this table:
  - get_writeoff_dashboard in puvi-backend/puvi-backend-main/modules/writeoff_analytics.py
  - get_writeoff_report in puvi-backend/puvi-backend-main/modules/writeoff_analytics.py
...
### writeoffs
- Used by modules: material_writeoff, opening_balance, writeoff_analytics, tm_input_operations, tm_main
- Files: 5

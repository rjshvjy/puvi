...
Generated: 2025-09-02 05:34:12.261103
...
### batch
- Used by modules: traceability, app, material_sales, writeoff_analytics, sku_production, opening_balance, blending, batch_production, masters_crud, material_writeoff, db_utils, cost_management
- Files: 14
- Functions using this table:
...
### batches
- Used by modules: app, material_sales, sku_production, opening_balance, blending, batch_production, material_writeoff
- Files: 7
- Functions using this table:
...
### categories_master
- Used by modules: purchase, masters_common, sku_outbound, blending, masters_crud, material_writeoff, db_utils
- Files: 7
- Functions using this table:
...
### cost_elements
- Used by modules: masters_common, system_config, batch_production, masters_crud, cost_management
- Files: 25

### cost_elements_master
- Used by modules: masters_common, system_config, sku_production, batch_production, package_sizes, db_utils, cost_management
- Files: 7
- Functions using this table:
...
### database
- Used by modules: traceability, masters_common, system_config, sku_production, batch_production, blending, material_writeoff, cost_management
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: traceability, masters_common, app, inventory_utils, date_utils, sku_production, sku_management, opening_balance, sku_outbound, blending, package_sizes, masters_crud, expiry_utils, cost_management
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: purchase, masters_common, app, material_sales, writeoff_analytics, system_config, locations, sku_production, sku_management, opening_balance, sku_outbound, blending, batch_production, package_sizes, masters_crud, material_writeoff, customers, cost_management
- Files: 18

### decimal
- Used by modules: purchase, masters_common, material_sales, inventory_utils, writeoff_analytics, locations, sku_production, sku_management, opening_balance, sku_outbound, blending, expiry_utils, batch_production, package_sizes, masters_crud, validation, cost_management
- Files: 17
...
### errors
- Used by modules: app, locations, opening_balance, masters_crud, db_utils, customers, sku_management
- Files: 7

### existing
- Used by modules: traceability, inventory_utils, opening_balance, batch_production, package_sizes, expiry_utils, cost_management
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: purchase, app, material_sales, writeoff_analytics, system_config, locations, sku_production, sku_management, opening_balance, sku_outbound, blending, batch_production, package_sizes, masters_crud, material_writeoff, customers, cost_management
- Files: 17
...
### inventory
- Used by modules: purchase, material_sales, inventory_utils, sku_production, opening_balance, blending, batch_production, masters_crud, material_writeoff, db_utils
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### materials
- Used by modules: purchase, traceability, masters_common, app, writeoff_analytics, system_config, sku_production, opening_balance, blending, batch_production, masters_crud, material_writeoff, db_utils
- Files: 26
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: masters_common, material_sales, writeoff_analytics, locations, sku_production, opening_balance, sku_outbound, material_writeoff, cost_management
- Files: 9
...
### purchases
- Used by modules: purchase, masters_common, app, sku_production, opening_balance, blending, batch_production, db_utils
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### query
- Used by modules: masters_common, locations, package_sizes, masters_crud, customers, sku_management
- Files: 6
- Functions using this table:
  - update_package_size in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### sku_inventory
- Used by modules: locations, sku_production, sku_outbound, expiry_utils, material_writeoff, db_utils
- Files: 6
- Functions using this table:
  - repair_missing_locations in puvi-backend/puvi-backend-main/utils/expiry_utils.py
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: app, system_config, sku_production, sku_outbound, package_sizes, masters_crud, material_writeoff, expiry_utils, db_utils, sku_management
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: app, sku_production, sku_outbound, material_writeoff, expiry_utils, db_utils, sku_management
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### status
- Used by modules: app, sku_production, sku_outbound, opening_balance, masters_crud
- Files: 5
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: purchase, masters_common, sku_outbound, blending, masters_crud, db_utils
- Files: 6
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: purchase, app, material_sales, writeoff_analytics, system_config, locations, sku_production, sku_management, opening_balance, sku_outbound, blending, batch_production, package_sizes, masters_crud, material_writeoff, expiry_utils, customers, cost_management
- Files: 18
...
### suppliers
- Used by modules: purchase, traceability, masters_common, app, system_config, sku_production, opening_balance, db_utils
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### utils
- Used by modules: purchase, material_sales, writeoff_analytics, locations, sku_production, sku_management, opening_balance, sku_outbound, blending, batch_production, masters_crud, material_writeoff, expiry_utils, customers, cost_management
- Files: 15

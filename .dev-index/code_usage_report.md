...
Generated: 2025-08-31 05:35:31.297720
...
### batch
- Used by modules: material_sales, sku_production, opening_balance, batch_production, writeoff_analytics, material_writeoff, masters_crud, traceability, app, blending, db_utils, cost_management
- Files: 14
- Functions using this table:
...
### batches
- Used by modules: material_sales, sku_production, opening_balance, batch_production, material_writeoff, app, blending
- Files: 7
- Functions using this table:
...
### categories
- Used by modules: system_config, sku_production, masters_crud, material_writeoff, masters_common
- Files: 10

### categories_master
- Used by modules: material_writeoff, masters_crud, blending, masters_common, db_utils, purchase
- Files: 6
- Functions using this table:
...
### cost_elements
- Used by modules: system_config, batch_production, masters_crud, masters_common, cost_management
- Files: 25

### cost_elements_master
- Used by modules: system_config, sku_production, batch_production, masters_common, package_sizes, db_utils, cost_management
- Files: 7
- Functions using this table:
...
### database
- Used by modules: system_config, sku_production, batch_production, material_writeoff, traceability, blending, masters_common, cost_management
- Files: 8
- Functions using this table:
  - generate_batch_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
...
### datetime
- Used by modules: sku_production, expiry_utils, opening_balance, sku_management, masters_crud, traceability, date_utils, app, blending, inventory_utils, package_sizes, masters_common, sku_outbound, cost_management
- Files: 14
- Functions using this table:
...
### db_utils
- Used by modules: material_sales, system_config, sku_production, opening_balance, batch_production, writeoff_analytics, material_writeoff, sku_management, masters_crud, locations, app, blending, package_sizes, masters_common, purchase, sku_outbound, cost_management, customers
- Files: 18

### decimal
- Used by modules: material_sales, sku_production, opening_balance, expiry_utils, batch_production, writeoff_analytics, sku_management, masters_crud, locations, blending, inventory_utils, package_sizes, validation, masters_common, purchase, sku_outbound, cost_management
- Files: 17
...
### errors
- Used by modules: sku_management, opening_balance, masters_crud, locations, app, db_utils, customers
- Files: 7

### existing
- Used by modules: opening_balance, expiry_utils, batch_production, traceability, inventory_utils, package_sizes, cost_management
- Files: 7
- Functions using this table:
...
### flask
- Used by modules: material_sales, system_config, sku_production, opening_balance, batch_production, writeoff_analytics, material_writeoff, sku_management, masters_crud, locations, app, blending, package_sizes, purchase, sku_outbound, cost_management, customers
- Files: 17
...
### in
- Used by modules: package_sizes, sku_management, cost_management
- Files: 3
- Functions using this table:
  - bulk_update_cost_elements in puvi-backend/puvi-backend-main/modules/cost_management.py
  - bulk_update_package_sizes in puvi-backend/puvi-backend-main/modules/package_sizes.py
...
### inventory
- Used by modules: material_sales, sku_production, opening_balance, batch_production, material_writeoff, masters_crud, blending, inventory_utils, db_utils, purchase
- Files: 12
- Functions using this table:
  - update_inventory in puvi-backend/puvi-backend-main/inventory_utils.py
...
### materials
- Used by modules: system_config, sku_production, opening_balance, batch_production, writeoff_analytics, material_writeoff, masters_crud, traceability, app, blending, masters_common, db_utils, purchase
- Files: 26
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
...
### notes
- Used by modules: material_sales, sku_production, opening_balance, material_writeoff, writeoff_analytics, locations, masters_common, sku_outbound, cost_management
- Files: 9
...
### oil_types
- Used by modules: material_sales, system_config, batch_production, material_writeoff, blending
- Files: 7
...
### purchases
- Used by modules: sku_production, opening_balance, batch_production, app, blending, masters_common, db_utils, purchase
- Files: 12
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - get_system_status in puvi-backend/puvi-backend-main/modules/opening_balance.py
...
### sku_inventory
- Used by modules: sku_production, locations, material_writeoff, db_utils, sku_outbound
- Files: 5
- Functions using this table:
  - create_sku_production in puvi-backend/puvi-backend-main/modules/sku_production.py
...
### sku_master
- Used by modules: system_config, sku_production, expiry_utils, material_writeoff, sku_management, masters_crud, app, package_sizes, db_utils, sku_outbound
- Files: 10
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### sku_production
- Used by modules: sku_production, expiry_utils, material_writeoff, sku_management, app, db_utils, sku_outbound
- Files: 7
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - check_near_expiry_items in puvi-backend/puvi-backend-main/utils/expiry_utils.py
...
### statistics
- Used by modules: writeoff_analytics, opening_balance, masters_crud, app
- Files: 4

### status
- Used by modules: sku_production, opening_balance, masters_crud, app, sku_outbound
- Files: 5
- Functions using this table:
  - update_outbound_status in puvi-backend/puvi-backend-main/modules/sku_outbound.py
...
### subcategories_master
- Used by modules: masters_crud, blending, masters_common, db_utils, purchase
- Files: 5
- Functions using this table:
  - get_oil_types_for_blending in puvi-backend/puvi-backend-main/modules/blending.py
  - get_batches_for_oil_type in puvi-backend/puvi-backend-main/modules/blending.py
...
### success
- Used by modules: material_sales, system_config, sku_production, opening_balance, expiry_utils, batch_production, writeoff_analytics, material_writeoff, sku_management, masters_crud, locations, app, blending, package_sizes, purchase, sku_outbound, cost_management, customers
- Files: 18
...
### suppliers
- Used by modules: system_config, sku_production, opening_balance, traceability, app, masters_common, db_utils, purchase
- Files: 13
- Functions using this table:
  - system_info in puvi-backend/puvi-backend-main/app.py
  - generate_purchase_traceable_code in puvi-backend/puvi-backend-main/utils/traceability.py
...
### utils
- Used by modules: material_sales, sku_production, opening_balance, expiry_utils, batch_production, writeoff_analytics, material_writeoff, sku_management, masters_crud, locations, blending, purchase, sku_outbound, cost_management, customers
- Files: 15
